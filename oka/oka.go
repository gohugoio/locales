...
// New returns a new instance of translator for the 'oka' locale
...
func (oka *oka) Locale() string {
	return oka.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'oka'
func (oka *oka) PluralsCardinal() []locales.PluralRule {
	return oka.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'oka'
func (oka *oka) PluralsOrdinal() []locales.PluralRule {
	return oka.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'oka'
func (oka *oka) PluralsRange() []locales.PluralRule {
	return oka.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'oka'
func (oka *oka) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'oka'
func (oka *oka) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'oka'
func (oka *oka) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (oka *oka) MonthsAbbreviated() []string {
	return nil
}
...
func (oka *oka) MonthsNarrow() []string {
	return nil
}
...
func (oka *oka) MonthsWide() []string {
	return nil
}
...
func (oka *oka) WeekdaysAbbreviated() []string {
...
func (oka *oka) WeekdaysNarrow() []string {
...
func (oka *oka) WeekdaysShort() []string {
...
func (oka *oka) WeekdaysWide() []string {
	return oka.daysWide
}

// Decimal returns the decimal point of number
func (oka *oka) Decimal() string {
	return oka.decimal
}

// Group returns the group of number
func (oka *oka) Group() string {
	return oka.group
}

// Group returns the minus sign of number
func (oka *oka) Minus() string {
	return oka.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'oka' and handles both Whole and Real numbers based on 'v'
func (oka *oka) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'oka' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (oka *oka) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'oka'
func (oka *oka) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'oka'
// in accounting notation.
func (oka *oka) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'oka'
func (oka *oka) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'oka'
func (oka *oka) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'oka'
func (oka *oka) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'oka'
func (oka *oka) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'oka'
func (oka *oka) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'oka'
func (oka *oka) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'oka'
func (oka *oka) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'oka'
func (oka *oka) FmtTimeFull(t time.Time) string {
