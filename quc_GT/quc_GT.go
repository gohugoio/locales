...
// New returns a new instance of translator for the 'quc_GT' locale
...
func (quc *quc_GT) Locale() string {
	return quc.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'quc_GT'
func (quc *quc_GT) PluralsCardinal() []locales.PluralRule {
	return quc.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'quc_GT'
func (quc *quc_GT) PluralsOrdinal() []locales.PluralRule {
	return quc.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'quc_GT'
func (quc *quc_GT) PluralsRange() []locales.PluralRule {
	return quc.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'quc_GT'
func (quc *quc_GT) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'quc_GT'
func (quc *quc_GT) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'quc_GT'
func (quc *quc_GT) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (quc *quc_GT) MonthsAbbreviated() []string {
	return nil
}
...
func (quc *quc_GT) MonthsNarrow() []string {
	return nil
}
...
func (quc *quc_GT) MonthsWide() []string {
	return nil
}
...
func (quc *quc_GT) WeekdaysAbbreviated() []string {
...
func (quc *quc_GT) WeekdaysNarrow() []string {
...
func (quc *quc_GT) WeekdaysShort() []string {
...
func (quc *quc_GT) WeekdaysWide() []string {
	return quc.daysWide
}

// Decimal returns the decimal point of number
func (quc *quc_GT) Decimal() string {
	return quc.decimal
}

// Group returns the group of number
func (quc *quc_GT) Group() string {
	return quc.group
}

// Group returns the minus sign of number
func (quc *quc_GT) Minus() string {
	return quc.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'quc_GT' and handles both Whole and Real numbers based on 'v'
func (quc *quc_GT) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'quc_GT' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (quc *quc_GT) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'quc_GT'
func (quc *quc_GT) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'quc_GT'
// in accounting notation.
func (quc *quc_GT) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'quc_GT'
func (quc *quc_GT) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'quc_GT'
func (quc *quc_GT) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'quc_GT'
func (quc *quc_GT) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'quc_GT'
func (quc *quc_GT) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'quc_GT'
func (quc *quc_GT) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'quc_GT'
func (quc *quc_GT) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'quc_GT'
func (quc *quc_GT) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'quc_GT'
func (quc *quc_GT) FmtTimeFull(t time.Time) string {
