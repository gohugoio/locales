...
// New returns a new instance of translator for the 'sdh_IQ' locale
...
func (sdh *sdh_IQ) Locale() string {
	return sdh.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'sdh_IQ'
func (sdh *sdh_IQ) PluralsCardinal() []locales.PluralRule {
	return sdh.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'sdh_IQ'
func (sdh *sdh_IQ) PluralsOrdinal() []locales.PluralRule {
	return sdh.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'sdh_IQ'
func (sdh *sdh_IQ) PluralsRange() []locales.PluralRule {
	return sdh.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'sdh_IQ'
func (sdh *sdh_IQ) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	n := math.Abs(num)
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'sdh_IQ'
func (sdh *sdh_IQ) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'sdh_IQ'
func (sdh *sdh_IQ) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (sdh *sdh_IQ) MonthsAbbreviated() []string {
	return nil
}
...
func (sdh *sdh_IQ) MonthsNarrow() []string {
	return nil
}
...
func (sdh *sdh_IQ) MonthsWide() []string {
	return nil
}
...
func (sdh *sdh_IQ) WeekdaysAbbreviated() []string {
...
func (sdh *sdh_IQ) WeekdaysNarrow() []string {
...
func (sdh *sdh_IQ) WeekdaysShort() []string {
...
func (sdh *sdh_IQ) WeekdaysWide() []string {
	return sdh.daysWide
}

// Decimal returns the decimal point of number
func (sdh *sdh_IQ) Decimal() string {
	return sdh.decimal
}

// Group returns the group of number
func (sdh *sdh_IQ) Group() string {
	return sdh.group
}

// Group returns the minus sign of number
func (sdh *sdh_IQ) Minus() string {
	return sdh.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'sdh_IQ' and handles both Whole and Real numbers based on 'v'
func (sdh *sdh_IQ) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'sdh_IQ' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (sdh *sdh_IQ) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'sdh_IQ'
func (sdh *sdh_IQ) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := sdh.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'sdh_IQ'
// in accounting notation.
func (sdh *sdh_IQ) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := sdh.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtDateShort returns the short date representation of 't' for 'sdh_IQ'
func (sdh *sdh_IQ) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateMedium returns the medium date representation of 't' for 'sdh_IQ'
func (sdh *sdh_IQ) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateLong returns the long date representation of 't' for 'sdh_IQ'
func (sdh *sdh_IQ) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateFull returns the full date representation of 't' for 'sdh_IQ'
func (sdh *sdh_IQ) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeShort returns the short time representation of 't' for 'sdh_IQ'
func (sdh *sdh_IQ) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeMedium returns the medium time representation of 't' for 'sdh_IQ'
func (sdh *sdh_IQ) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeLong returns the long time representation of 't' for 'sdh_IQ'
func (sdh *sdh_IQ) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeFull returns the full time representation of 't' for 'sdh_IQ'
func (sdh *sdh_IQ) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
