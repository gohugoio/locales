...
// New returns a new instance of translator for the 'nv_US' locale
...
func (nv *nv_US) Locale() string {
	return nv.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'nv_US'
func (nv *nv_US) PluralsCardinal() []locales.PluralRule {
	return nv.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'nv_US'
func (nv *nv_US) PluralsOrdinal() []locales.PluralRule {
	return nv.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'nv_US'
func (nv *nv_US) PluralsRange() []locales.PluralRule {
	return nv.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'nv_US'
func (nv *nv_US) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'nv_US'
func (nv *nv_US) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'nv_US'
func (nv *nv_US) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (nv *nv_US) MonthsAbbreviated() []string {
	return nil
}
...
func (nv *nv_US) MonthsNarrow() []string {
	return nil
}
...
func (nv *nv_US) MonthsWide() []string {
	return nil
}
...
func (nv *nv_US) WeekdaysAbbreviated() []string {
...
func (nv *nv_US) WeekdaysNarrow() []string {
...
func (nv *nv_US) WeekdaysShort() []string {
	return nv.daysShort
}
...
func (nv *nv_US) WeekdaysWide() []string {
	return nv.daysWide
}

// Decimal returns the decimal point of number
func (nv *nv_US) Decimal() string {
	return nv.decimal
}

// Group returns the group of number
func (nv *nv_US) Group() string {
	return nv.group
}

// Group returns the minus sign of number
func (nv *nv_US) Minus() string {
	return nv.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'nv_US' and handles both Whole and Real numbers based on 'v'
func (nv *nv_US) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'nv_US' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (nv *nv_US) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'nv_US'
func (nv *nv_US) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'nv_US'
// in accounting notation.
func (nv *nv_US) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'nv_US'
func (nv *nv_US) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'nv_US'
func (nv *nv_US) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'nv_US'
func (nv *nv_US) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'nv_US'
func (nv *nv_US) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'nv_US'
func (nv *nv_US) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'nv_US'
func (nv *nv_US) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'nv_US'
func (nv *nv_US) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'nv_US'
func (nv *nv_US) FmtTimeFull(t time.Time) string {
