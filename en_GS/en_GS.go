...
// New returns a new instance of translator for the 'en_GS' locale
...
func (en *en_GS) Locale() string {
	return en.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'en_GS'
func (en *en_GS) PluralsCardinal() []locales.PluralRule {
	return en.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'en_GS'
func (en *en_GS) PluralsOrdinal() []locales.PluralRule {
	return en.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'en_GS'
func (en *en_GS) PluralsRange() []locales.PluralRule {
	return en.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'en_GS'
func (en *en_GS) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'en_GS'
func (en *en_GS) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'en_GS'
func (en *en_GS) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (en *en_GS) MonthAbbreviated(month time.Month) string {
...
func (en *en_GS) MonthsAbbreviated() []string {
	return en.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (en *en_GS) MonthNarrow(month time.Month) string {
...
func (en *en_GS) MonthsNarrow() []string {
	return en.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (en *en_GS) MonthWide(month time.Month) string {
...
func (en *en_GS) MonthsWide() []string {
	return en.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (en *en_GS) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (en *en_GS) WeekdaysAbbreviated() []string {
	return en.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (en *en_GS) WeekdayNarrow(weekday time.Weekday) string {
...
func (en *en_GS) WeekdaysNarrow() []string {
	return en.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (en *en_GS) WeekdayShort(weekday time.Weekday) string {
...
func (en *en_GS) WeekdaysShort() []string {
	return en.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (en *en_GS) WeekdayWide(weekday time.Weekday) string {
...
func (en *en_GS) WeekdaysWide() []string {
	return en.daysWide
}

// Decimal returns the decimal point of number
func (en *en_GS) Decimal() string {
	return en.decimal
}

// Group returns the group of number
func (en *en_GS) Group() string {
	return en.group
}

// Group returns the minus sign of number
func (en *en_GS) Minus() string {
	return en.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'en_GS' and handles both Whole and Real numbers based on 'v'
func (en *en_GS) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'en_GS' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (en *en_GS) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'en_GS'
func (en *en_GS) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'en_GS'
// in accounting notation.
func (en *en_GS) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'en_GS'
func (en *en_GS) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'en_GS'
func (en *en_GS) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'en_GS'
func (en *en_GS) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'en_GS'
func (en *en_GS) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'en_GS'
func (en *en_GS) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'en_GS'
func (en *en_GS) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'en_GS'
func (en *en_GS) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'en_GS'
func (en *en_GS) FmtTimeFull(t time.Time) string {
