...
// New returns a new instance of translator for the 'mww_Hmnp_US' locale
...
func (mww *mww_Hmnp_US) Locale() string {
	return mww.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) PluralsCardinal() []locales.PluralRule {
	return mww.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) PluralsOrdinal() []locales.PluralRule {
	return mww.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) PluralsRange() []locales.PluralRule {
	return mww.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (mww *mww_Hmnp_US) MonthsAbbreviated() []string {
	return nil
}
...
func (mww *mww_Hmnp_US) MonthsNarrow() []string {
	return nil
}
...
func (mww *mww_Hmnp_US) MonthsWide() []string {
...
func (mww *mww_Hmnp_US) WeekdaysAbbreviated() []string {
...
func (mww *mww_Hmnp_US) WeekdaysNarrow() []string {
...
func (mww *mww_Hmnp_US) WeekdaysShort() []string {
...
func (mww *mww_Hmnp_US) WeekdaysWide() []string {
	return mww.daysWide
}

// Decimal returns the decimal point of number
func (mww *mww_Hmnp_US) Decimal() string {
	return mww.decimal
}

// Group returns the group of number
func (mww *mww_Hmnp_US) Group() string {
	return mww.group
}

// Group returns the minus sign of number
func (mww *mww_Hmnp_US) Minus() string {
	return mww.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'mww_Hmnp_US' and handles both Whole and Real numbers based on 'v'
func (mww *mww_Hmnp_US) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'mww_Hmnp_US' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (mww *mww_Hmnp_US) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'mww_Hmnp_US'
// in accounting notation.
func (mww *mww_Hmnp_US) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'mww_Hmnp_US'
func (mww *mww_Hmnp_US) FmtTimeFull(t time.Time) string {
