...
// New returns a new instance of translator for the 've_ZA' locale
...
func (ve *ve_ZA) Locale() string {
	return ve.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 've_ZA'
func (ve *ve_ZA) PluralsCardinal() []locales.PluralRule {
	return ve.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 've_ZA'
func (ve *ve_ZA) PluralsOrdinal() []locales.PluralRule {
	return ve.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 've_ZA'
func (ve *ve_ZA) PluralsRange() []locales.PluralRule {
	return ve.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 've_ZA'
func (ve *ve_ZA) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	n := math.Abs(num)
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 've_ZA'
func (ve *ve_ZA) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 've_ZA'
func (ve *ve_ZA) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (ve *ve_ZA) MonthAbbreviated(month time.Month) string {
...
func (ve *ve_ZA) MonthsAbbreviated() []string {
	return ve.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (ve *ve_ZA) MonthNarrow(month time.Month) string {
...
func (ve *ve_ZA) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (ve *ve_ZA) MonthWide(month time.Month) string {
...
func (ve *ve_ZA) MonthsWide() []string {
	return ve.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (ve *ve_ZA) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (ve *ve_ZA) WeekdaysAbbreviated() []string {
	return ve.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (ve *ve_ZA) WeekdayNarrow(weekday time.Weekday) string {
...
func (ve *ve_ZA) WeekdaysNarrow() []string {
	return ve.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (ve *ve_ZA) WeekdayShort(weekday time.Weekday) string {
...
func (ve *ve_ZA) WeekdaysShort() []string {
	return ve.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (ve *ve_ZA) WeekdayWide(weekday time.Weekday) string {
...
func (ve *ve_ZA) WeekdaysWide() []string {
	return ve.daysWide
}

// Decimal returns the decimal point of number
func (ve *ve_ZA) Decimal() string {
	return ve.decimal
}

// Group returns the group of number
func (ve *ve_ZA) Group() string {
	return ve.group
}

// Group returns the minus sign of number
func (ve *ve_ZA) Minus() string {
	return ve.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 've_ZA' and handles both Whole and Real numbers based on 'v'
func (ve *ve_ZA) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 've_ZA' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (ve *ve_ZA) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 've_ZA'
func (ve *ve_ZA) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 've_ZA'
// in accounting notation.
func (ve *ve_ZA) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := ve.currencies[currency]
	l := len(s) + len(symbol) + 2 + 2*len(s[:len(s)-int(v)-1])/3
	count := 0
...
// FmtDateShort returns the short date representation of 't' for 've_ZA'
func (ve *ve_ZA) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateMedium returns the medium date representation of 't' for 've_ZA'
func (ve *ve_ZA) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateLong returns the long date representation of 't' for 've_ZA'
func (ve *ve_ZA) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateFull returns the full date representation of 't' for 've_ZA'
func (ve *ve_ZA) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeShort returns the short time representation of 't' for 've_ZA'
func (ve *ve_ZA) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeMedium returns the medium time representation of 't' for 've_ZA'
func (ve *ve_ZA) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeLong returns the long time representation of 't' for 've_ZA'
func (ve *ve_ZA) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeFull returns the full time representation of 't' for 've_ZA'
func (ve *ve_ZA) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
