...
// New returns a new instance of translator for the 'moh_CA' locale
...
func (moh *moh_CA) Locale() string {
	return moh.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'moh_CA'
func (moh *moh_CA) PluralsCardinal() []locales.PluralRule {
	return moh.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'moh_CA'
func (moh *moh_CA) PluralsOrdinal() []locales.PluralRule {
	return moh.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'moh_CA'
func (moh *moh_CA) PluralsRange() []locales.PluralRule {
	return moh.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'moh_CA'
func (moh *moh_CA) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'moh_CA'
func (moh *moh_CA) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'moh_CA'
func (moh *moh_CA) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (moh *moh_CA) MonthAbbreviated(month time.Month) string {
...
func (moh *moh_CA) MonthsAbbreviated() []string {
	return nil
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (moh *moh_CA) MonthNarrow(month time.Month) string {
...
func (moh *moh_CA) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (moh *moh_CA) MonthWide(month time.Month) string {
...
func (moh *moh_CA) MonthsWide() []string {
	return nil
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (moh *moh_CA) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (moh *moh_CA) WeekdaysAbbreviated() []string {
	return moh.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (moh *moh_CA) WeekdayNarrow(weekday time.Weekday) string {
...
func (moh *moh_CA) WeekdaysNarrow() []string {
	return moh.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (moh *moh_CA) WeekdayShort(weekday time.Weekday) string {
...
func (moh *moh_CA) WeekdaysShort() []string {
	return moh.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (moh *moh_CA) WeekdayWide(weekday time.Weekday) string {
...
func (moh *moh_CA) WeekdaysWide() []string {
	return moh.daysWide
}

// Decimal returns the decimal point of number
func (moh *moh_CA) Decimal() string {
	return moh.decimal
}

// Group returns the group of number
func (moh *moh_CA) Group() string {
	return moh.group
}

// Group returns the minus sign of number
func (moh *moh_CA) Minus() string {
	return moh.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'moh_CA' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (moh *moh_CA) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
