...
// New returns a new instance of translator for the 'rif' locale
...
func (rif *rif) MonthsAbbreviated() []string {
	return rif.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (rif *rif) MonthNarrow(month time.Month) string {
	if len(rif.monthsNarrow) == 0 {
		return ""
	}
...
func (rif *rif) MonthsNarrow() []string {
	return rif.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (rif *rif) MonthWide(month time.Month) string {
	if len(rif.monthsWide) == 0 {
		return ""
	}
...
func (rif *rif) MonthsWide() []string {
	return rif.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (rif *rif) WeekdayAbbreviated(weekday time.Weekday) string {
	if len(rif.daysAbbreviated) == 0 {
		return ""
	}
...
func (rif *rif) WeekdaysAbbreviated() []string {
	return rif.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (rif *rif) WeekdayNarrow(weekday time.Weekday) string {
	if len(rif.daysNarrow) == 0 {
		return ""
	}
...
func (rif *rif) WeekdaysNarrow() []string {
	return rif.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (rif *rif) WeekdayShort(weekday time.Weekday) string {
	if len(rif.daysShort) == 0 {
		return ""
	}
...
func (rif *rif) WeekdaysShort() []string {
	return rif.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (rif *rif) WeekdayWide(weekday time.Weekday) string {
	if len(rif.daysWide) == 0 {
		return ""
	}
...
func (rif *rif) WeekdaysWide() []string {
	return rif.daysWide
}

// Decimal returns the decimal point of number
func (rif *rif) Decimal() string {
	return rif.decimal
}

// Group returns the group of number
func (rif *rif) Group() string {
	return rif.group
}

// Group returns the minus sign of number
func (rif *rif) Minus() string {
	return rif.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'rif' and handles both Whole and Real numbers based on 'v'
func (rif *rif) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'rif' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (rif *rif) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'rif'
func (rif *rif) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'rif'
// in accounting notation.
func (rif *rif) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'rif'
func (rif *rif) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'rif'
func (rif *rif) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'rif'
func (rif *rif) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'rif'
func (rif *rif) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'rif'
func (rif *rif) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'rif'
func (rif *rif) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'rif'
func (rif *rif) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'rif'
func (rif *rif) FmtTimeFull(t time.Time) string {
