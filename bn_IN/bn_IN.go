...
func New() locales.Translator {
	return &bn_IN{
		...
		monthsAbbreviated:      []string{"", "জানু", "ফেব", "মার্চ", "এপ্রি", "মে", "জুন", "জুল", "আগ", "সেপ্টেঃ", "অক্টোঃ", "নভেঃ", "ডিসেঃ"},
		monthsNarrow:           []string{"", "জা", "ফে", "মা", "এ", "মে", "জুন", "জুল", "আ", "সে", "অ", "ন", "ডি"},
...
func (bn *bn_IN) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	...
	for j := len(bn.currencyPositivePrefix) - 1; j >= 0; j-- {
		b = append(b, bn.currencyPositivePrefix[j])
	}
