...
// New returns a new instance of translator for the 'bal_Arab' locale
...
func (bal *bal_Arab) Locale() string {
	return bal.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'bal_Arab'
func (bal *bal_Arab) PluralsCardinal() []locales.PluralRule {
	return bal.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'bal_Arab'
func (bal *bal_Arab) PluralsOrdinal() []locales.PluralRule {
	return bal.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'bal_Arab'
func (bal *bal_Arab) PluralsRange() []locales.PluralRule {
	return bal.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'bal_Arab'
func (bal *bal_Arab) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	n := math.Abs(num)
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'bal_Arab'
func (bal *bal_Arab) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	n := math.Abs(num)
...
// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'bal_Arab'
func (bal *bal_Arab) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (bal *bal_Arab) MonthAbbreviated(month time.Month) string {
	return bal.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (bal *bal_Arab) MonthsAbbreviated() []string {
	return bal.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (bal *bal_Arab) MonthNarrow(month time.Month) string {
	return bal.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (bal *bal_Arab) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (bal *bal_Arab) MonthWide(month time.Month) string {
	return bal.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (bal *bal_Arab) MonthsWide() []string {
	return bal.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (bal *bal_Arab) WeekdayAbbreviated(weekday time.Weekday) string {
	return bal.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (bal *bal_Arab) WeekdaysAbbreviated() []string {
	return bal.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (bal *bal_Arab) WeekdayNarrow(weekday time.Weekday) string {
	return bal.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (bal *bal_Arab) WeekdaysNarrow() []string {
	return bal.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (bal *bal_Arab) WeekdayShort(weekday time.Weekday) string {
	return bal.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (bal *bal_Arab) WeekdaysShort() []string {
	return bal.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (bal *bal_Arab) WeekdayWide(weekday time.Weekday) string {
	return bal.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (bal *bal_Arab) WeekdaysWide() []string {
	return bal.daysWide
}

// Decimal returns the decimal point of number
func (bal *bal_Arab) Decimal() string {
	return bal.decimal
}

// Group returns the group of number
func (bal *bal_Arab) Group() string {
	return bal.group
}

// Group returns the minus sign of number
func (bal *bal_Arab) Minus() string {
	return bal.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'bal_Arab' and handles both Whole and Real numbers based on 'v'
func (bal *bal_Arab) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'bal_Arab' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (bal *bal_Arab) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'bal_Arab'
func (bal *bal_Arab) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := bal.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'bal_Arab'
// in accounting notation.
func (bal *bal_Arab) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := bal.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtDateShort returns the short date representation of 't' for 'bal_Arab'
func (bal *bal_Arab) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateMedium returns the medium date representation of 't' for 'bal_Arab'
func (bal *bal_Arab) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateLong returns the long date representation of 't' for 'bal_Arab'
func (bal *bal_Arab) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateFull returns the full date representation of 't' for 'bal_Arab'
func (bal *bal_Arab) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeShort returns the short time representation of 't' for 'bal_Arab'
func (bal *bal_Arab) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeMedium returns the medium time representation of 't' for 'bal_Arab'
func (bal *bal_Arab) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeLong returns the long time representation of 't' for 'bal_Arab'
func (bal *bal_Arab) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeFull returns the full time representation of 't' for 'bal_Arab'
func (bal *bal_Arab) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
