...
// New returns a new instance of translator for the 'kpe_LR' locale
...
func (kpe *kpe_LR) Locale() string {
	return kpe.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'kpe_LR'
func (kpe *kpe_LR) PluralsCardinal() []locales.PluralRule {
	return kpe.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'kpe_LR'
func (kpe *kpe_LR) PluralsOrdinal() []locales.PluralRule {
	return kpe.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'kpe_LR'
func (kpe *kpe_LR) PluralsRange() []locales.PluralRule {
	return kpe.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'kpe_LR'
func (kpe *kpe_LR) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'kpe_LR'
func (kpe *kpe_LR) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'kpe_LR'
func (kpe *kpe_LR) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (kpe *kpe_LR) MonthAbbreviated(month time.Month) string {
	return kpe.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (kpe *kpe_LR) MonthsAbbreviated() []string {
	return nil
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (kpe *kpe_LR) MonthNarrow(month time.Month) string {
	return kpe.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (kpe *kpe_LR) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (kpe *kpe_LR) MonthWide(month time.Month) string {
	return kpe.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (kpe *kpe_LR) MonthsWide() []string {
	return nil
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (kpe *kpe_LR) WeekdayAbbreviated(weekday time.Weekday) string {
	return kpe.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (kpe *kpe_LR) WeekdaysAbbreviated() []string {
	return kpe.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (kpe *kpe_LR) WeekdayNarrow(weekday time.Weekday) string {
	return kpe.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (kpe *kpe_LR) WeekdaysNarrow() []string {
	return kpe.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (kpe *kpe_LR) WeekdayShort(weekday time.Weekday) string {
	return kpe.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (kpe *kpe_LR) WeekdaysShort() []string {
	return kpe.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (kpe *kpe_LR) WeekdayWide(weekday time.Weekday) string {
	return kpe.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (kpe *kpe_LR) WeekdaysWide() []string {
	return kpe.daysWide
}

// Decimal returns the decimal point of number
func (kpe *kpe_LR) Decimal() string {
	return kpe.decimal
}

// Group returns the group of number
func (kpe *kpe_LR) Group() string {
	return kpe.group
}

// Group returns the minus sign of number
func (kpe *kpe_LR) Minus() string {
	return kpe.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'kpe_LR' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (kpe *kpe_LR) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
