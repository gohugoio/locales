...
// New returns a new instance of translator for the 'mn_Mong' locale
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'mn_Mong'
func (mn *mn_Mong) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'mn_Mong'
func (mn *mn_Mong) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
...
func (mn *mn_Mong) MonthAbbreviated(month time.Month) string {
	return mn.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (mn *mn_Mong) MonthsAbbreviated() []string {
	return mn.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (mn *mn_Mong) MonthNarrow(month time.Month) string {
	return mn.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (mn *mn_Mong) MonthsNarrow() []string {
	return mn.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (mn *mn_Mong) MonthWide(month time.Month) string {
	return mn.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (mn *mn_Mong) MonthsWide() []string {
	return mn.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (mn *mn_Mong) WeekdayAbbreviated(weekday time.Weekday) string {
	return mn.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (mn *mn_Mong) WeekdaysAbbreviated() []string {
	return mn.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (mn *mn_Mong) WeekdayNarrow(weekday time.Weekday) string {
	return mn.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (mn *mn_Mong) WeekdaysNarrow() []string {
	return mn.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (mn *mn_Mong) WeekdayShort(weekday time.Weekday) string {
	return mn.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (mn *mn_Mong) WeekdaysShort() []string {
	return mn.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (mn *mn_Mong) WeekdayWide(weekday time.Weekday) string {
	return mn.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (mn *mn_Mong) WeekdaysWide() []string {
	return mn.daysWide
}

// Decimal returns the decimal point of number
func (mn *mn_Mong) Decimal() string {
	return mn.decimal
}

// Group returns the group of number
func (mn *mn_Mong) Group() string {
	return mn.group
}

// Group returns the minus sign of number
func (mn *mn_Mong) Minus() string {
	return mn.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'mn_Mong' and handles both Whole and Real numbers based on 'v'
func (mn *mn_Mong) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'mn_Mong' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (mn *mn_Mong) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'mn_Mong'
func (mn *mn_Mong) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'mn_Mong'
// in accounting notation.
func (mn *mn_Mong) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := mn.currencies[currency]
	l := len(s) + len(symbol) + 4 + 1*len(s[:len(s)-int(v)-1])/3
	count := 0
...
// FmtDateShort returns the short date representation of 't' for 'mn_Mong'
func (mn *mn_Mong) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateMedium returns the medium date representation of 't' for 'mn_Mong'
func (mn *mn_Mong) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateLong returns the long date representation of 't' for 'mn_Mong'
func (mn *mn_Mong) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateFull returns the full date representation of 't' for 'mn_Mong'
func (mn *mn_Mong) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeShort returns the short time representation of 't' for 'mn_Mong'
func (mn *mn_Mong) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeMedium returns the medium time representation of 't' for 'mn_Mong'
func (mn *mn_Mong) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeLong returns the long time representation of 't' for 'mn_Mong'
func (mn *mn_Mong) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeFull returns the full time representation of 't' for 'mn_Mong'
func (mn *mn_Mong) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
