...
// New returns a new instance of translator for the 'cv' locale
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'cv'
func (cv *cv) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'cv'
func (cv *cv) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (cv *cv) MonthAbbreviated(month time.Month) string {
	if len(cv.monthsAbbreviated) == 0 {
		return ""
	}
...
func (cv *cv) MonthsAbbreviated() []string {
	return cv.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (cv *cv) MonthNarrow(month time.Month) string {
	if len(cv.monthsNarrow) == 0 {
		return ""
	}
...
func (cv *cv) MonthsNarrow() []string {
	return cv.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (cv *cv) MonthWide(month time.Month) string {
	if len(cv.monthsWide) == 0 {
		return ""
	}
...
func (cv *cv) MonthsWide() []string {
	return cv.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (cv *cv) WeekdayAbbreviated(weekday time.Weekday) string {
	if len(cv.daysAbbreviated) == 0 {
		return ""
	}
...
func (cv *cv) WeekdaysAbbreviated() []string {
	return cv.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (cv *cv) WeekdayNarrow(weekday time.Weekday) string {
	if len(cv.daysNarrow) == 0 {
		return ""
	}
...
func (cv *cv) WeekdaysNarrow() []string {
	return cv.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (cv *cv) WeekdayShort(weekday time.Weekday) string {
	if len(cv.daysShort) == 0 {
		return ""
	}
...
func (cv *cv) WeekdaysShort() []string {
	return cv.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (cv *cv) WeekdayWide(weekday time.Weekday) string {
	if len(cv.daysWide) == 0 {
		return ""
	}
...
func (cv *cv) WeekdaysWide() []string {
	return cv.daysWide
}

// Decimal returns the decimal point of number
func (cv *cv) Decimal() string {
	return cv.decimal
}

// Group returns the group of number
func (cv *cv) Group() string {
	return cv.group
}

// Group returns the minus sign of number
func (cv *cv) Minus() string {
	return cv.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'cv' and handles both Whole and Real numbers based on 'v'
func (cv *cv) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'cv' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (cv *cv) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 5
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'cv'
func (cv *cv) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'cv'
// in accounting notation.
func (cv *cv) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'cv'
func (cv *cv) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'cv'
func (cv *cv) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'cv'
func (cv *cv) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'cv'
func (cv *cv) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'cv'
func (cv *cv) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'cv'
func (cv *cv) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'cv'
func (cv *cv) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'cv'
func (cv *cv) FmtTimeFull(t time.Time) string {
