...
// New returns a new instance of translator for the 'csw_CA' locale
...
func (csw *csw_CA) Locale() string {
	return csw.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'csw_CA'
func (csw *csw_CA) PluralsCardinal() []locales.PluralRule {
	return csw.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'csw_CA'
func (csw *csw_CA) PluralsOrdinal() []locales.PluralRule {
	return csw.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'csw_CA'
func (csw *csw_CA) PluralsRange() []locales.PluralRule {
	return csw.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'csw_CA'
func (csw *csw_CA) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'csw_CA'
func (csw *csw_CA) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'csw_CA'
func (csw *csw_CA) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (csw *csw_CA) MonthAbbreviated(month time.Month) string {
	return csw.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (csw *csw_CA) MonthsAbbreviated() []string {
	return csw.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (csw *csw_CA) MonthNarrow(month time.Month) string {
	return csw.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (csw *csw_CA) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (csw *csw_CA) MonthWide(month time.Month) string {
	return csw.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (csw *csw_CA) MonthsWide() []string {
	return csw.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (csw *csw_CA) WeekdayAbbreviated(weekday time.Weekday) string {
	return csw.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (csw *csw_CA) WeekdaysAbbreviated() []string {
	return csw.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (csw *csw_CA) WeekdayNarrow(weekday time.Weekday) string {
	return csw.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (csw *csw_CA) WeekdaysNarrow() []string {
	return csw.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (csw *csw_CA) WeekdayShort(weekday time.Weekday) string {
	return csw.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (csw *csw_CA) WeekdaysShort() []string {
	return csw.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (csw *csw_CA) WeekdayWide(weekday time.Weekday) string {
	return csw.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (csw *csw_CA) WeekdaysWide() []string {
	return csw.daysWide
}

// Decimal returns the decimal point of number
func (csw *csw_CA) Decimal() string {
	return csw.decimal
}

// Group returns the group of number
func (csw *csw_CA) Group() string {
	return csw.group
}

// Group returns the minus sign of number
func (csw *csw_CA) Minus() string {
	return csw.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'csw_CA' and handles both Whole and Real numbers based on 'v'
func (csw *csw_CA) FmtNumber(num float64, v uint64) string {

	return strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
}

// FmtPercent returns 'num' with digits/precision of 'v' for 'csw_CA' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (csw *csw_CA) FmtPercent(num float64, v uint64) string {
	return strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
}

// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'csw_CA'
func (csw *csw_CA) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'csw_CA'
// in accounting notation.
func (csw *csw_CA) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'csw_CA'
func (csw *csw_CA) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'csw_CA'
func (csw *csw_CA) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'csw_CA'
func (csw *csw_CA) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'csw_CA'
func (csw *csw_CA) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'csw_CA'
func (csw *csw_CA) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'csw_CA'
func (csw *csw_CA) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'csw_CA'
func (csw *csw_CA) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'csw_CA'
func (csw *csw_CA) FmtTimeFull(t time.Time) string {
