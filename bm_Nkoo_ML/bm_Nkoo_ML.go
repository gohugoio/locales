...
// New returns a new instance of translator for the 'bm_Nkoo_ML' locale
...
func (bm *bm_Nkoo_ML) Locale() string {
	return bm.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) PluralsCardinal() []locales.PluralRule {
	return bm.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) PluralsOrdinal() []locales.PluralRule {
	return bm.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) PluralsRange() []locales.PluralRule {
	return bm.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (bm *bm_Nkoo_ML) MonthAbbreviated(month time.Month) string {
	if len(bm.monthsAbbreviated) == 0 {
		return ""
	}
...
func (bm *bm_Nkoo_ML) MonthsAbbreviated() []string {
	return bm.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (bm *bm_Nkoo_ML) MonthNarrow(month time.Month) string {
	if len(bm.monthsNarrow) == 0 {
		return ""
	}
...
func (bm *bm_Nkoo_ML) MonthsNarrow() []string {
	return bm.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (bm *bm_Nkoo_ML) MonthWide(month time.Month) string {
	if len(bm.monthsWide) == 0 {
		return ""
	}
...
func (bm *bm_Nkoo_ML) MonthsWide() []string {
	return bm.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (bm *bm_Nkoo_ML) WeekdayAbbreviated(weekday time.Weekday) string {
	if len(bm.daysAbbreviated) == 0 {
		return ""
	}
...
func (bm *bm_Nkoo_ML) WeekdaysAbbreviated() []string {
	return bm.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (bm *bm_Nkoo_ML) WeekdayNarrow(weekday time.Weekday) string {
	if len(bm.daysNarrow) == 0 {
		return ""
	}
...
func (bm *bm_Nkoo_ML) WeekdaysNarrow() []string {
	return bm.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (bm *bm_Nkoo_ML) WeekdayShort(weekday time.Weekday) string {
	if len(bm.daysShort) == 0 {
		return ""
	}
...
func (bm *bm_Nkoo_ML) WeekdaysShort() []string {
	return bm.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (bm *bm_Nkoo_ML) WeekdayWide(weekday time.Weekday) string {
	if len(bm.daysWide) == 0 {
		return ""
	}
...
func (bm *bm_Nkoo_ML) WeekdaysWide() []string {
	return bm.daysWide
}

// Decimal returns the decimal point of number
func (bm *bm_Nkoo_ML) Decimal() string {
	return bm.decimal
}

// Group returns the group of number
func (bm *bm_Nkoo_ML) Group() string {
	return bm.group
}

// Group returns the minus sign of number
func (bm *bm_Nkoo_ML) Minus() string {
	return bm.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'bm_Nkoo_ML' and handles both Whole and Real numbers based on 'v'
func (bm *bm_Nkoo_ML) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'bm_Nkoo_ML' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (bm *bm_Nkoo_ML) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
	...
	b = append(b, bm.percent...)

	return string(b)
}

// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'bm_Nkoo_ML'
// in accounting notation.
func (bm *bm_Nkoo_ML) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := bm.currencies[currency]
...
// FmtDateShort returns the short date representation of 't' for 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateMedium returns the medium date representation of 't' for 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateLong returns the long date representation of 't' for 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateFull returns the full date representation of 't' for 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeShort returns the short time representation of 't' for 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeMedium returns the medium time representation of 't' for 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeLong returns the long time representation of 't' for 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeFull returns the full time representation of 't' for 'bm_Nkoo_ML'
func (bm *bm_Nkoo_ML) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
