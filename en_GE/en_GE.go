...
// New returns a new instance of translator for the 'en_GE' locale
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'en_GE'
func (en *en_GE) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'en_GE'
func (en *en_GE) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (en *en_GE) MonthAbbreviated(month time.Month) string {
...
func (en *en_GE) MonthsAbbreviated() []string {
	return en.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (en *en_GE) MonthNarrow(month time.Month) string {
...
func (en *en_GE) MonthsNarrow() []string {
	return en.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (en *en_GE) MonthWide(month time.Month) string {
...
func (en *en_GE) MonthsWide() []string {
	return en.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (en *en_GE) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (en *en_GE) WeekdaysAbbreviated() []string {
	return en.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (en *en_GE) WeekdayNarrow(weekday time.Weekday) string {
...
func (en *en_GE) WeekdaysNarrow() []string {
	return en.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (en *en_GE) WeekdayShort(weekday time.Weekday) string {
...
func (en *en_GE) WeekdaysShort() []string {
	return en.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (en *en_GE) WeekdayWide(weekday time.Weekday) string {
...
func (en *en_GE) WeekdaysWide() []string {
	return en.daysWide
}

// Decimal returns the decimal point of number
func (en *en_GE) Decimal() string {
	return en.decimal
}

// Group returns the group of number
func (en *en_GE) Group() string {
	return en.group
}

// Group returns the minus sign of number
func (en *en_GE) Minus() string {
	return en.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'en_GE' and handles both Whole and Real numbers based on 'v'
func (en *en_GE) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'en_GE' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (en *en_GE) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'en_GE'
func (en *en_GE) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'en_GE'
// in accounting notation.
func (en *en_GE) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'en_GE'
func (en *en_GE) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'en_GE'
func (en *en_GE) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'en_GE'
func (en *en_GE) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'en_GE'
func (en *en_GE) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'en_GE'
func (en *en_GE) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'en_GE'
func (en *en_GE) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'en_GE'
func (en *en_GE) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'en_GE'
func (en *en_GE) FmtTimeFull(t time.Time) string {
