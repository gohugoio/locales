...
// New returns a new instance of translator for the 'bm_Nkoo' locale
...
func (bm *bm_Nkoo) Locale() string {
	return bm.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'bm_Nkoo'
func (bm *bm_Nkoo) PluralsCardinal() []locales.PluralRule {
	return bm.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'bm_Nkoo'
func (bm *bm_Nkoo) PluralsOrdinal() []locales.PluralRule {
	return bm.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'bm_Nkoo'
func (bm *bm_Nkoo) PluralsRange() []locales.PluralRule {
	return bm.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'bm_Nkoo'
func (bm *bm_Nkoo) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'bm_Nkoo'
func (bm *bm_Nkoo) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'bm_Nkoo'
func (bm *bm_Nkoo) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (bm *bm_Nkoo) MonthAbbreviated(month time.Month) string {
...
func (bm *bm_Nkoo) MonthsAbbreviated() []string {
	return bm.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (bm *bm_Nkoo) MonthNarrow(month time.Month) string {
...
func (bm *bm_Nkoo) MonthsNarrow() []string {
	return bm.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (bm *bm_Nkoo) MonthWide(month time.Month) string {
...
func (bm *bm_Nkoo) MonthsWide() []string {
	return bm.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (bm *bm_Nkoo) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (bm *bm_Nkoo) WeekdaysAbbreviated() []string {
	return bm.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (bm *bm_Nkoo) WeekdayNarrow(weekday time.Weekday) string {
...
func (bm *bm_Nkoo) WeekdaysNarrow() []string {
	return bm.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (bm *bm_Nkoo) WeekdayShort(weekday time.Weekday) string {
...
func (bm *bm_Nkoo) WeekdaysShort() []string {
	return bm.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (bm *bm_Nkoo) WeekdayWide(weekday time.Weekday) string {
...
func (bm *bm_Nkoo) WeekdaysWide() []string {
	return bm.daysWide
}

// Decimal returns the decimal point of number
func (bm *bm_Nkoo) Decimal() string {
	return bm.decimal
}

// Group returns the group of number
func (bm *bm_Nkoo) Group() string {
	return bm.group
}

// Group returns the minus sign of number
func (bm *bm_Nkoo) Minus() string {
	return bm.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'bm_Nkoo' and handles both Whole and Real numbers based on 'v'
func (bm *bm_Nkoo) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'bm_Nkoo' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (bm *bm_Nkoo) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'bm_Nkoo'
func (bm *bm_Nkoo) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'bm_Nkoo'
// in accounting notation.
func (bm *bm_Nkoo) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := bm.currencies[currency]
...
// FmtDateShort returns the short date representation of 't' for 'bm_Nkoo'
func (bm *bm_Nkoo) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateMedium returns the medium date representation of 't' for 'bm_Nkoo'
func (bm *bm_Nkoo) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateLong returns the long date representation of 't' for 'bm_Nkoo'
func (bm *bm_Nkoo) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateFull returns the full date representation of 't' for 'bm_Nkoo'
func (bm *bm_Nkoo) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeShort returns the short time representation of 't' for 'bm_Nkoo'
func (bm *bm_Nkoo) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeMedium returns the medium time representation of 't' for 'bm_Nkoo'
func (bm *bm_Nkoo) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeLong returns the long time representation of 't' for 'bm_Nkoo'
func (bm *bm_Nkoo) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeFull returns the full time representation of 't' for 'bm_Nkoo'
func (bm *bm_Nkoo) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
