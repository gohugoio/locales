...
// New returns a new instance of translator for the 'sms_FI' locale
...
func (sms *sms_FI) Locale() string {
	return sms.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'sms_FI'
func (sms *sms_FI) PluralsCardinal() []locales.PluralRule {
	return sms.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'sms_FI'
func (sms *sms_FI) PluralsOrdinal() []locales.PluralRule {
	return sms.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'sms_FI'
func (sms *sms_FI) PluralsRange() []locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'sms_FI'
func (sms *sms_FI) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'sms_FI'
func (sms *sms_FI) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (sms *sms_FI) MonthAbbreviated(month time.Month) string {
	return sms.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (sms *sms_FI) MonthsAbbreviated() []string {
	return nil
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (sms *sms_FI) MonthNarrow(month time.Month) string {
	return sms.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (sms *sms_FI) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (sms *sms_FI) MonthWide(month time.Month) string {
	return sms.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (sms *sms_FI) MonthsWide() []string {
	return nil
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (sms *sms_FI) WeekdayAbbreviated(weekday time.Weekday) string {
	return sms.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (sms *sms_FI) WeekdaysAbbreviated() []string {
	return sms.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (sms *sms_FI) WeekdayNarrow(weekday time.Weekday) string {
	return sms.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (sms *sms_FI) WeekdaysNarrow() []string {
	return sms.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (sms *sms_FI) WeekdayShort(weekday time.Weekday) string {
	return sms.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (sms *sms_FI) WeekdaysShort() []string {
	return sms.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (sms *sms_FI) WeekdayWide(weekday time.Weekday) string {
	return sms.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (sms *sms_FI) WeekdaysWide() []string {
	return sms.daysWide
}

// Decimal returns the decimal point of number
func (sms *sms_FI) Decimal() string {
	return sms.decimal
}

// Group returns the group of number
func (sms *sms_FI) Group() string {
	return sms.group
}

// Group returns the minus sign of number
func (sms *sms_FI) Minus() string {
	return sms.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'sms_FI' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (sms *sms_FI) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
