...
// New returns a new instance of translator for the 'bqi' locale
...
func (bqi *bqi) Locale() string {
	return bqi.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'bqi'
func (bqi *bqi) PluralsCardinal() []locales.PluralRule {
	return bqi.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'bqi'
func (bqi *bqi) PluralsOrdinal() []locales.PluralRule {
	return bqi.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'bqi'
func (bqi *bqi) PluralsRange() []locales.PluralRule {
	return bqi.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'bqi'
func (bqi *bqi) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'bqi'
func (bqi *bqi) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'bqi'
func (bqi *bqi) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (bqi *bqi) MonthAbbreviated(month time.Month) string {
	return bqi.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (bqi *bqi) MonthsAbbreviated() []string {
	return nil
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (bqi *bqi) MonthNarrow(month time.Month) string {
	return bqi.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (bqi *bqi) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (bqi *bqi) MonthWide(month time.Month) string {
	return bqi.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (bqi *bqi) MonthsWide() []string {
	return bqi.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (bqi *bqi) WeekdayAbbreviated(weekday time.Weekday) string {
	return bqi.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (bqi *bqi) WeekdaysAbbreviated() []string {
	return bqi.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (bqi *bqi) WeekdayNarrow(weekday time.Weekday) string {
	return bqi.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (bqi *bqi) WeekdaysNarrow() []string {
	return bqi.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (bqi *bqi) WeekdayShort(weekday time.Weekday) string {
	return bqi.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (bqi *bqi) WeekdaysShort() []string {
	return bqi.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (bqi *bqi) WeekdayWide(weekday time.Weekday) string {
	return bqi.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (bqi *bqi) WeekdaysWide() []string {
	return bqi.daysWide
}

// Decimal returns the decimal point of number
func (bqi *bqi) Decimal() string {
	return bqi.decimal
}

// Group returns the group of number
func (bqi *bqi) Group() string {
	return bqi.group
}

// Group returns the minus sign of number
func (bqi *bqi) Minus() string {
	return bqi.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'bqi' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (bqi *bqi) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 8
	b := make([]byte, 0, l)
