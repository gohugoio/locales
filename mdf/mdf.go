...
// New returns a new instance of translator for the 'mdf' locale
...
func (mdf *mdf) Locale() string {
	return mdf.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'mdf'
func (mdf *mdf) PluralsCardinal() []locales.PluralRule {
	return mdf.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'mdf'
func (mdf *mdf) PluralsOrdinal() []locales.PluralRule {
	return mdf.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'mdf'
func (mdf *mdf) PluralsRange() []locales.PluralRule {
	return mdf.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'mdf'
func (mdf *mdf) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'mdf'
func (mdf *mdf) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'mdf'
func (mdf *mdf) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (mdf *mdf) MonthsAbbreviated() []string {
	return nil
}
...
func (mdf *mdf) MonthsNarrow() []string {
	return nil
}
...
func (mdf *mdf) MonthsWide() []string {
	return nil
}
...
func (mdf *mdf) WeekdaysAbbreviated() []string {
...
func (mdf *mdf) WeekdaysNarrow() []string {
...
func (mdf *mdf) WeekdaysShort() []string {
...
func (mdf *mdf) WeekdaysWide() []string {
	return mdf.daysWide
}

// Decimal returns the decimal point of number
func (mdf *mdf) Decimal() string {
	return mdf.decimal
}

// Group returns the group of number
func (mdf *mdf) Group() string {
	return mdf.group
}

// Group returns the minus sign of number
func (mdf *mdf) Minus() string {
	return mdf.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'mdf' and handles both Whole and Real numbers based on 'v'
func (mdf *mdf) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'mdf' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (mdf *mdf) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'mdf'
func (mdf *mdf) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'mdf'
// in accounting notation.
func (mdf *mdf) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'mdf'
func (mdf *mdf) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'mdf'
func (mdf *mdf) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'mdf'
func (mdf *mdf) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'mdf'
func (mdf *mdf) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'mdf'
func (mdf *mdf) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'mdf'
func (mdf *mdf) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'mdf'
func (mdf *mdf) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'mdf'
func (mdf *mdf) FmtTimeFull(t time.Time) string {
