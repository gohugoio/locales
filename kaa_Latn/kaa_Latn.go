...
// New returns a new instance of translator for the 'kaa_Latn' locale
...
func (kaa *kaa_Latn) Locale() string {
	return kaa.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'kaa_Latn'
func (kaa *kaa_Latn) PluralsCardinal() []locales.PluralRule {
	return kaa.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'kaa_Latn'
func (kaa *kaa_Latn) PluralsOrdinal() []locales.PluralRule {
	return kaa.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'kaa_Latn'
func (kaa *kaa_Latn) PluralsRange() []locales.PluralRule {
	return kaa.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'kaa_Latn'
func (kaa *kaa_Latn) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'kaa_Latn'
func (kaa *kaa_Latn) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'kaa_Latn'
func (kaa *kaa_Latn) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (kaa *kaa_Latn) MonthAbbreviated(month time.Month) string {
...
func (kaa *kaa_Latn) MonthsAbbreviated() []string {
	return kaa.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (kaa *kaa_Latn) MonthNarrow(month time.Month) string {
...
func (kaa *kaa_Latn) MonthsNarrow() []string {
	return kaa.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (kaa *kaa_Latn) MonthWide(month time.Month) string {
...
func (kaa *kaa_Latn) MonthsWide() []string {
	return kaa.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (kaa *kaa_Latn) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (kaa *kaa_Latn) WeekdaysAbbreviated() []string {
	return kaa.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (kaa *kaa_Latn) WeekdayNarrow(weekday time.Weekday) string {
...
func (kaa *kaa_Latn) WeekdaysNarrow() []string {
	return kaa.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (kaa *kaa_Latn) WeekdayShort(weekday time.Weekday) string {
...
func (kaa *kaa_Latn) WeekdaysShort() []string {
	return kaa.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (kaa *kaa_Latn) WeekdayWide(weekday time.Weekday) string {
...
func (kaa *kaa_Latn) WeekdaysWide() []string {
	return kaa.daysWide
}

// Decimal returns the decimal point of number
func (kaa *kaa_Latn) Decimal() string {
	return kaa.decimal
}

// Group returns the group of number
func (kaa *kaa_Latn) Group() string {
	return kaa.group
}

// Group returns the minus sign of number
func (kaa *kaa_Latn) Minus() string {
	return kaa.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'kaa_Latn' and handles both Whole and Real numbers based on 'v'
func (kaa *kaa_Latn) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'kaa_Latn' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (kaa *kaa_Latn) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'kaa_Latn'
func (kaa *kaa_Latn) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	...
	for j := len(kaa.currencyPositivePrefix) - 1; j >= 0; j-- {
		b = append(b, kaa.currencyPositivePrefix[j])
	}
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'kaa_Latn'
// in accounting notation.
func (kaa *kaa_Latn) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	...
	if num < 0 {
		...
		for j := len(kaa.currencyNegativePrefix) - 1; j >= 0; j-- {
			b = append(b, kaa.currencyNegativePrefix[j])
		}
...
// FmtDateShort returns the short date representation of 't' for 'kaa_Latn'
func (kaa *kaa_Latn) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'kaa_Latn'
func (kaa *kaa_Latn) FmtDateMedium(t time.Time) string {
	...
	b = append(b, kaa.monthsAbbreviated[t.Month()]...)
	b = append(b, []byte{0x20}...)
	b = strconv.AppendInt(b, int64(t.Day()), 10)
...
// FmtDateLong returns the long date representation of 't' for 'kaa_Latn'
func (kaa *kaa_Latn) FmtDateLong(t time.Time) string {
	...
	b = append(b, []byte{0x20}...)
	b = append(b, kaa.monthsWide[t.Month()]...)
	b = append(b, []byte{0x20}...)
	b = strconv.AppendInt(b, int64(t.Day()), 10)
...
// FmtDateFull returns the full date representation of 't' for 'kaa_Latn'
func (kaa *kaa_Latn) FmtDateFull(t time.Time) string {
	...
	b = append(b, kaa.daysWide[t.Weekday()]...)

	return string(b)
}

// FmtTimeShort returns the short time representation of 't' for 'kaa_Latn'
func (kaa *kaa_Latn) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'kaa_Latn'
func (kaa *kaa_Latn) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'kaa_Latn'
func (kaa *kaa_Latn) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'kaa_Latn'
func (kaa *kaa_Latn) FmtTimeFull(t time.Time) string {
