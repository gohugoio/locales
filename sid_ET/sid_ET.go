...
// New returns a new instance of translator for the 'sid_ET' locale
func New() locales.Translator {
	return &sid_ET{
		...
		erasAbbreviated:    []string{"YIA", "YIG"},
		erasNarrow:         []string{"", ""},
		erasWide:           []string{"", ""},
...
func (sid *sid_ET) Locale() string {
	return sid.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'sid_ET'
func (sid *sid_ET) PluralsCardinal() []locales.PluralRule {
	return sid.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'sid_ET'
func (sid *sid_ET) PluralsOrdinal() []locales.PluralRule {
	return sid.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'sid_ET'
func (sid *sid_ET) PluralsRange() []locales.PluralRule {
	return sid.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'sid_ET'
func (sid *sid_ET) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'sid_ET'
func (sid *sid_ET) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'sid_ET'
func (sid *sid_ET) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (sid *sid_ET) MonthAbbreviated(month time.Month) string {
	return sid.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (sid *sid_ET) MonthsAbbreviated() []string {
	return nil
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (sid *sid_ET) MonthNarrow(month time.Month) string {
	return sid.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (sid *sid_ET) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (sid *sid_ET) MonthWide(month time.Month) string {
	return sid.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (sid *sid_ET) MonthsWide() []string {
	return nil
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (sid *sid_ET) WeekdayAbbreviated(weekday time.Weekday) string {
	return sid.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (sid *sid_ET) WeekdaysAbbreviated() []string {
	return sid.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (sid *sid_ET) WeekdayNarrow(weekday time.Weekday) string {
	return sid.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (sid *sid_ET) WeekdaysNarrow() []string {
	return sid.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (sid *sid_ET) WeekdayShort(weekday time.Weekday) string {
	return sid.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (sid *sid_ET) WeekdaysShort() []string {
	return sid.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (sid *sid_ET) WeekdayWide(weekday time.Weekday) string {
	return sid.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (sid *sid_ET) WeekdaysWide() []string {
	return sid.daysWide
}

// Decimal returns the decimal point of number
func (sid *sid_ET) Decimal() string {
	return sid.decimal
}

// Group returns the group of number
func (sid *sid_ET) Group() string {
	return sid.group
}

// Group returns the minus sign of number
func (sid *sid_ET) Minus() string {
	return sid.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'sid_ET' and handles both Whole and Real numbers based on 'v'
func (sid *sid_ET) FmtNumber(num float64, v uint64) string {

	return strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
}

// FmtPercent returns 'num' with digits/precision of 'v' for 'sid_ET' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (sid *sid_ET) FmtPercent(num float64, v uint64) string {
	return strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
}

// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'sid_ET'
func (sid *sid_ET) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'sid_ET'
// in accounting notation.
func (sid *sid_ET) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'sid_ET'
func (sid *sid_ET) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'sid_ET'
func (sid *sid_ET) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'sid_ET'
func (sid *sid_ET) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'sid_ET'
func (sid *sid_ET) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'sid_ET'
func (sid *sid_ET) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'sid_ET'
func (sid *sid_ET) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'sid_ET'
func (sid *sid_ET) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'sid_ET'
func (sid *sid_ET) FmtTimeFull(t time.Time) string {
