...
// New returns a new instance of translator for the 'ba_RU' locale
...
func (ba *ba_RU) MonthsAbbreviated() []string {
	return ba.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (ba *ba_RU) MonthNarrow(month time.Month) string {
	if len(ba.monthsNarrow) == 0 {
		return ""
	}
...
func (ba *ba_RU) MonthsNarrow() []string {
	return ba.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (ba *ba_RU) MonthWide(month time.Month) string {
	if len(ba.monthsWide) == 0 {
		return ""
	}
...
func (ba *ba_RU) MonthsWide() []string {
	return ba.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (ba *ba_RU) WeekdayAbbreviated(weekday time.Weekday) string {
	if len(ba.daysAbbreviated) == 0 {
		return ""
	}
...
func (ba *ba_RU) WeekdaysAbbreviated() []string {
	return ba.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (ba *ba_RU) WeekdayNarrow(weekday time.Weekday) string {
	if len(ba.daysNarrow) == 0 {
		return ""
	}
...
func (ba *ba_RU) WeekdaysNarrow() []string {
	return ba.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (ba *ba_RU) WeekdayShort(weekday time.Weekday) string {
	if len(ba.daysShort) == 0 {
		return ""
	}
...
func (ba *ba_RU) WeekdaysShort() []string {
	return ba.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (ba *ba_RU) WeekdayWide(weekday time.Weekday) string {
	if len(ba.daysWide) == 0 {
		return ""
	}
...
func (ba *ba_RU) WeekdaysWide() []string {
	return ba.daysWide
}

// Decimal returns the decimal point of number
func (ba *ba_RU) Decimal() string {
	return ba.decimal
}

// Group returns the group of number
func (ba *ba_RU) Group() string {
	return ba.group
}

// Group returns the minus sign of number
func (ba *ba_RU) Minus() string {
	return ba.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'ba_RU' and handles both Whole and Real numbers based on 'v'
func (ba *ba_RU) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'ba_RU' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (ba *ba_RU) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'ba_RU'
func (ba *ba_RU) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'ba_RU'
// in accounting notation.
func (ba *ba_RU) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'ba_RU'
func (ba *ba_RU) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'ba_RU'
func (ba *ba_RU) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'ba_RU'
func (ba *ba_RU) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'ba_RU'
func (ba *ba_RU) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'ba_RU'
func (ba *ba_RU) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'ba_RU'
func (ba *ba_RU) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'ba_RU'
func (ba *ba_RU) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'ba_RU'
func (ba *ba_RU) FmtTimeFull(t time.Time) string {
