...
// New returns a new instance of translator for the 'kaa_Cyrl' locale
...
func (kaa *kaa_Cyrl) Locale() string {
	return kaa.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'kaa_Cyrl'
func (kaa *kaa_Cyrl) PluralsCardinal() []locales.PluralRule {
	return kaa.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'kaa_Cyrl'
func (kaa *kaa_Cyrl) PluralsOrdinal() []locales.PluralRule {
	return kaa.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'kaa_Cyrl'
func (kaa *kaa_Cyrl) PluralsRange() []locales.PluralRule {
	return kaa.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'kaa_Cyrl'
func (kaa *kaa_Cyrl) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'kaa_Cyrl'
func (kaa *kaa_Cyrl) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'kaa_Cyrl'
func (kaa *kaa_Cyrl) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (kaa *kaa_Cyrl) MonthsAbbreviated() []string {
...
func (kaa *kaa_Cyrl) MonthsNarrow() []string {
...
func (kaa *kaa_Cyrl) MonthsWide() []string {
...
func (kaa *kaa_Cyrl) WeekdaysAbbreviated() []string {
...
func (kaa *kaa_Cyrl) WeekdaysNarrow() []string {
...
func (kaa *kaa_Cyrl) WeekdaysShort() []string {
...
func (kaa *kaa_Cyrl) WeekdaysWide() []string {
	return kaa.daysWide
}

// Decimal returns the decimal point of number
func (kaa *kaa_Cyrl) Decimal() string {
	return kaa.decimal
}

// Group returns the group of number
func (kaa *kaa_Cyrl) Group() string {
	return kaa.group
}

// Group returns the minus sign of number
func (kaa *kaa_Cyrl) Minus() string {
	return kaa.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'kaa_Cyrl' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (kaa *kaa_Cyrl) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
