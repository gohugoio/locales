...
// New returns a new instance of translator for the 'cad' locale
...
func (cad *cad) Locale() string {
	return cad.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'cad'
func (cad *cad) PluralsCardinal() []locales.PluralRule {
	return cad.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'cad'
func (cad *cad) PluralsOrdinal() []locales.PluralRule {
	return cad.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'cad'
func (cad *cad) PluralsRange() []locales.PluralRule {
	return cad.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'cad'
func (cad *cad) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'cad'
func (cad *cad) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'cad'
func (cad *cad) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (cad *cad) MonthsAbbreviated() []string {
	return nil
}
...
func (cad *cad) MonthsNarrow() []string {
	return nil
}
...
func (cad *cad) MonthsWide() []string {
...
func (cad *cad) WeekdaysAbbreviated() []string {
...
func (cad *cad) WeekdaysNarrow() []string {
...
func (cad *cad) WeekdaysShort() []string {
...
func (cad *cad) WeekdaysWide() []string {
	return cad.daysWide
}

// Decimal returns the decimal point of number
func (cad *cad) Decimal() string {
	return cad.decimal
}

// Group returns the group of number
func (cad *cad) Group() string {
	return cad.group
}

// Group returns the minus sign of number
func (cad *cad) Minus() string {
	return cad.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'cad' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (cad *cad) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
