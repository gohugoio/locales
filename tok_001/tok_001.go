...
// New returns a new instance of translator for the 'tok_001' locale
...
func (tok *tok_001) Locale() string {
	return tok.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'tok_001'
func (tok *tok_001) PluralsCardinal() []locales.PluralRule {
	return tok.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'tok_001'
func (tok *tok_001) PluralsOrdinal() []locales.PluralRule {
	return tok.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'tok_001'
func (tok *tok_001) PluralsRange() []locales.PluralRule {
	return tok.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'tok_001'
func (tok *tok_001) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'tok_001'
func (tok *tok_001) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'tok_001'
func (tok *tok_001) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (tok *tok_001) MonthsAbbreviated() []string {
	return nil
}
...
func (tok *tok_001) MonthsNarrow() []string {
	return nil
}
...
func (tok *tok_001) MonthsWide() []string {
...
func (tok *tok_001) WeekdaysAbbreviated() []string {
...
func (tok *tok_001) WeekdaysNarrow() []string {
...
func (tok *tok_001) WeekdaysShort() []string {
...
func (tok *tok_001) WeekdaysWide() []string {
	return tok.daysWide
}

// Decimal returns the decimal point of number
func (tok *tok_001) Decimal() string {
	return tok.decimal
}

// Group returns the group of number
func (tok *tok_001) Group() string {
	return tok.group
}

// Group returns the minus sign of number
func (tok *tok_001) Minus() string {
	return tok.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'tok_001' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (tok *tok_001) FmtPercent(num float64, v uint64) string {
