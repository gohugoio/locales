...
// New returns a new instance of translator for the 'ken' locale
...
func (ken *ken) Locale() string {
	return ken.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'ken'
func (ken *ken) PluralsCardinal() []locales.PluralRule {
	return ken.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'ken'
func (ken *ken) PluralsOrdinal() []locales.PluralRule {
	return ken.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'ken'
func (ken *ken) PluralsRange() []locales.PluralRule {
	return ken.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'ken'
func (ken *ken) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'ken'
func (ken *ken) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'ken'
func (ken *ken) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (ken *ken) MonthsAbbreviated() []string {
	return nil
}
...
func (ken *ken) MonthsNarrow() []string {
	return nil
}
...
func (ken *ken) MonthsWide() []string {
	return nil
}
...
func (ken *ken) WeekdaysAbbreviated() []string {
...
func (ken *ken) WeekdaysNarrow() []string {
...
func (ken *ken) WeekdaysShort() []string {
...
func (ken *ken) WeekdaysWide() []string {
	return ken.daysWide
}

// Decimal returns the decimal point of number
func (ken *ken) Decimal() string {
	return ken.decimal
}

// Group returns the group of number
func (ken *ken) Group() string {
	return ken.group
}

// Group returns the minus sign of number
func (ken *ken) Minus() string {
	return ken.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'ken' and handles both Whole and Real numbers based on 'v'
func (ken *ken) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'ken' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (ken *ken) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'ken'
func (ken *ken) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := ken.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'ken'
// in accounting notation.
func (ken *ken) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := ken.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtDateShort returns the short date representation of 't' for 'ken'
func (ken *ken) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateMedium returns the medium date representation of 't' for 'ken'
func (ken *ken) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateLong returns the long date representation of 't' for 'ken'
func (ken *ken) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateFull returns the full date representation of 't' for 'ken'
func (ken *ken) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeShort returns the short time representation of 't' for 'ken'
func (ken *ken) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeMedium returns the medium time representation of 't' for 'ken'
func (ken *ken) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeLong returns the long time representation of 't' for 'ken'
func (ken *ken) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeFull returns the full time representation of 't' for 'ken'
func (ken *ken) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
