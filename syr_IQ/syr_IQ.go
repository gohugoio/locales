...
// New returns a new instance of translator for the 'syr_IQ' locale
...
func (syr *syr_IQ) Locale() string {
	return syr.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'syr_IQ'
func (syr *syr_IQ) PluralsCardinal() []locales.PluralRule {
	return syr.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'syr_IQ'
func (syr *syr_IQ) PluralsOrdinal() []locales.PluralRule {
	return syr.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'syr_IQ'
func (syr *syr_IQ) PluralsRange() []locales.PluralRule {
	return syr.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'syr_IQ'
func (syr *syr_IQ) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	n := math.Abs(num)
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'syr_IQ'
func (syr *syr_IQ) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'syr_IQ'
func (syr *syr_IQ) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (syr *syr_IQ) MonthAbbreviated(month time.Month) string {
	return syr.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (syr *syr_IQ) MonthsAbbreviated() []string {
	return syr.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (syr *syr_IQ) MonthNarrow(month time.Month) string {
	return syr.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (syr *syr_IQ) MonthsNarrow() []string {
	return syr.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (syr *syr_IQ) MonthWide(month time.Month) string {
	return syr.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (syr *syr_IQ) MonthsWide() []string {
	return syr.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (syr *syr_IQ) WeekdayAbbreviated(weekday time.Weekday) string {
	return syr.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (syr *syr_IQ) WeekdaysAbbreviated() []string {
	return syr.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (syr *syr_IQ) WeekdayNarrow(weekday time.Weekday) string {
	return syr.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (syr *syr_IQ) WeekdaysNarrow() []string {
	return syr.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (syr *syr_IQ) WeekdayShort(weekday time.Weekday) string {
	return syr.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (syr *syr_IQ) WeekdaysShort() []string {
	return syr.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (syr *syr_IQ) WeekdayWide(weekday time.Weekday) string {
	return syr.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (syr *syr_IQ) WeekdaysWide() []string {
	return syr.daysWide
}

// Decimal returns the decimal point of number
func (syr *syr_IQ) Decimal() string {
	return syr.decimal
}

// Group returns the group of number
func (syr *syr_IQ) Group() string {
	return syr.group
}

// Group returns the minus sign of number
func (syr *syr_IQ) Minus() string {
	return syr.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'syr_IQ' and handles both Whole and Real numbers based on 'v'
func (syr *syr_IQ) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'syr_IQ' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (syr *syr_IQ) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'syr_IQ'
func (syr *syr_IQ) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := syr.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'syr_IQ'
// in accounting notation.
func (syr *syr_IQ) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := syr.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtDateShort returns the short date representation of 't' for 'syr_IQ'
func (syr *syr_IQ) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateMedium returns the medium date representation of 't' for 'syr_IQ'
func (syr *syr_IQ) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateLong returns the long date representation of 't' for 'syr_IQ'
func (syr *syr_IQ) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateFull returns the full date representation of 't' for 'syr_IQ'
func (syr *syr_IQ) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeShort returns the short time representation of 't' for 'syr_IQ'
func (syr *syr_IQ) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeMedium returns the medium time representation of 't' for 'syr_IQ'
func (syr *syr_IQ) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeLong returns the long time representation of 't' for 'syr_IQ'
func (syr *syr_IQ) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeFull returns the full time representation of 't' for 'syr_IQ'
func (syr *syr_IQ) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
