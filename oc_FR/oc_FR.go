...
// New returns a new instance of translator for the 'oc_FR' locale
...
func (oc *oc_FR) MonthsAbbreviated() []string {
	return oc.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (oc *oc_FR) MonthNarrow(month time.Month) string {
	if len(oc.monthsNarrow) == 0 {
		return ""
	}
...
func (oc *oc_FR) MonthsNarrow() []string {
	return oc.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (oc *oc_FR) MonthWide(month time.Month) string {
	if len(oc.monthsWide) == 0 {
		return ""
	}
...
func (oc *oc_FR) MonthsWide() []string {
	return oc.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (oc *oc_FR) WeekdayAbbreviated(weekday time.Weekday) string {
	if len(oc.daysAbbreviated) == 0 {
		return ""
	}
...
func (oc *oc_FR) WeekdaysAbbreviated() []string {
	return oc.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (oc *oc_FR) WeekdayNarrow(weekday time.Weekday) string {
	if len(oc.daysNarrow) == 0 {
		return ""
	}
...
func (oc *oc_FR) WeekdaysNarrow() []string {
	return oc.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (oc *oc_FR) WeekdayShort(weekday time.Weekday) string {
	if len(oc.daysShort) == 0 {
		return ""
	}
...
func (oc *oc_FR) WeekdaysShort() []string {
	return oc.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (oc *oc_FR) WeekdayWide(weekday time.Weekday) string {
	if len(oc.daysWide) == 0 {
		return ""
	}
...
func (oc *oc_FR) WeekdaysWide() []string {
	return oc.daysWide
}

// Decimal returns the decimal point of number
func (oc *oc_FR) Decimal() string {
	return oc.decimal
}

// Group returns the group of number
func (oc *oc_FR) Group() string {
	return oc.group
}

// Group returns the minus sign of number
func (oc *oc_FR) Minus() string {
	return oc.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'oc_FR' and handles both Whole and Real numbers based on 'v'
func (oc *oc_FR) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'oc_FR' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (oc *oc_FR) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 6
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'oc_FR'
func (oc *oc_FR) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'oc_FR'
// in accounting notation.
func (oc *oc_FR) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'oc_FR'
func (oc *oc_FR) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'oc_FR'
func (oc *oc_FR) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'oc_FR'
func (oc *oc_FR) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'oc_FR'
func (oc *oc_FR) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'oc_FR'
func (oc *oc_FR) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'oc_FR'
func (oc *oc_FR) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'oc_FR'
func (oc *oc_FR) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'oc_FR'
func (oc *oc_FR) FmtTimeFull(t time.Time) string {
