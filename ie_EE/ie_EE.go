...
// New returns a new instance of translator for the 'ie_EE' locale
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'ie_EE'
func (ie *ie_EE) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'ie_EE'
func (ie *ie_EE) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (ie *ie_EE) MonthAbbreviated(month time.Month) string {
	return ie.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (ie *ie_EE) MonthsAbbreviated() []string {
	return ie.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (ie *ie_EE) MonthNarrow(month time.Month) string {
	return ie.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (ie *ie_EE) MonthsNarrow() []string {
	return ie.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (ie *ie_EE) MonthWide(month time.Month) string {
	return ie.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (ie *ie_EE) MonthsWide() []string {
	return ie.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (ie *ie_EE) WeekdayAbbreviated(weekday time.Weekday) string {
	return ie.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (ie *ie_EE) WeekdaysAbbreviated() []string {
	return ie.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (ie *ie_EE) WeekdayNarrow(weekday time.Weekday) string {
	return ie.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (ie *ie_EE) WeekdaysNarrow() []string {
	return ie.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (ie *ie_EE) WeekdayShort(weekday time.Weekday) string {
	return ie.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (ie *ie_EE) WeekdaysShort() []string {
	return ie.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (ie *ie_EE) WeekdayWide(weekday time.Weekday) string {
	return ie.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (ie *ie_EE) WeekdaysWide() []string {
	return ie.daysWide
}

// Decimal returns the decimal point of number
func (ie *ie_EE) Decimal() string {
	return ie.decimal
}

// Group returns the group of number
func (ie *ie_EE) Group() string {
	return ie.group
}

// Group returns the minus sign of number
func (ie *ie_EE) Minus() string {
	return ie.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'ie_EE' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (ie *ie_EE) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
