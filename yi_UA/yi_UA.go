...
// New returns a new instance of translator for the 'yi_UA' locale
func New() locales.Translator {
	return &yi_UA{
		...
		monthsAbbreviated: []string{"", "יאַנ", "פֿעב", "מערץ", "אַפּר", "מיי", "יוני", "יולי", "אויג", "סעפּ", "אקט", "נאוו", "דעצ"},
...
func (yi *yi_UA) Locale() string {
	return yi.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'yi_UA'
func (yi *yi_UA) PluralsCardinal() []locales.PluralRule {
	return yi.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'yi_UA'
func (yi *yi_UA) PluralsOrdinal() []locales.PluralRule {
	return yi.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'yi_UA'
func (yi *yi_UA) PluralsRange() []locales.PluralRule {
	return yi.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'yi_UA'
func (yi *yi_UA) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	n := math.Abs(num)
	i := int64(n)
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'yi_UA'
func (yi *yi_UA) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'yi_UA'
func (yi *yi_UA) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (yi *yi_UA) MonthsAbbreviated() []string {
...
func (yi *yi_UA) MonthsNarrow() []string {
	return nil
}
...
func (yi *yi_UA) MonthsWide() []string {
...
func (yi *yi_UA) WeekdaysAbbreviated() []string {
...
func (yi *yi_UA) WeekdaysNarrow() []string {
...
func (yi *yi_UA) WeekdaysShort() []string {
	return yi.daysShort
}
...
func (yi *yi_UA) WeekdaysWide() []string {
	return yi.daysWide
}

// Decimal returns the decimal point of number
func (yi *yi_UA) Decimal() string {
	return yi.decimal
}

// Group returns the group of number
func (yi *yi_UA) Group() string {
	return yi.group
}

// Group returns the minus sign of number
func (yi *yi_UA) Minus() string {
	return yi.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'yi_UA' and handles both Whole and Real numbers based on 'v'
func (yi *yi_UA) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'yi_UA' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (yi *yi_UA) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
	...
	b = append(b, yi.percent...)

	return string(b)
}

// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'yi_UA'
func (yi *yi_UA) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := yi.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'yi_UA'
// in accounting notation.
func (yi *yi_UA) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := yi.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtDateShort returns the short date representation of 't' for 'yi_UA'
func (yi *yi_UA) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateMedium returns the medium date representation of 't' for 'yi_UA'
func (yi *yi_UA) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateLong returns the long date representation of 't' for 'yi_UA'
func (yi *yi_UA) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateFull returns the full date representation of 't' for 'yi_UA'
func (yi *yi_UA) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeShort returns the short time representation of 't' for 'yi_UA'
func (yi *yi_UA) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeMedium returns the medium time representation of 't' for 'yi_UA'
func (yi *yi_UA) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeLong returns the long time representation of 't' for 'yi_UA'
func (yi *yi_UA) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeFull returns the full time representation of 't' for 'yi_UA'
func (yi *yi_UA) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
