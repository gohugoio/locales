...
// New returns a new instance of translator for the 'ha_Arab_SD' locale
...
func (ha *ha_Arab_SD) Locale() string {
	return ha.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'ha_Arab_SD'
func (ha *ha_Arab_SD) PluralsCardinal() []locales.PluralRule {
	return ha.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'ha_Arab_SD'
func (ha *ha_Arab_SD) PluralsOrdinal() []locales.PluralRule {
	return ha.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'ha_Arab_SD'
func (ha *ha_Arab_SD) PluralsRange() []locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'ha_Arab_SD'
func (ha *ha_Arab_SD) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'ha_Arab_SD'
func (ha *ha_Arab_SD) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (ha *ha_Arab_SD) MonthAbbreviated(month time.Month) string {
...
func (ha *ha_Arab_SD) MonthsAbbreviated() []string {
	return ha.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (ha *ha_Arab_SD) MonthNarrow(month time.Month) string {
...
func (ha *ha_Arab_SD) MonthsNarrow() []string {
	return ha.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (ha *ha_Arab_SD) MonthWide(month time.Month) string {
...
func (ha *ha_Arab_SD) MonthsWide() []string {
	return ha.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (ha *ha_Arab_SD) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (ha *ha_Arab_SD) WeekdaysAbbreviated() []string {
	return ha.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (ha *ha_Arab_SD) WeekdayNarrow(weekday time.Weekday) string {
...
func (ha *ha_Arab_SD) WeekdaysNarrow() []string {
	return ha.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (ha *ha_Arab_SD) WeekdayShort(weekday time.Weekday) string {
...
func (ha *ha_Arab_SD) WeekdaysShort() []string {
	return ha.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (ha *ha_Arab_SD) WeekdayWide(weekday time.Weekday) string {
...
func (ha *ha_Arab_SD) WeekdaysWide() []string {
	return ha.daysWide
}

// Decimal returns the decimal point of number
func (ha *ha_Arab_SD) Decimal() string {
	return ha.decimal
}

// Group returns the group of number
func (ha *ha_Arab_SD) Group() string {
	return ha.group
}

// Group returns the minus sign of number
func (ha *ha_Arab_SD) Minus() string {
	return ha.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'ha_Arab_SD' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (ha *ha_Arab_SD) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
