...
// New returns a new instance of translator for the 'kok_Latn' locale
...
// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'kok_Latn'
func (kok *kok_Latn) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (kok *kok_Latn) MonthAbbreviated(month time.Month) string {
...
func (kok *kok_Latn) MonthsAbbreviated() []string {
	return kok.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (kok *kok_Latn) MonthNarrow(month time.Month) string {
...
func (kok *kok_Latn) MonthsNarrow() []string {
	return kok.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (kok *kok_Latn) MonthWide(month time.Month) string {
...
func (kok *kok_Latn) MonthsWide() []string {
	return kok.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (kok *kok_Latn) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (kok *kok_Latn) WeekdaysAbbreviated() []string {
	return kok.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (kok *kok_Latn) WeekdayNarrow(weekday time.Weekday) string {
...
func (kok *kok_Latn) WeekdaysNarrow() []string {
	return kok.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (kok *kok_Latn) WeekdayShort(weekday time.Weekday) string {
...
func (kok *kok_Latn) WeekdaysShort() []string {
	return kok.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (kok *kok_Latn) WeekdayWide(weekday time.Weekday) string {
...
func (kok *kok_Latn) WeekdaysWide() []string {
	return kok.daysWide
}

// Decimal returns the decimal point of number
func (kok *kok_Latn) Decimal() string {
	return kok.decimal
}

// Group returns the group of number
func (kok *kok_Latn) Group() string {
	return kok.group
}

// Group returns the minus sign of number
func (kok *kok_Latn) Minus() string {
	return kok.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'kok_Latn' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (kok *kok_Latn) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
