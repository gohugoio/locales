...
// New returns a new instance of translator for the 'lij_IT' locale
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'lij_IT'
func (lij *lij_IT) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	n := math.Abs(num)
...
// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'lij_IT'
func (lij *lij_IT) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
...
func (lij *lij_IT) MonthAbbreviated(month time.Month) string {
	if len(lij.monthsAbbreviated) == 0 {
		return ""
	}
...
func (lij *lij_IT) MonthsAbbreviated() []string {
	return lij.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (lij *lij_IT) MonthNarrow(month time.Month) string {
	if len(lij.monthsNarrow) == 0 {
		return ""
	}
...
func (lij *lij_IT) MonthsNarrow() []string {
	return lij.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (lij *lij_IT) MonthWide(month time.Month) string {
	if len(lij.monthsWide) == 0 {
		return ""
	}
...
func (lij *lij_IT) MonthsWide() []string {
	return lij.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (lij *lij_IT) WeekdayAbbreviated(weekday time.Weekday) string {
	if len(lij.daysAbbreviated) == 0 {
		return ""
	}
...
func (lij *lij_IT) WeekdaysAbbreviated() []string {
	return lij.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (lij *lij_IT) WeekdayNarrow(weekday time.Weekday) string {
	if len(lij.daysNarrow) == 0 {
		return ""
	}
...
func (lij *lij_IT) WeekdaysNarrow() []string {
	return lij.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (lij *lij_IT) WeekdayShort(weekday time.Weekday) string {
	if len(lij.daysShort) == 0 {
		return ""
	}
...
func (lij *lij_IT) WeekdaysShort() []string {
	return lij.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (lij *lij_IT) WeekdayWide(weekday time.Weekday) string {
	if len(lij.daysWide) == 0 {
		return ""
	}
...
func (lij *lij_IT) WeekdaysWide() []string {
	return lij.daysWide
}

// Decimal returns the decimal point of number
func (lij *lij_IT) Decimal() string {
	return lij.decimal
}

// Group returns the group of number
func (lij *lij_IT) Group() string {
	return lij.group
}

// Group returns the minus sign of number
func (lij *lij_IT) Minus() string {
	return lij.minus
}
...
func (lij *lij_IT) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'lij_IT'
// in accounting notation.
func (lij *lij_IT) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := lij.currencies[currency]
...
// FmtDateShort returns the short date representation of 't' for 'lij_IT'
func (lij *lij_IT) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateMedium returns the medium date representation of 't' for 'lij_IT'
func (lij *lij_IT) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateLong returns the long date representation of 't' for 'lij_IT'
func (lij *lij_IT) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateFull returns the full date representation of 't' for 'lij_IT'
func (lij *lij_IT) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeShort returns the short time representation of 't' for 'lij_IT'
func (lij *lij_IT) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeMedium returns the medium time representation of 't' for 'lij_IT'
func (lij *lij_IT) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeLong returns the long time representation of 't' for 'lij_IT'
func (lij *lij_IT) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeFull returns the full time representation of 't' for 'lij_IT'
func (lij *lij_IT) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
