...
// New returns a new instance of translator for the 'lzz' locale
...
func (lzz *lzz) Locale() string {
	return lzz.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'lzz'
func (lzz *lzz) PluralsCardinal() []locales.PluralRule {
	return lzz.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'lzz'
func (lzz *lzz) PluralsOrdinal() []locales.PluralRule {
	return lzz.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'lzz'
func (lzz *lzz) PluralsRange() []locales.PluralRule {
	return lzz.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'lzz'
func (lzz *lzz) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'lzz'
func (lzz *lzz) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'lzz'
func (lzz *lzz) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (lzz *lzz) MonthsAbbreviated() []string {
	return nil
}
...
func (lzz *lzz) MonthsNarrow() []string {
	return nil
}
...
func (lzz *lzz) MonthsWide() []string {
	return nil
}
...
func (lzz *lzz) WeekdaysAbbreviated() []string {
...
func (lzz *lzz) WeekdaysNarrow() []string {
...
func (lzz *lzz) WeekdaysShort() []string {
...
func (lzz *lzz) WeekdaysWide() []string {
	return lzz.daysWide
}

// Decimal returns the decimal point of number
func (lzz *lzz) Decimal() string {
	return lzz.decimal
}

// Group returns the group of number
func (lzz *lzz) Group() string {
	return lzz.group
}

// Group returns the minus sign of number
func (lzz *lzz) Minus() string {
	return lzz.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'lzz' and handles both Whole and Real numbers based on 'v'
func (lzz *lzz) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'lzz' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (lzz *lzz) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'lzz'
func (lzz *lzz) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := lzz.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'lzz'
// in accounting notation.
func (lzz *lzz) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := lzz.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtDateShort returns the short date representation of 't' for 'lzz'
func (lzz *lzz) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateMedium returns the medium date representation of 't' for 'lzz'
func (lzz *lzz) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateLong returns the long date representation of 't' for 'lzz'
func (lzz *lzz) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateFull returns the full date representation of 't' for 'lzz'
func (lzz *lzz) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeShort returns the short time representation of 't' for 'lzz'
func (lzz *lzz) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeMedium returns the medium time representation of 't' for 'lzz'
func (lzz *lzz) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeLong returns the long time representation of 't' for 'lzz'
func (lzz *lzz) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeFull returns the full time representation of 't' for 'lzz'
func (lzz *lzz) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
