...
// New returns a new instance of translator for the 'tyv_RU' locale
...
func (tyv *tyv_RU) Locale() string {
	return tyv.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'tyv_RU'
func (tyv *tyv_RU) PluralsCardinal() []locales.PluralRule {
	return tyv.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'tyv_RU'
func (tyv *tyv_RU) PluralsOrdinal() []locales.PluralRule {
	return tyv.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'tyv_RU'
func (tyv *tyv_RU) PluralsRange() []locales.PluralRule {
	return tyv.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'tyv_RU'
func (tyv *tyv_RU) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'tyv_RU'
func (tyv *tyv_RU) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'tyv_RU'
func (tyv *tyv_RU) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (tyv *tyv_RU) MonthAbbreviated(month time.Month) string {
	return tyv.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (tyv *tyv_RU) MonthsAbbreviated() []string {
	return tyv.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (tyv *tyv_RU) MonthNarrow(month time.Month) string {
	return tyv.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (tyv *tyv_RU) MonthsNarrow() []string {
	return tyv.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (tyv *tyv_RU) MonthWide(month time.Month) string {
	return tyv.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (tyv *tyv_RU) MonthsWide() []string {
	return tyv.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (tyv *tyv_RU) WeekdayAbbreviated(weekday time.Weekday) string {
	return tyv.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (tyv *tyv_RU) WeekdaysAbbreviated() []string {
	return tyv.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (tyv *tyv_RU) WeekdayNarrow(weekday time.Weekday) string {
	return tyv.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (tyv *tyv_RU) WeekdaysNarrow() []string {
	return tyv.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (tyv *tyv_RU) WeekdayShort(weekday time.Weekday) string {
	return tyv.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (tyv *tyv_RU) WeekdaysShort() []string {
	return tyv.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (tyv *tyv_RU) WeekdayWide(weekday time.Weekday) string {
	return tyv.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (tyv *tyv_RU) WeekdaysWide() []string {
	return tyv.daysWide
}

// Decimal returns the decimal point of number
func (tyv *tyv_RU) Decimal() string {
	return tyv.decimal
}

// Group returns the group of number
func (tyv *tyv_RU) Group() string {
	return tyv.group
}

// Group returns the minus sign of number
func (tyv *tyv_RU) Minus() string {
	return tyv.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'tyv_RU' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (tyv *tyv_RU) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
