...
// New returns a new instance of translator for the 'shn' locale
...
func (shn *shn) MonthsAbbreviated() []string {
	return shn.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (shn *shn) MonthNarrow(month time.Month) string {
	if len(shn.monthsNarrow) == 0 {
		return ""
	}
...
func (shn *shn) MonthsNarrow() []string {
	return shn.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (shn *shn) MonthWide(month time.Month) string {
	if len(shn.monthsWide) == 0 {
		return ""
	}
...
func (shn *shn) MonthsWide() []string {
	return shn.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (shn *shn) WeekdayAbbreviated(weekday time.Weekday) string {
	if len(shn.daysAbbreviated) == 0 {
		return ""
	}
...
func (shn *shn) WeekdaysAbbreviated() []string {
	return shn.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (shn *shn) WeekdayNarrow(weekday time.Weekday) string {
	if len(shn.daysNarrow) == 0 {
		return ""
	}
...
func (shn *shn) WeekdaysNarrow() []string {
	return shn.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (shn *shn) WeekdayShort(weekday time.Weekday) string {
	if len(shn.daysShort) == 0 {
		return ""
	}
...
func (shn *shn) WeekdaysShort() []string {
	return shn.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (shn *shn) WeekdayWide(weekday time.Weekday) string {
	if len(shn.daysWide) == 0 {
		return ""
	}
...
func (shn *shn) WeekdaysWide() []string {
	return shn.daysWide
}

// Decimal returns the decimal point of number
func (shn *shn) Decimal() string {
	return shn.decimal
}

// Group returns the group of number
func (shn *shn) Group() string {
	return shn.group
}

// Group returns the minus sign of number
func (shn *shn) Minus() string {
	return shn.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'shn' and handles both Whole and Real numbers based on 'v'
func (shn *shn) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'shn' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (shn *shn) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
	...
	b = append(b, shn.percent...)

	return string(b)
}

// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'shn'
func (shn *shn) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'shn'
// in accounting notation.
func (shn *shn) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'shn'
func (shn *shn) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'shn'
func (shn *shn) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'shn'
func (shn *shn) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'shn'
func (shn *shn) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'shn'
func (shn *shn) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'shn'
func (shn *shn) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'shn'
func (shn *shn) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'shn'
func (shn *shn) FmtTimeFull(t time.Time) string {
