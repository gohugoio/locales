...
// New returns a new instance of translator for the 'suz_Sunu' locale
...
func (suz *suz_Sunu) Locale() string {
	return suz.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'suz_Sunu'
func (suz *suz_Sunu) PluralsCardinal() []locales.PluralRule {
	return suz.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'suz_Sunu'
func (suz *suz_Sunu) PluralsOrdinal() []locales.PluralRule {
	return suz.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'suz_Sunu'
func (suz *suz_Sunu) PluralsRange() []locales.PluralRule {
	return suz.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'suz_Sunu'
func (suz *suz_Sunu) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'suz_Sunu'
func (suz *suz_Sunu) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'suz_Sunu'
func (suz *suz_Sunu) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (suz *suz_Sunu) MonthsAbbreviated() []string {
	return nil
}
...
func (suz *suz_Sunu) MonthsNarrow() []string {
	return suz.monthsNarrow[1:]
}
...
func (suz *suz_Sunu) MonthsWide() []string {
	return suz.monthsWide[1:]
}
...
func (suz *suz_Sunu) WeekdaysAbbreviated() []string {
...
func (suz *suz_Sunu) WeekdaysNarrow() []string {
...
func (suz *suz_Sunu) WeekdaysShort() []string {
...
func (suz *suz_Sunu) WeekdaysWide() []string {
	return suz.daysWide
}

// Decimal returns the decimal point of number
func (suz *suz_Sunu) Decimal() string {
	return suz.decimal
}

// Group returns the group of number
func (suz *suz_Sunu) Group() string {
	return suz.group
}

// Group returns the minus sign of number
func (suz *suz_Sunu) Minus() string {
	return suz.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'suz_Sunu' and handles both Whole and Real numbers based on 'v'
func (suz *suz_Sunu) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'suz_Sunu' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (suz *suz_Sunu) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'suz_Sunu'
func (suz *suz_Sunu) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	...
	for j := len(suz.currencyPositivePrefix) - 1; j >= 0; j-- {
		b = append(b, suz.currencyPositivePrefix[j])
	}
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'suz_Sunu'
// in accounting notation.
func (suz *suz_Sunu) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	...
	if num < 0 {
		...
		for j := len(suz.currencyNegativePrefix) - 1; j >= 0; j-- {
			b = append(b, suz.currencyNegativePrefix[j])
		}
...
// FmtDateShort returns the short date representation of 't' for 'suz_Sunu'
func (suz *suz_Sunu) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'suz_Sunu'
func (suz *suz_Sunu) FmtDateMedium(t time.Time) string {
	...
	b = append(b, suz.monthsAbbreviated[t.Month()]...)
	b = append(b, []byte{0x20}...)
	b = strconv.AppendInt(b, int64(t.Day()), 10)
...
// FmtDateLong returns the long date representation of 't' for 'suz_Sunu'
func (suz *suz_Sunu) FmtDateLong(t time.Time) string {
	...
	b = append(b, []byte{0x20}...)
	b = append(b, suz.monthsWide[t.Month()]...)
	b = append(b, []byte{0x20}...)
	b = strconv.AppendInt(b, int64(t.Day()), 10)
...
// FmtDateFull returns the full date representation of 't' for 'suz_Sunu'
func (suz *suz_Sunu) FmtDateFull(t time.Time) string {
	...
	b = append(b, suz.daysWide[t.Weekday()]...)

	return string(b)
}

// FmtTimeShort returns the short time representation of 't' for 'suz_Sunu'
func (suz *suz_Sunu) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'suz_Sunu'
func (suz *suz_Sunu) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'suz_Sunu'
func (suz *suz_Sunu) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'suz_Sunu'
func (suz *suz_Sunu) FmtTimeFull(t time.Time) string {
