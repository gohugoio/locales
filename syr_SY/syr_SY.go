...
// New returns a new instance of translator for the 'syr_SY' locale
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'syr_SY'
func (syr *syr_SY) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'syr_SY'
func (syr *syr_SY) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (syr *syr_SY) MonthAbbreviated(month time.Month) string {
	return syr.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (syr *syr_SY) MonthsAbbreviated() []string {
	return syr.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (syr *syr_SY) MonthNarrow(month time.Month) string {
	return syr.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (syr *syr_SY) MonthsNarrow() []string {
	return syr.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (syr *syr_SY) MonthWide(month time.Month) string {
	return syr.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (syr *syr_SY) MonthsWide() []string {
	return syr.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (syr *syr_SY) WeekdayAbbreviated(weekday time.Weekday) string {
	return syr.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (syr *syr_SY) WeekdaysAbbreviated() []string {
	return syr.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (syr *syr_SY) WeekdayNarrow(weekday time.Weekday) string {
	return syr.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (syr *syr_SY) WeekdaysNarrow() []string {
	return syr.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (syr *syr_SY) WeekdayShort(weekday time.Weekday) string {
	return syr.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (syr *syr_SY) WeekdaysShort() []string {
	return syr.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (syr *syr_SY) WeekdayWide(weekday time.Weekday) string {
	return syr.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (syr *syr_SY) WeekdaysWide() []string {
	return syr.daysWide
}

// Decimal returns the decimal point of number
func (syr *syr_SY) Decimal() string {
	return syr.decimal
}

// Group returns the group of number
func (syr *syr_SY) Group() string {
	return syr.group
}

// Group returns the minus sign of number
func (syr *syr_SY) Minus() string {
	return syr.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'syr_SY' and handles both Whole and Real numbers based on 'v'
func (syr *syr_SY) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'syr_SY' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (syr *syr_SY) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'syr_SY'
func (syr *syr_SY) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := syr.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'syr_SY'
// in accounting notation.
func (syr *syr_SY) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := syr.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtDateShort returns the short date representation of 't' for 'syr_SY'
func (syr *syr_SY) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateMedium returns the medium date representation of 't' for 'syr_SY'
func (syr *syr_SY) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateLong returns the long date representation of 't' for 'syr_SY'
func (syr *syr_SY) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateFull returns the full date representation of 't' for 'syr_SY'
func (syr *syr_SY) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeShort returns the short time representation of 't' for 'syr_SY'
func (syr *syr_SY) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeMedium returns the medium time representation of 't' for 'syr_SY'
func (syr *syr_SY) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeLong returns the long time representation of 't' for 'syr_SY'
func (syr *syr_SY) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeFull returns the full time representation of 't' for 'syr_SY'
func (syr *syr_SY) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
