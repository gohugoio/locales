...
func (myv *myv_RU) Locale() string {
	return myv.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'myv_RU'
func (myv *myv_RU) PluralsCardinal() []locales.PluralRule {
	return myv.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'myv_RU'
func (myv *myv_RU) PluralsOrdinal() []locales.PluralRule {
	return myv.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'myv_RU'
func (myv *myv_RU) PluralsRange() []locales.PluralRule {
	return myv.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'myv_RU'
func (myv *myv_RU) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'myv_RU'
func (myv *myv_RU) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'myv_RU'
func (myv *myv_RU) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (myv *myv_RU) MonthAbbreviated(month time.Month) string {
...
func (myv *myv_RU) MonthsAbbreviated() []string {
	return myv.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (myv *myv_RU) MonthNarrow(month time.Month) string {
...
func (myv *myv_RU) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (myv *myv_RU) MonthWide(month time.Month) string {
...
func (myv *myv_RU) MonthsWide() []string {
	return myv.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (myv *myv_RU) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (myv *myv_RU) WeekdaysAbbreviated() []string {
	return myv.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (myv *myv_RU) WeekdayNarrow(weekday time.Weekday) string {
...
func (myv *myv_RU) WeekdaysNarrow() []string {
	return myv.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (myv *myv_RU) WeekdayShort(weekday time.Weekday) string {
...
func (myv *myv_RU) WeekdaysShort() []string {
	return myv.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (myv *myv_RU) WeekdayWide(weekday time.Weekday) string {
...
func (myv *myv_RU) WeekdaysWide() []string {
	return myv.daysWide
}

// Decimal returns the decimal point of number
func (myv *myv_RU) Decimal() string {
	return myv.decimal
}

// Group returns the group of number
func (myv *myv_RU) Group() string {
	return myv.group
}

// Group returns the minus sign of number
func (myv *myv_RU) Minus() string {
	return myv.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'myv_RU' and handles both Whole and Real numbers based on 'v'
func (myv *myv_RU) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'myv_RU' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (myv *myv_RU) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'myv_RU'
func (myv *myv_RU) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := myv.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'myv_RU'
// in accounting notation.
func (myv *myv_RU) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := myv.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtDateShort returns the short date representation of 't' for 'myv_RU'
func (myv *myv_RU) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateMedium returns the medium date representation of 't' for 'myv_RU'
func (myv *myv_RU) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateLong returns the long date representation of 't' for 'myv_RU'
func (myv *myv_RU) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateFull returns the full date representation of 't' for 'myv_RU'
func (myv *myv_RU) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeShort returns the short time representation of 't' for 'myv_RU'
func (myv *myv_RU) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeMedium returns the medium time representation of 't' for 'myv_RU'
func (myv *myv_RU) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeLong returns the long time representation of 't' for 'myv_RU'
func (myv *myv_RU) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeFull returns the full time representation of 't' for 'myv_RU'
func (myv *myv_RU) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
