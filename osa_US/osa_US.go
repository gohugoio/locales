...
// New returns a new instance of translator for the 'osa_US' locale
...
func (osa *osa_US) Locale() string {
	return osa.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'osa_US'
func (osa *osa_US) PluralsCardinal() []locales.PluralRule {
	return osa.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'osa_US'
func (osa *osa_US) PluralsOrdinal() []locales.PluralRule {
	return osa.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'osa_US'
func (osa *osa_US) PluralsRange() []locales.PluralRule {
	return osa.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'osa_US'
func (osa *osa_US) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'osa_US'
func (osa *osa_US) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'osa_US'
func (osa *osa_US) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (osa *osa_US) MonthAbbreviated(month time.Month) string {
	return osa.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (osa *osa_US) MonthsAbbreviated() []string {
	return osa.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (osa *osa_US) MonthNarrow(month time.Month) string {
	return osa.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (osa *osa_US) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (osa *osa_US) MonthWide(month time.Month) string {
	return osa.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (osa *osa_US) MonthsWide() []string {
	return osa.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (osa *osa_US) WeekdayAbbreviated(weekday time.Weekday) string {
	return osa.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (osa *osa_US) WeekdaysAbbreviated() []string {
	return osa.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (osa *osa_US) WeekdayNarrow(weekday time.Weekday) string {
	return osa.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (osa *osa_US) WeekdaysNarrow() []string {
	return osa.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (osa *osa_US) WeekdayShort(weekday time.Weekday) string {
	return osa.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (osa *osa_US) WeekdaysShort() []string {
	return osa.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (osa *osa_US) WeekdayWide(weekday time.Weekday) string {
	return osa.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (osa *osa_US) WeekdaysWide() []string {
	return osa.daysWide
}

// Decimal returns the decimal point of number
func (osa *osa_US) Decimal() string {
	return osa.decimal
}

// Group returns the group of number
func (osa *osa_US) Group() string {
	return osa.group
}

// Group returns the minus sign of number
func (osa *osa_US) Minus() string {
	return osa.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'osa_US' and handles both Whole and Real numbers based on 'v'
func (osa *osa_US) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'osa_US' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (osa *osa_US) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
	...
	b = append(b, osa.percent...)

	return string(b)
}

// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'osa_US'
func (osa *osa_US) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'osa_US'
// in accounting notation.
func (osa *osa_US) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'osa_US'
func (osa *osa_US) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'osa_US'
func (osa *osa_US) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'osa_US'
func (osa *osa_US) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'osa_US'
func (osa *osa_US) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'osa_US'
func (osa *osa_US) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'osa_US'
func (osa *osa_US) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'osa_US'
func (osa *osa_US) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'osa_US'
func (osa *osa_US) FmtTimeFull(t time.Time) string {
