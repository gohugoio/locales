...
// New returns a new instance of translator for the 'apc' locale
...
func (apc *apc) Locale() string {
	return apc.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'apc'
func (apc *apc) PluralsCardinal() []locales.PluralRule {
	return apc.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'apc'
func (apc *apc) PluralsOrdinal() []locales.PluralRule {
	return apc.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'apc'
func (apc *apc) PluralsRange() []locales.PluralRule {
	return apc.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'apc'
func (apc *apc) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'apc'
func (apc *apc) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'apc'
func (apc *apc) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (apc *apc) MonthAbbreviated(month time.Month) string {
...
func (apc *apc) MonthsAbbreviated() []string {
	return nil
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (apc *apc) MonthNarrow(month time.Month) string {
...
func (apc *apc) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (apc *apc) MonthWide(month time.Month) string {
...
func (apc *apc) MonthsWide() []string {
	return apc.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (apc *apc) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (apc *apc) WeekdaysAbbreviated() []string {
	return apc.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (apc *apc) WeekdayNarrow(weekday time.Weekday) string {
...
func (apc *apc) WeekdaysNarrow() []string {
	return apc.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (apc *apc) WeekdayShort(weekday time.Weekday) string {
...
func (apc *apc) WeekdaysShort() []string {
	return apc.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (apc *apc) WeekdayWide(weekday time.Weekday) string {
...
func (apc *apc) WeekdaysWide() []string {
	return apc.daysWide
}

// Decimal returns the decimal point of number
func (apc *apc) Decimal() string {
	return apc.decimal
}

// Group returns the group of number
func (apc *apc) Group() string {
	return apc.group
}

// Group returns the minus sign of number
func (apc *apc) Minus() string {
	return apc.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'apc' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (apc *apc) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
