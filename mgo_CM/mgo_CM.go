...
func New() locales.Translator {
	return &mgo_CM{
		...
		daysShort:         []string{"A1", "A2", "A3", "A4", "A5", "A6", "A7"},
...
func (mgo *mgo_CM) MonthAbbreviated(month time.Month) string {
	if len(mgo.monthsAbbreviated) == 0 {
		return ""
	}
