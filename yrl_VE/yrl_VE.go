...
func New() locales.Translator {
	return &yrl_VE{
		...
		percent:                "%",
		timeSeparator:          ":",
		currencies:             []string{"ADP", "AED", "AFA", "AFN", "ALK", "ALL", "AMD", "ANG", "AOA", "AOK", "AON", "AOR", "ARA", "ARL", "ARM", "ARP", "ARS", "ATS", "AU$", "AWG", "AZM", "AZN", "BAD", "BAM", "BAN", "BBD", "BDT", "BEC", "BEF", "BEL", "BGL", "BGM", "BGN", "BGO", "BHD", "BIF", "BMD", "BND", "BUB", "BOL", "BOP", "BOV", "BRB", "BRC", "BRE", "BRL", "BRN", "BRR", "BRZ", "BSD", "BTN", "BUK", "BWP", "BYB", "p.", "BYR", "BZD", "CAD", "CDF", "CHE", "CHF", "CHW", "CLE", "CLF", "CLP", "CNH", "CNX", "CNY", "$", "COU", "CRC", "CSD", "CSK", "CUC", "CUP", "CVE", "CYP", "CZK", "DDM", "DEM", "DJF", "DKK", "DOP", "DZD", "ECS", "ECV", "EEK", "EGP", "ERN", "ESA", "ESB", "ESP", "ETB", "EUR", "FIM", "FJD", "FKP", "FRF", "GBP", "GEK", "GEL", "GHC", "GHS", "GIP", "GMD", "GNF", "GNS", "GQE", "GRD", "GTQ", "GWE", "GWP", "GYD", "HKD", "HNL", "HRD", "HRK", "HTG", "HUF", "IDR", "IEP", "ILP", "ILR", "ILS", "INR", "IQD", "IRR", "ISJ", "ISK", "ITL", "JMD", "JOD", "JPY", "KES", "KGS", "KHR", "KMF", "KPW", "KRH", "KRO", "KRW", "KWD", "KYD", "KZT", "LAK", "LBP", "LKR", "LRD", "LSL", "LTL", "LTT", "LUC", "LUF", "LUL", "LVL", "LVR", "LYD", "MAD", "MAF", "MCF", "MDC", "MDL", "MGA", "MGF", "MKD", "MKN", "MLF", "MMK", "MNT", "MOP", "MRO", "MRU", "MTL", "MTP", "MUR", "MVP", "MVR", "MWK", "MXN", "MXP", "MXV", "MYR", "MZE", "MZM", "MZN", "NAD", "NGN", "NIC", "NIO", "NLG", "NOK", "NPR", "NZD", "OMR", "PAB", "PEI", "PEN", "PES", "PGK", "PHP", "PKR", "PLN", "PLZ", "Esc.", "PYG", "QAR", "RHD", "ROL", "L", "RSD", "RUB", "RUR", "RWF", "SAR", "SBD", "SCRu", "SDD", "SDG", "SDP", "SEK", "SGD", "SHP", "SIT", "SKK", "SLE", "SLL", "SOS", "SRD", "SRG", "SSP", "STD", "STN", "SUR", "SVC", "S£", "SZL", "฿", "TJR", "TJS", "TMM", "TMT", "TND", "TOP", "TPE", "TRL", "TRY", "TTD", "NT$", "TZS", "UAH", "UAK", "UGS", "UGX", "USD", "USN", "USS", "UYI", "UYP", "UYU", "UYW", "UZS", "VEB", "VED", "VEF", "Bs.S", "VND", "VNN", "VUV", "WST", "FCF", "XAG", "XAU", "XBA", "XBB", "XBC", "XBD", "XCD", "XCG", "XDR", "XEU", "XFO", "XFU", "CFA", "XPD", "CFP", "XPT", "XRE", "XSU", "XTS", "XUA", "XXX", "YDD", "YER", "YUD", "YUM", "YUN", "YUR", "ZAL", "ZAR", "ZMK", "Zk", "ZRN", "ZRZ", "ZWD", "ZWG", "ZWL", "ZWR"},
...
func (yrl *yrl_VE) MonthAbbreviated(month time.Month) string {
	if len(yrl.monthsAbbreviated) == 0 {
		return ""
	}
...
func (yrl *yrl_VE) MonthsAbbreviated() []string {
	return yrl.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (yrl *yrl_VE) MonthNarrow(month time.Month) string {
	if len(yrl.monthsNarrow) == 0 {
		return ""
	}
...
func (yrl *yrl_VE) MonthsNarrow() []string {
	return yrl.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (yrl *yrl_VE) MonthWide(month time.Month) string {
	if len(yrl.monthsWide) == 0 {
		return ""
	}
...
func (yrl *yrl_VE) MonthsWide() []string {
	return yrl.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (yrl *yrl_VE) WeekdayAbbreviated(weekday time.Weekday) string {
	if len(yrl.daysAbbreviated) == 0 {
		return ""
	}
...
func (yrl *yrl_VE) WeekdaysAbbreviated() []string {
	return yrl.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (yrl *yrl_VE) WeekdayNarrow(weekday time.Weekday) string {
	if len(yrl.daysNarrow) == 0 {
		return ""
	}
...
func (yrl *yrl_VE) WeekdaysNarrow() []string {
	return yrl.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (yrl *yrl_VE) WeekdayShort(weekday time.Weekday) string {
	if len(yrl.daysShort) == 0 {
		return ""
	}
...
func (yrl *yrl_VE) WeekdaysShort() []string {
	return yrl.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (yrl *yrl_VE) WeekdayWide(weekday time.Weekday) string {
	if len(yrl.daysWide) == 0 {
		return ""
	}
...
func (yrl *yrl_VE) WeekdaysWide() []string {
	return yrl.daysWide
}

// Decimal returns the decimal point of number
func (yrl *yrl_VE) Decimal() string {
	return yrl.decimal
}

// Group returns the group of number
func (yrl *yrl_VE) Group() string {
	return yrl.group
}

// Group returns the minus sign of number
func (yrl *yrl_VE) Minus() string {
	return yrl.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'yrl_VE' and handles both Whole and Real numbers based on 'v'
func (yrl *yrl_VE) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'yrl_VE' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (yrl *yrl_VE) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'yrl_VE'
func (yrl *yrl_VE) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'yrl_VE'
// in accounting notation.
func (yrl *yrl_VE) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
func (yrl *yrl_VE) FmtTimeShort(t time.Time) string {
	...
	if t.Hour() < 12 {
		b = append(b, yrl.periodsAbbreviated[0]...)
	} else {
		b = append(b, yrl.periodsAbbreviated[1]...)
	}
