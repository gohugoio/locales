...
func (sc *sc) MonthAbbreviated(month time.Month) string {
	if len(sc.monthsAbbreviated) == 0 {
		return ""
	}
...
func (sc *sc) MonthsAbbreviated() []string {
	return sc.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (sc *sc) MonthNarrow(month time.Month) string {
	if len(sc.monthsNarrow) == 0 {
		return ""
	}
...
func (sc *sc) MonthsNarrow() []string {
	return sc.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (sc *sc) MonthWide(month time.Month) string {
	if len(sc.monthsWide) == 0 {
		return ""
	}
...
func (sc *sc) MonthsWide() []string {
	return sc.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (sc *sc) WeekdayAbbreviated(weekday time.Weekday) string {
	if len(sc.daysAbbreviated) == 0 {
		return ""
	}
...
func (sc *sc) WeekdaysAbbreviated() []string {
	return sc.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (sc *sc) WeekdayNarrow(weekday time.Weekday) string {
	if len(sc.daysNarrow) == 0 {
		return ""
	}
...
func (sc *sc) WeekdaysNarrow() []string {
	return sc.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (sc *sc) WeekdayShort(weekday time.Weekday) string {
	if len(sc.daysShort) == 0 {
		return ""
	}
...
func (sc *sc) WeekdaysShort() []string {
	return sc.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (sc *sc) WeekdayWide(weekday time.Weekday) string {
	if len(sc.daysWide) == 0 {
		return ""
	}
...
func (sc *sc) WeekdaysWide() []string {
	return sc.daysWide
}

// Decimal returns the decimal point of number
func (sc *sc) Decimal() string {
	return sc.decimal
}

// Group returns the group of number
func (sc *sc) Group() string {
	return sc.group
}

// Group returns the minus sign of number
func (sc *sc) Minus() string {
	return sc.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'sc' and handles both Whole and Real numbers based on 'v'
func (sc *sc) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'sc' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (sc *sc) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'sc'
func (sc *sc) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'sc'
// in accounting notation.
func (sc *sc) FmtAccounting(num float64, v uint64, currency currency.Type) string {
