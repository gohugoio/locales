...
// New returns a new instance of translator for the 'mdf_RU' locale
...
func (mdf *mdf_RU) Locale() string {
	return mdf.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'mdf_RU'
func (mdf *mdf_RU) PluralsCardinal() []locales.PluralRule {
	return mdf.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'mdf_RU'
func (mdf *mdf_RU) PluralsOrdinal() []locales.PluralRule {
	return mdf.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'mdf_RU'
func (mdf *mdf_RU) PluralsRange() []locales.PluralRule {
	return mdf.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'mdf_RU'
func (mdf *mdf_RU) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'mdf_RU'
func (mdf *mdf_RU) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'mdf_RU'
func (mdf *mdf_RU) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (mdf *mdf_RU) MonthsAbbreviated() []string {
	return nil
}
...
func (mdf *mdf_RU) MonthsNarrow() []string {
	return nil
}
...
func (mdf *mdf_RU) MonthsWide() []string {
	return nil
}
...
func (mdf *mdf_RU) WeekdaysAbbreviated() []string {
	return mdf.daysAbbreviated
}
...
func (mdf *mdf_RU) WeekdaysNarrow() []string {
	return mdf.daysNarrow
}
...
func (mdf *mdf_RU) WeekdaysShort() []string {
	return mdf.daysShort
}
...
func (mdf *mdf_RU) WeekdaysWide() []string {
	return mdf.daysWide
}

// Decimal returns the decimal point of number
func (mdf *mdf_RU) Decimal() string {
	return mdf.decimal
}

// Group returns the group of number
func (mdf *mdf_RU) Group() string {
	return mdf.group
}

// Group returns the minus sign of number
func (mdf *mdf_RU) Minus() string {
	return mdf.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'mdf_RU' and handles both Whole and Real numbers based on 'v'
func (mdf *mdf_RU) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'mdf_RU' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (mdf *mdf_RU) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
	...
	b = append(b, mdf.percent...)

	return string(b)
}

// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'mdf_RU'
func (mdf *mdf_RU) FmtCurrency(num float64, v uint64, currency currency.Type) string {

	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := mdf.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'mdf_RU'
// in accounting notation.
func (mdf *mdf_RU) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'mdf_RU'
func (mdf *mdf_RU) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'mdf_RU'
func (mdf *mdf_RU) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'mdf_RU'
func (mdf *mdf_RU) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'mdf_RU'
func (mdf *mdf_RU) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'mdf_RU'
func (mdf *mdf_RU) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'mdf_RU'
func (mdf *mdf_RU) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'mdf_RU'
func (mdf *mdf_RU) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'mdf_RU'
func (mdf *mdf_RU) FmtTimeFull(t time.Time) string {
