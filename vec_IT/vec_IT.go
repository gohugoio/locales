...
// New returns a new instance of translator for the 'vec_IT' locale
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'vec_IT'
func (vec *vec_IT) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'vec_IT'
func (vec *vec_IT) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (vec *vec_IT) MonthAbbreviated(month time.Month) string {
	if len(vec.monthsAbbreviated) == 0 {
		return ""
	}
...
func (vec *vec_IT) MonthsAbbreviated() []string {
	return vec.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (vec *vec_IT) MonthNarrow(month time.Month) string {
	if len(vec.monthsNarrow) == 0 {
		return ""
	}
...
func (vec *vec_IT) MonthsNarrow() []string {
	return vec.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (vec *vec_IT) MonthWide(month time.Month) string {
	if len(vec.monthsWide) == 0 {
		return ""
	}
...
func (vec *vec_IT) MonthsWide() []string {
	return vec.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (vec *vec_IT) WeekdayAbbreviated(weekday time.Weekday) string {
	if len(vec.daysAbbreviated) == 0 {
		return ""
	}
...
func (vec *vec_IT) WeekdaysAbbreviated() []string {
	return vec.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (vec *vec_IT) WeekdayNarrow(weekday time.Weekday) string {
	if len(vec.daysNarrow) == 0 {
		return ""
	}
...
func (vec *vec_IT) WeekdaysNarrow() []string {
	return vec.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (vec *vec_IT) WeekdayShort(weekday time.Weekday) string {
	if len(vec.daysShort) == 0 {
		return ""
	}
...
func (vec *vec_IT) WeekdaysShort() []string {
	return vec.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (vec *vec_IT) WeekdayWide(weekday time.Weekday) string {
	if len(vec.daysWide) == 0 {
		return ""
	}
...
func (vec *vec_IT) WeekdaysWide() []string {
	return vec.daysWide
}

// Decimal returns the decimal point of number
func (vec *vec_IT) Decimal() string {
	return vec.decimal
}

// Group returns the group of number
func (vec *vec_IT) Group() string {
	return vec.group
}

// Group returns the minus sign of number
func (vec *vec_IT) Minus() string {
	return vec.minus
}
...
func (vec *vec_IT) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'vec_IT'
// in accounting notation.
func (vec *vec_IT) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'vec_IT'
func (vec *vec_IT) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'vec_IT'
func (vec *vec_IT) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'vec_IT'
func (vec *vec_IT) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'vec_IT'
func (vec *vec_IT) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'vec_IT'
func (vec *vec_IT) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'vec_IT'
func (vec *vec_IT) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'vec_IT'
func (vec *vec_IT) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'vec_IT'
func (vec *vec_IT) FmtTimeFull(t time.Time) string {
