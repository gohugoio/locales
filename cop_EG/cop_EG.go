...
func New() locales.Translator {
	return &cop_EG{
		...
		periodsAbbreviated: []string{"Ϧ︦Ⲙ︦", "Ⲙ︦Ⲙ︦"},
		periodsNarrow:      []string{"Ϧ︦Ⲙ︦", "Ⲙ︦Ⲙ︦"},
		periodsWide:        []string{"ϧⲁϫⲉⲛ ⲙⲉⲣⲓ", "ⲙⲉⲛⲉⲛⲥⲁ ⲙⲉⲣⲓ"},
		erasAbbreviated:    []string{"ϧⲁϫⲉⲛ ⲡⲭ︦ⲥ︦", "ⲙⲉⲛⲉⲛⲥⲁ ⲡⲭ︦ⲥ︦"},
		erasNarrow:         []string{"", ""},
		erasWide:           []string{"ϧⲁϫⲉⲛ ⲡⲓⲭⲣⲓⲥⲧⲟⲥ", "ⲙⲉⲛⲉⲛⲥⲁ ⲡⲓⲭⲣⲓⲥⲧⲟⲥ"},
