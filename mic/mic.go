...
// New returns a new instance of translator for the 'mic' locale
...
func (mic *mic) Locale() string {
	return mic.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'mic'
func (mic *mic) PluralsCardinal() []locales.PluralRule {
	return mic.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'mic'
func (mic *mic) PluralsOrdinal() []locales.PluralRule {
	return mic.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'mic'
func (mic *mic) PluralsRange() []locales.PluralRule {
	return mic.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'mic'
func (mic *mic) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'mic'
func (mic *mic) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'mic'
func (mic *mic) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (mic *mic) MonthAbbreviated(month time.Month) string {
...
func (mic *mic) MonthsAbbreviated() []string {
	return nil
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (mic *mic) MonthNarrow(month time.Month) string {
...
func (mic *mic) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (mic *mic) MonthWide(month time.Month) string {
...
func (mic *mic) MonthsWide() []string {
	return nil
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (mic *mic) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (mic *mic) WeekdaysAbbreviated() []string {
	return mic.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (mic *mic) WeekdayNarrow(weekday time.Weekday) string {
...
func (mic *mic) WeekdaysNarrow() []string {
	return mic.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (mic *mic) WeekdayShort(weekday time.Weekday) string {
...
func (mic *mic) WeekdaysShort() []string {
	return mic.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (mic *mic) WeekdayWide(weekday time.Weekday) string {
...
func (mic *mic) WeekdaysWide() []string {
	return mic.daysWide
}

// Decimal returns the decimal point of number
func (mic *mic) Decimal() string {
	return mic.decimal
}

// Group returns the group of number
func (mic *mic) Group() string {
	return mic.group
}

// Group returns the minus sign of number
func (mic *mic) Minus() string {
	return mic.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'mic' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (mic *mic) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
