...
// New returns a new instance of translator for the 'bua_RU' locale
...
func (bua *bua_RU) Locale() string {
	return bua.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'bua_RU'
func (bua *bua_RU) PluralsCardinal() []locales.PluralRule {
	return bua.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'bua_RU'
func (bua *bua_RU) PluralsOrdinal() []locales.PluralRule {
	return bua.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'bua_RU'
func (bua *bua_RU) PluralsRange() []locales.PluralRule {
	return bua.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'bua_RU'
func (bua *bua_RU) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'bua_RU'
func (bua *bua_RU) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'bua_RU'
func (bua *bua_RU) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (bua *bua_RU) MonthsAbbreviated() []string {
	return nil
}
...
func (bua *bua_RU) MonthsNarrow() []string {
	return nil
}
...
func (bua *bua_RU) MonthsWide() []string {
...
func (bua *bua_RU) WeekdaysAbbreviated() []string {
...
func (bua *bua_RU) WeekdaysNarrow() []string {
...
func (bua *bua_RU) WeekdaysShort() []string {
...
func (bua *bua_RU) WeekdaysWide() []string {
	return bua.daysWide
}

// Decimal returns the decimal point of number
func (bua *bua_RU) Decimal() string {
	return bua.decimal
}

// Group returns the group of number
func (bua *bua_RU) Group() string {
	return bua.group
}

// Group returns the minus sign of number
func (bua *bua_RU) Minus() string {
	return bua.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'bua_RU' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (bua *bua_RU) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 5
	b := make([]byte, 0, l)
