...
// New returns a new instance of translator for the 'iu_CA' locale
...
func (iu *iu_CA) Locale() string {
	return iu.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'iu_CA'
func (iu *iu_CA) PluralsCardinal() []locales.PluralRule {
	return iu.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'iu_CA'
func (iu *iu_CA) PluralsOrdinal() []locales.PluralRule {
	return iu.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'iu_CA'
func (iu *iu_CA) PluralsRange() []locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'iu_CA'
func (iu *iu_CA) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'iu_CA'
func (iu *iu_CA) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (iu *iu_CA) MonthAbbreviated(month time.Month) string {
...
func (iu *iu_CA) MonthsAbbreviated() []string {
	return nil
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (iu *iu_CA) MonthNarrow(month time.Month) string {
...
func (iu *iu_CA) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (iu *iu_CA) MonthWide(month time.Month) string {
...
func (iu *iu_CA) MonthsWide() []string {
	return iu.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (iu *iu_CA) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (iu *iu_CA) WeekdaysAbbreviated() []string {
	return iu.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (iu *iu_CA) WeekdayNarrow(weekday time.Weekday) string {
...
func (iu *iu_CA) WeekdaysNarrow() []string {
	return iu.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (iu *iu_CA) WeekdayShort(weekday time.Weekday) string {
...
func (iu *iu_CA) WeekdaysShort() []string {
	return iu.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (iu *iu_CA) WeekdayWide(weekday time.Weekday) string {
...
func (iu *iu_CA) WeekdaysWide() []string {
	return iu.daysWide
}

// Decimal returns the decimal point of number
func (iu *iu_CA) Decimal() string {
	return iu.decimal
}

// Group returns the group of number
func (iu *iu_CA) Group() string {
	return iu.group
}

// Group returns the minus sign of number
func (iu *iu_CA) Minus() string {
	return iu.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'iu_CA' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (iu *iu_CA) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
