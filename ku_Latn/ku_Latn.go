...
// New returns a new instance of translator for the 'ku_Latn' locale
...
func (ku *ku_Latn) Locale() string {
	return ku.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'ku_Latn'
func (ku *ku_Latn) PluralsCardinal() []locales.PluralRule {
	return ku.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'ku_Latn'
func (ku *ku_Latn) PluralsOrdinal() []locales.PluralRule {
	return ku.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'ku_Latn'
func (ku *ku_Latn) PluralsRange() []locales.PluralRule {
	return ku.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'ku_Latn'
func (ku *ku_Latn) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'ku_Latn'
func (ku *ku_Latn) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'ku_Latn'
func (ku *ku_Latn) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (ku *ku_Latn) MonthAbbreviated(month time.Month) string {
...
func (ku *ku_Latn) MonthsAbbreviated() []string {
	return ku.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (ku *ku_Latn) MonthNarrow(month time.Month) string {
...
func (ku *ku_Latn) MonthsNarrow() []string {
	return ku.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (ku *ku_Latn) MonthWide(month time.Month) string {
...
func (ku *ku_Latn) MonthsWide() []string {
	return ku.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (ku *ku_Latn) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (ku *ku_Latn) WeekdaysAbbreviated() []string {
	return ku.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (ku *ku_Latn) WeekdayNarrow(weekday time.Weekday) string {
...
func (ku *ku_Latn) WeekdaysNarrow() []string {
	return ku.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (ku *ku_Latn) WeekdayShort(weekday time.Weekday) string {
...
func (ku *ku_Latn) WeekdaysShort() []string {
	return ku.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (ku *ku_Latn) WeekdayWide(weekday time.Weekday) string {
...
func (ku *ku_Latn) WeekdaysWide() []string {
	return ku.daysWide
}

// Decimal returns the decimal point of number
func (ku *ku_Latn) Decimal() string {
	return ku.decimal
}

// Group returns the group of number
func (ku *ku_Latn) Group() string {
	return ku.group
}

// Group returns the minus sign of number
func (ku *ku_Latn) Minus() string {
	return ku.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'ku_Latn' and handles both Whole and Real numbers based on 'v'
func (ku *ku_Latn) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'ku_Latn' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (ku *ku_Latn) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'ku_Latn'
func (ku *ku_Latn) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'ku_Latn'
// in accounting notation.
func (ku *ku_Latn) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'ku_Latn'
func (ku *ku_Latn) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'ku_Latn'
func (ku *ku_Latn) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'ku_Latn'
func (ku *ku_Latn) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'ku_Latn'
func (ku *ku_Latn) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'ku_Latn'
func (ku *ku_Latn) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'ku_Latn'
func (ku *ku_Latn) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'ku_Latn'
func (ku *ku_Latn) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'ku_Latn'
func (ku *ku_Latn) FmtTimeFull(t time.Time) string {
