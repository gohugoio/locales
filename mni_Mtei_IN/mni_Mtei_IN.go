...
// New returns a new instance of translator for the 'mni_Mtei_IN' locale
...
func (mni *mni_Mtei_IN) Locale() string {
	return mni.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) PluralsCardinal() []locales.PluralRule {
	return mni.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) PluralsOrdinal() []locales.PluralRule {
	return mni.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) PluralsRange() []locales.PluralRule {
	return mni.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (mni *mni_Mtei_IN) MonthAbbreviated(month time.Month) string {
	return mni.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (mni *mni_Mtei_IN) MonthsAbbreviated() []string {
	return mni.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (mni *mni_Mtei_IN) MonthNarrow(month time.Month) string {
	return mni.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (mni *mni_Mtei_IN) MonthsNarrow() []string {
	return mni.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (mni *mni_Mtei_IN) MonthWide(month time.Month) string {
	return mni.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (mni *mni_Mtei_IN) MonthsWide() []string {
	return mni.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (mni *mni_Mtei_IN) WeekdayAbbreviated(weekday time.Weekday) string {
	return mni.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (mni *mni_Mtei_IN) WeekdaysAbbreviated() []string {
	return mni.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (mni *mni_Mtei_IN) WeekdayNarrow(weekday time.Weekday) string {
	return mni.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (mni *mni_Mtei_IN) WeekdaysNarrow() []string {
	return mni.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (mni *mni_Mtei_IN) WeekdayShort(weekday time.Weekday) string {
	return mni.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (mni *mni_Mtei_IN) WeekdaysShort() []string {
	return mni.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (mni *mni_Mtei_IN) WeekdayWide(weekday time.Weekday) string {
	return mni.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (mni *mni_Mtei_IN) WeekdaysWide() []string {
	return mni.daysWide
}

// Decimal returns the decimal point of number
func (mni *mni_Mtei_IN) Decimal() string {
	return mni.decimal
}

// Group returns the group of number
func (mni *mni_Mtei_IN) Group() string {
	return mni.group
}

// Group returns the minus sign of number
func (mni *mni_Mtei_IN) Minus() string {
	return mni.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'mni_Mtei_IN' and handles both Whole and Real numbers based on 'v'
func (mni *mni_Mtei_IN) FmtNumber(num float64, v uint64) string {

	return strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
}

// FmtPercent returns 'num' with digits/precision of 'v' for 'mni_Mtei_IN' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (mni *mni_Mtei_IN) FmtPercent(num float64, v uint64) string {
	return strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
}

// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'mni_Mtei_IN'
// in accounting notation.
func (mni *mni_Mtei_IN) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'mni_Mtei_IN'
func (mni *mni_Mtei_IN) FmtTimeFull(t time.Time) string {
