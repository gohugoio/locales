...
// New returns a new instance of translator for the 'mic_CA' locale
...
func (mic *mic_CA) Locale() string {
	return mic.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'mic_CA'
func (mic *mic_CA) PluralsCardinal() []locales.PluralRule {
	return mic.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'mic_CA'
func (mic *mic_CA) PluralsOrdinal() []locales.PluralRule {
	return mic.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'mic_CA'
func (mic *mic_CA) PluralsRange() []locales.PluralRule {
	return mic.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'mic_CA'
func (mic *mic_CA) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'mic_CA'
func (mic *mic_CA) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'mic_CA'
func (mic *mic_CA) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (mic *mic_CA) MonthsAbbreviated() []string {
	return nil
}
...
func (mic *mic_CA) MonthsNarrow() []string {
	return nil
}
...
func (mic *mic_CA) MonthsWide() []string {
	return nil
}
...
func (mic *mic_CA) WeekdaysAbbreviated() []string {
	return mic.daysAbbreviated
}
...
func (mic *mic_CA) WeekdaysNarrow() []string {
	return mic.daysNarrow
}
...
func (mic *mic_CA) WeekdaysShort() []string {
	return mic.daysShort
}
...
func (mic *mic_CA) WeekdaysWide() []string {
	return mic.daysWide
}

// Decimal returns the decimal point of number
func (mic *mic_CA) Decimal() string {
	return mic.decimal
}

// Group returns the group of number
func (mic *mic_CA) Group() string {
	return mic.group
}

// Group returns the minus sign of number
func (mic *mic_CA) Minus() string {
	return mic.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'mic_CA' and handles both Whole and Real numbers based on 'v'
func (mic *mic_CA) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'mic_CA' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (mic *mic_CA) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
	...
	b = append(b, mic.percent...)

	return string(b)
}

// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'mic_CA'
func (mic *mic_CA) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := mic.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'mic_CA'
// in accounting notation.
func (mic *mic_CA) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := mic.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtDateShort returns the short date representation of 't' for 'mic_CA'
func (mic *mic_CA) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateMedium returns the medium date representation of 't' for 'mic_CA'
func (mic *mic_CA) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateLong returns the long date representation of 't' for 'mic_CA'
func (mic *mic_CA) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateFull returns the full date representation of 't' for 'mic_CA'
func (mic *mic_CA) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeShort returns the short time representation of 't' for 'mic_CA'
func (mic *mic_CA) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)
	...
	if t.Hour() < 12 {
		b = append(b, mic.periodsAbbreviated[0]...)
	} else {
		b = append(b, mic.periodsAbbreviated[1]...)
	}

	return string(b)
}

// FmtTimeMedium returns the medium time representation of 't' for 'mic_CA'
func (mic *mic_CA) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeLong returns the long time representation of 't' for 'mic_CA'
func (mic *mic_CA) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeFull returns the full time representation of 't' for 'mic_CA'
func (mic *mic_CA) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
