...
// New returns a new instance of translator for the 'skr_PK' locale
...
func (skr *skr_PK) Locale() string {
	return skr.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'skr_PK'
func (skr *skr_PK) PluralsCardinal() []locales.PluralRule {
	return skr.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'skr_PK'
func (skr *skr_PK) PluralsOrdinal() []locales.PluralRule {
	return skr.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'skr_PK'
func (skr *skr_PK) PluralsRange() []locales.PluralRule {
	return skr.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'skr_PK'
func (skr *skr_PK) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'skr_PK'
func (skr *skr_PK) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'skr_PK'
func (skr *skr_PK) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (skr *skr_PK) MonthAbbreviated(month time.Month) string {
	return skr.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (skr *skr_PK) MonthsAbbreviated() []string {
	return nil
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (skr *skr_PK) MonthNarrow(month time.Month) string {
	return skr.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (skr *skr_PK) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (skr *skr_PK) MonthWide(month time.Month) string {
	return skr.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (skr *skr_PK) MonthsWide() []string {
	return skr.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (skr *skr_PK) WeekdayAbbreviated(weekday time.Weekday) string {
	return skr.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (skr *skr_PK) WeekdaysAbbreviated() []string {
	return skr.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (skr *skr_PK) WeekdayNarrow(weekday time.Weekday) string {
	return skr.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (skr *skr_PK) WeekdaysNarrow() []string {
	return skr.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (skr *skr_PK) WeekdayShort(weekday time.Weekday) string {
	return skr.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (skr *skr_PK) WeekdaysShort() []string {
	return skr.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (skr *skr_PK) WeekdayWide(weekday time.Weekday) string {
	return skr.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (skr *skr_PK) WeekdaysWide() []string {
	return skr.daysWide
}

// Decimal returns the decimal point of number
func (skr *skr_PK) Decimal() string {
	return skr.decimal
}

// Group returns the group of number
func (skr *skr_PK) Group() string {
	return skr.group
}

// Group returns the minus sign of number
func (skr *skr_PK) Minus() string {
	return skr.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'skr_PK' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (skr *skr_PK) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
