...
// New returns a new instance of translator for the 'az_Arab_IR' locale
...
func (az *az_Arab_IR) Locale() string {
	return az.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'az_Arab_IR'
func (az *az_Arab_IR) PluralsCardinal() []locales.PluralRule {
	return az.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'az_Arab_IR'
func (az *az_Arab_IR) PluralsOrdinal() []locales.PluralRule {
	return az.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'az_Arab_IR'
func (az *az_Arab_IR) PluralsRange() []locales.PluralRule {
	return az.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'az_Arab_IR'
func (az *az_Arab_IR) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'az_Arab_IR'
func (az *az_Arab_IR) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'az_Arab_IR'
func (az *az_Arab_IR) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
...
func (az *az_Arab_IR) MonthAbbreviated(month time.Month) string {
...
func (az *az_Arab_IR) MonthsAbbreviated() []string {
	return az.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (az *az_Arab_IR) MonthNarrow(month time.Month) string {
...
func (az *az_Arab_IR) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (az *az_Arab_IR) MonthWide(month time.Month) string {
...
func (az *az_Arab_IR) MonthsWide() []string {
	return az.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (az *az_Arab_IR) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (az *az_Arab_IR) WeekdaysAbbreviated() []string {
	return az.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (az *az_Arab_IR) WeekdayNarrow(weekday time.Weekday) string {
...
func (az *az_Arab_IR) WeekdaysNarrow() []string {
	return az.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (az *az_Arab_IR) WeekdayShort(weekday time.Weekday) string {
...
func (az *az_Arab_IR) WeekdaysShort() []string {
	return az.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (az *az_Arab_IR) WeekdayWide(weekday time.Weekday) string {
...
func (az *az_Arab_IR) WeekdaysWide() []string {
	return az.daysWide
}

// Decimal returns the decimal point of number
func (az *az_Arab_IR) Decimal() string {
	return az.decimal
}

// Group returns the group of number
func (az *az_Arab_IR) Group() string {
	return az.group
}

// Group returns the minus sign of number
func (az *az_Arab_IR) Minus() string {
	return az.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'az_Arab_IR' and handles both Whole and Real numbers based on 'v'
func (az *az_Arab_IR) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'az_Arab_IR' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (az *az_Arab_IR) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'az_Arab_IR'
func (az *az_Arab_IR) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'az_Arab_IR'
// in accounting notation.
func (az *az_Arab_IR) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'az_Arab_IR'
func (az *az_Arab_IR) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'az_Arab_IR'
func (az *az_Arab_IR) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'az_Arab_IR'
func (az *az_Arab_IR) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'az_Arab_IR'
func (az *az_Arab_IR) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'az_Arab_IR'
func (az *az_Arab_IR) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'az_Arab_IR'
func (az *az_Arab_IR) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'az_Arab_IR'
func (az *az_Arab_IR) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'az_Arab_IR'
func (az *az_Arab_IR) FmtTimeFull(t time.Time) string {
