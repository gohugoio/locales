...
// New returns a new instance of translator for the 'vmw' locale
...
func (vmw *vmw) Locale() string {
	return vmw.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'vmw'
func (vmw *vmw) PluralsCardinal() []locales.PluralRule {
	return vmw.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'vmw'
func (vmw *vmw) PluralsOrdinal() []locales.PluralRule {
	return vmw.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'vmw'
func (vmw *vmw) PluralsRange() []locales.PluralRule {
	return vmw.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'vmw'
func (vmw *vmw) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'vmw'
func (vmw *vmw) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'vmw'
func (vmw *vmw) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (vmw *vmw) MonthAbbreviated(month time.Month) string {
	return vmw.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (vmw *vmw) MonthsAbbreviated() []string {
	return nil
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (vmw *vmw) MonthNarrow(month time.Month) string {
	return vmw.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (vmw *vmw) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (vmw *vmw) MonthWide(month time.Month) string {
	return vmw.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (vmw *vmw) MonthsWide() []string {
	return vmw.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (vmw *vmw) WeekdayAbbreviated(weekday time.Weekday) string {
	return vmw.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (vmw *vmw) WeekdaysAbbreviated() []string {
	return vmw.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (vmw *vmw) WeekdayNarrow(weekday time.Weekday) string {
	return vmw.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (vmw *vmw) WeekdaysNarrow() []string {
	return vmw.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (vmw *vmw) WeekdayShort(weekday time.Weekday) string {
	return vmw.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (vmw *vmw) WeekdaysShort() []string {
	return vmw.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (vmw *vmw) WeekdayWide(weekday time.Weekday) string {
	return vmw.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (vmw *vmw) WeekdaysWide() []string {
	return vmw.daysWide
}

// Decimal returns the decimal point of number
func (vmw *vmw) Decimal() string {
	return vmw.decimal
}

// Group returns the group of number
func (vmw *vmw) Group() string {
	return vmw.group
}

// Group returns the minus sign of number
func (vmw *vmw) Minus() string {
	return vmw.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'vmw' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (vmw *vmw) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
