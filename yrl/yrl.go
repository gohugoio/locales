...
func (yrl *yrl) MonthAbbreviated(month time.Month) string {
...
func (yrl *yrl) MonthsAbbreviated() []string {
	return yrl.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (yrl *yrl) MonthNarrow(month time.Month) string {
...
func (yrl *yrl) MonthsNarrow() []string {
	return yrl.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (yrl *yrl) MonthWide(month time.Month) string {
...
func (yrl *yrl) MonthsWide() []string {
	return yrl.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (yrl *yrl) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (yrl *yrl) WeekdaysAbbreviated() []string {
	return yrl.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (yrl *yrl) WeekdayNarrow(weekday time.Weekday) string {
...
func (yrl *yrl) WeekdaysNarrow() []string {
	return yrl.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (yrl *yrl) WeekdayShort(weekday time.Weekday) string {
...
func (yrl *yrl) WeekdaysShort() []string {
	return yrl.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (yrl *yrl) WeekdayWide(weekday time.Weekday) string {
...
func (yrl *yrl) WeekdaysWide() []string {
	return yrl.daysWide
}

// Decimal returns the decimal point of number
func (yrl *yrl) Decimal() string {
	return yrl.decimal
}

// Group returns the group of number
func (yrl *yrl) Group() string {
	return yrl.group
}

// Group returns the minus sign of number
func (yrl *yrl) Minus() string {
	return yrl.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'yrl' and handles both Whole and Real numbers based on 'v'
func (yrl *yrl) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'yrl' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (yrl *yrl) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'yrl'
func (yrl *yrl) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'yrl'
// in accounting notation.
func (yrl *yrl) FmtAccounting(num float64, v uint64, currency currency.Type) string {
