...
// New returns a new instance of translator for the 'wbp_AU' locale
...
func (wbp *wbp_AU) Locale() string {
	return wbp.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'wbp_AU'
func (wbp *wbp_AU) PluralsCardinal() []locales.PluralRule {
	return wbp.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'wbp_AU'
func (wbp *wbp_AU) PluralsOrdinal() []locales.PluralRule {
	return wbp.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'wbp_AU'
func (wbp *wbp_AU) PluralsRange() []locales.PluralRule {
	return wbp.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'wbp_AU'
func (wbp *wbp_AU) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'wbp_AU'
func (wbp *wbp_AU) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'wbp_AU'
func (wbp *wbp_AU) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (wbp *wbp_AU) MonthsAbbreviated() []string {
	return nil
}
...
func (wbp *wbp_AU) MonthsNarrow() []string {
	return nil
}
...
func (wbp *wbp_AU) MonthsWide() []string {
	return nil
}
...
func (wbp *wbp_AU) WeekdaysAbbreviated() []string {
...
func (wbp *wbp_AU) WeekdaysNarrow() []string {
...
func (wbp *wbp_AU) WeekdaysShort() []string {
...
func (wbp *wbp_AU) WeekdaysWide() []string {
	return wbp.daysWide
}

// Decimal returns the decimal point of number
func (wbp *wbp_AU) Decimal() string {
	return wbp.decimal
}

// Group returns the group of number
func (wbp *wbp_AU) Group() string {
	return wbp.group
}

// Group returns the minus sign of number
func (wbp *wbp_AU) Minus() string {
	return wbp.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'wbp_AU' and handles both Whole and Real numbers based on 'v'
func (wbp *wbp_AU) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'wbp_AU' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (wbp *wbp_AU) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'wbp_AU'
func (wbp *wbp_AU) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := wbp.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'wbp_AU'
// in accounting notation.
func (wbp *wbp_AU) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := wbp.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtDateShort returns the short date representation of 't' for 'wbp_AU'
func (wbp *wbp_AU) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateMedium returns the medium date representation of 't' for 'wbp_AU'
func (wbp *wbp_AU) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateLong returns the long date representation of 't' for 'wbp_AU'
func (wbp *wbp_AU) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateFull returns the full date representation of 't' for 'wbp_AU'
func (wbp *wbp_AU) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeShort returns the short time representation of 't' for 'wbp_AU'
func (wbp *wbp_AU) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeMedium returns the medium time representation of 't' for 'wbp_AU'
func (wbp *wbp_AU) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeLong returns the long time representation of 't' for 'wbp_AU'
func (wbp *wbp_AU) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeFull returns the full time representation of 't' for 'wbp_AU'
func (wbp *wbp_AU) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
