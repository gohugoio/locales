...
func (en *en_MV) MonthAbbreviated(month time.Month) string {
...
func (en *en_MV) MonthsAbbreviated() []string {
	return en.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (en *en_MV) MonthNarrow(month time.Month) string {
...
func (en *en_MV) MonthsNarrow() []string {
	return en.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (en *en_MV) MonthWide(month time.Month) string {
...
func (en *en_MV) MonthsWide() []string {
	return en.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (en *en_MV) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (en *en_MV) WeekdaysAbbreviated() []string {
	return en.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (en *en_MV) WeekdayNarrow(weekday time.Weekday) string {
...
func (en *en_MV) WeekdaysNarrow() []string {
	return en.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (en *en_MV) WeekdayShort(weekday time.Weekday) string {
...
func (en *en_MV) WeekdaysShort() []string {
	return en.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (en *en_MV) WeekdayWide(weekday time.Weekday) string {
...
func (en *en_MV) WeekdaysWide() []string {
	return en.daysWide
}

// Decimal returns the decimal point of number
func (en *en_MV) Decimal() string {
	return en.decimal
}

// Group returns the group of number
func (en *en_MV) Group() string {
	return en.group
}

// Group returns the minus sign of number
func (en *en_MV) Minus() string {
	return en.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'en_MV' and handles both Whole and Real numbers based on 'v'
func (en *en_MV) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'en_MV' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (en *en_MV) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'en_MV'
func (en *en_MV) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'en_MV'
// in accounting notation.
func (en *en_MV) FmtAccounting(num float64, v uint64, currency currency.Type) string {
