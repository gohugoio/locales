...
// New returns a new instance of translator for the 'nso' locale
...
func (nso *nso) Locale() string {
	return nso.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'nso'
func (nso *nso) PluralsCardinal() []locales.PluralRule {
	return nso.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'nso'
func (nso *nso) PluralsOrdinal() []locales.PluralRule {
	return nso.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'nso'
func (nso *nso) PluralsRange() []locales.PluralRule {
	return nso.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'nso'
func (nso *nso) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	n := math.Abs(num)
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'nso'
func (nso *nso) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'nso'
func (nso *nso) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (nso *nso) MonthAbbreviated(month time.Month) string {
	if len(nso.monthsAbbreviated) == 0 {
		return ""
	}
...
func (nso *nso) MonthsAbbreviated() []string {
	return nso.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (nso *nso) MonthNarrow(month time.Month) string {
	if len(nso.monthsNarrow) == 0 {
		return ""
	}
...
func (nso *nso) MonthsNarrow() []string {
	return nso.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (nso *nso) MonthWide(month time.Month) string {
	if len(nso.monthsWide) == 0 {
		return ""
	}
...
func (nso *nso) MonthsWide() []string {
	return nso.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (nso *nso) WeekdayAbbreviated(weekday time.Weekday) string {
	if len(nso.daysAbbreviated) == 0 {
		return ""
	}
...
func (nso *nso) WeekdaysAbbreviated() []string {
	return nso.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (nso *nso) WeekdayNarrow(weekday time.Weekday) string {
	if len(nso.daysNarrow) == 0 {
		return ""
	}
...
func (nso *nso) WeekdaysNarrow() []string {
	return nso.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (nso *nso) WeekdayShort(weekday time.Weekday) string {
	if len(nso.daysShort) == 0 {
		return ""
	}
...
func (nso *nso) WeekdaysShort() []string {
	return nso.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (nso *nso) WeekdayWide(weekday time.Weekday) string {
	if len(nso.daysWide) == 0 {
		return ""
	}
...
func (nso *nso) WeekdaysWide() []string {
	return nso.daysWide
}

// Decimal returns the decimal point of number
func (nso *nso) Decimal() string {
	return nso.decimal
}

// Group returns the group of number
func (nso *nso) Group() string {
	return nso.group
}

// Group returns the minus sign of number
func (nso *nso) Minus() string {
	return nso.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'nso' and handles both Whole and Real numbers based on 'v'
func (nso *nso) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'nso' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (nso *nso) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'nso'
func (nso *nso) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'nso'
// in accounting notation.
func (nso *nso) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := nso.currencies[currency]
	l := len(s) + len(symbol) + 2 + 1*len(s[:len(s)-int(v)-1])/3
	count := 0
...
// FmtDateShort returns the short date representation of 't' for 'nso'
func (nso *nso) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateMedium returns the medium date representation of 't' for 'nso'
func (nso *nso) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateLong returns the long date representation of 't' for 'nso'
func (nso *nso) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateFull returns the full date representation of 't' for 'nso'
func (nso *nso) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeShort returns the short time representation of 't' for 'nso'
func (nso *nso) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeMedium returns the medium time representation of 't' for 'nso'
func (nso *nso) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeLong returns the long time representation of 't' for 'nso'
func (nso *nso) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeFull returns the full time representation of 't' for 'nso'
func (nso *nso) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
