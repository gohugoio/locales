...
// New returns a new instance of translator for the 'raj_IN' locale
...
func (raj *raj_IN) Locale() string {
	return raj.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'raj_IN'
func (raj *raj_IN) PluralsCardinal() []locales.PluralRule {
	return raj.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'raj_IN'
func (raj *raj_IN) PluralsOrdinal() []locales.PluralRule {
	return raj.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'raj_IN'
func (raj *raj_IN) PluralsRange() []locales.PluralRule {
	return raj.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'raj_IN'
func (raj *raj_IN) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'raj_IN'
func (raj *raj_IN) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'raj_IN'
func (raj *raj_IN) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (raj *raj_IN) MonthAbbreviated(month time.Month) string {
	return raj.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (raj *raj_IN) MonthsAbbreviated() []string {
	return nil
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (raj *raj_IN) MonthNarrow(month time.Month) string {
	return raj.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (raj *raj_IN) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (raj *raj_IN) MonthWide(month time.Month) string {
	return raj.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (raj *raj_IN) MonthsWide() []string {
	return raj.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (raj *raj_IN) WeekdayAbbreviated(weekday time.Weekday) string {
	return raj.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (raj *raj_IN) WeekdaysAbbreviated() []string {
	return raj.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (raj *raj_IN) WeekdayNarrow(weekday time.Weekday) string {
	return raj.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (raj *raj_IN) WeekdaysNarrow() []string {
	return raj.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (raj *raj_IN) WeekdayShort(weekday time.Weekday) string {
	return raj.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (raj *raj_IN) WeekdaysShort() []string {
	return raj.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (raj *raj_IN) WeekdayWide(weekday time.Weekday) string {
	return raj.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (raj *raj_IN) WeekdaysWide() []string {
	return raj.daysWide
}

// Decimal returns the decimal point of number
func (raj *raj_IN) Decimal() string {
	return raj.decimal
}

// Group returns the group of number
func (raj *raj_IN) Group() string {
	return raj.group
}

// Group returns the minus sign of number
func (raj *raj_IN) Minus() string {
	return raj.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'raj_IN' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (raj *raj_IN) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
