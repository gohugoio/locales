...
// New returns a new instance of translator for the 'gez_ET' locale
...
func (gez *gez_ET) Locale() string {
	return gez.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'gez_ET'
func (gez *gez_ET) PluralsCardinal() []locales.PluralRule {
	return gez.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'gez_ET'
func (gez *gez_ET) PluralsOrdinal() []locales.PluralRule {
	return gez.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'gez_ET'
func (gez *gez_ET) PluralsRange() []locales.PluralRule {
	return gez.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'gez_ET'
func (gez *gez_ET) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'gez_ET'
func (gez *gez_ET) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'gez_ET'
func (gez *gez_ET) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (gez *gez_ET) MonthAbbreviated(month time.Month) string {
...
func (gez *gez_ET) MonthsAbbreviated() []string {
	return nil
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (gez *gez_ET) MonthNarrow(month time.Month) string {
...
func (gez *gez_ET) MonthsNarrow() []string {
	return gez.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (gez *gez_ET) MonthWide(month time.Month) string {
...
func (gez *gez_ET) MonthsWide() []string {
	return gez.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (gez *gez_ET) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (gez *gez_ET) WeekdaysAbbreviated() []string {
	return gez.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (gez *gez_ET) WeekdayNarrow(weekday time.Weekday) string {
...
func (gez *gez_ET) WeekdaysNarrow() []string {
	return gez.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (gez *gez_ET) WeekdayShort(weekday time.Weekday) string {
...
func (gez *gez_ET) WeekdaysShort() []string {
	return gez.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (gez *gez_ET) WeekdayWide(weekday time.Weekday) string {
...
func (gez *gez_ET) WeekdaysWide() []string {
	return gez.daysWide
}

// Decimal returns the decimal point of number
func (gez *gez_ET) Decimal() string {
	return gez.decimal
}

// Group returns the group of number
func (gez *gez_ET) Group() string {
	return gez.group
}

// Group returns the minus sign of number
func (gez *gez_ET) Minus() string {
	return gez.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'gez_ET' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (gez *gez_ET) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
