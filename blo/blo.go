...
func New() locales.Translator {
	return &blo{
		...
		periodsAbbreviated:     []string{"1ka", "2ja"},
		periodsNarrow:          []string{"", ""},
		periodsWide:            []string{"ʊshilè kʊboɖu", "ʊshilè kʊsasʊ"},
		erasAbbreviated:        []string{"naaBYŊAƖ", "AƖAK"},
		erasNarrow:             []string{"", ""},
		erasWide:               []string{"naa Ba Ye Ŋʊm Annabi Ɩsa", "Annabi Ɩsa Abʊŋʊma Kaŋkǝm"},
