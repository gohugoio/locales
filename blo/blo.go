...
// New returns a new instance of translator for the 'blo' locale
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'blo'
func (blo *blo) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	n := math.Abs(num)
	i := int64(n)
...
// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'blo'
func (blo *blo) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (blo *blo) MonthAbbreviated(month time.Month) string {
	if len(blo.monthsAbbreviated) == 0 {
		return ""
	}
...
func (blo *blo) MonthsAbbreviated() []string {
	return blo.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (blo *blo) MonthNarrow(month time.Month) string {
	if len(blo.monthsNarrow) == 0 {
		return ""
	}
...
func (blo *blo) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (blo *blo) MonthWide(month time.Month) string {
	if len(blo.monthsWide) == 0 {
		return ""
	}
...
func (blo *blo) MonthsWide() []string {
	return blo.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (blo *blo) WeekdayAbbreviated(weekday time.Weekday) string {
	if len(blo.daysAbbreviated) == 0 {
		return ""
	}
...
func (blo *blo) WeekdaysAbbreviated() []string {
	return blo.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (blo *blo) WeekdayNarrow(weekday time.Weekday) string {
	if len(blo.daysNarrow) == 0 {
		return ""
	}
...
func (blo *blo) WeekdaysNarrow() []string {
	return blo.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (blo *blo) WeekdayShort(weekday time.Weekday) string {
	if len(blo.daysShort) == 0 {
		return ""
	}
...
func (blo *blo) WeekdaysShort() []string {
	return blo.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (blo *blo) WeekdayWide(weekday time.Weekday) string {
	if len(blo.daysWide) == 0 {
		return ""
	}
...
func (blo *blo) WeekdaysWide() []string {
	return blo.daysWide
}

// Decimal returns the decimal point of number
func (blo *blo) Decimal() string {
	return blo.decimal
}

// Group returns the group of number
func (blo *blo) Group() string {
	return blo.group
}

// Group returns the minus sign of number
func (blo *blo) Minus() string {
	return blo.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'blo' and handles both Whole and Real numbers based on 'v'
func (blo *blo) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'blo' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (blo *blo) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'blo'
func (blo *blo) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'blo'
// in accounting notation.
func (blo *blo) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := blo.currencies[currency]
...
// FmtDateShort returns the short date representation of 't' for 'blo'
func (blo *blo) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateMedium returns the medium date representation of 't' for 'blo'
func (blo *blo) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateLong returns the long date representation of 't' for 'blo'
func (blo *blo) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateFull returns the full date representation of 't' for 'blo'
func (blo *blo) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeShort returns the short time representation of 't' for 'blo'
func (blo *blo) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeMedium returns the medium time representation of 't' for 'blo'
func (blo *blo) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeLong returns the long time representation of 't' for 'blo'
func (blo *blo) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeFull returns the full time representation of 't' for 'blo'
func (blo *blo) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
