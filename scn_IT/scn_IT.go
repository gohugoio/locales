...
// New returns a new instance of translator for the 'scn_IT' locale
...
func (scn *scn_IT) MonthAbbreviated(month time.Month) string {
	return scn.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (scn *scn_IT) MonthsAbbreviated() []string {
	return scn.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (scn *scn_IT) MonthNarrow(month time.Month) string {
	return scn.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (scn *scn_IT) MonthsNarrow() []string {
	return scn.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (scn *scn_IT) MonthWide(month time.Month) string {
	return scn.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (scn *scn_IT) MonthsWide() []string {
	return scn.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (scn *scn_IT) WeekdayAbbreviated(weekday time.Weekday) string {
	return scn.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (scn *scn_IT) WeekdaysAbbreviated() []string {
	return scn.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (scn *scn_IT) WeekdayNarrow(weekday time.Weekday) string {
	return scn.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (scn *scn_IT) WeekdaysNarrow() []string {
	return scn.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (scn *scn_IT) WeekdayShort(weekday time.Weekday) string {
	return scn.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (scn *scn_IT) WeekdaysShort() []string {
	return scn.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (scn *scn_IT) WeekdayWide(weekday time.Weekday) string {
	return scn.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (scn *scn_IT) WeekdaysWide() []string {
	return scn.daysWide
}

// Decimal returns the decimal point of number
func (scn *scn_IT) Decimal() string {
	return scn.decimal
}

// Group returns the group of number
func (scn *scn_IT) Group() string {
	return scn.group
}

// Group returns the minus sign of number
func (scn *scn_IT) Minus() string {
	return scn.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'scn_IT' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (scn *scn_IT) FmtPercent(num float64, v uint64) string {
	return strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
}
