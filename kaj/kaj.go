...
// New returns a new instance of translator for the 'kaj' locale
...
func (kaj *kaj) Locale() string {
	return kaj.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'kaj'
func (kaj *kaj) PluralsCardinal() []locales.PluralRule {
	return kaj.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'kaj'
func (kaj *kaj) PluralsOrdinal() []locales.PluralRule {
	return kaj.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'kaj'
func (kaj *kaj) PluralsRange() []locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'kaj'
func (kaj *kaj) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'kaj'
func (kaj *kaj) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (kaj *kaj) MonthAbbreviated(month time.Month) string {
	return kaj.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (kaj *kaj) MonthsAbbreviated() []string {
	return kaj.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (kaj *kaj) MonthNarrow(month time.Month) string {
	return kaj.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (kaj *kaj) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (kaj *kaj) MonthWide(month time.Month) string {
	return kaj.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (kaj *kaj) MonthsWide() []string {
	return kaj.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (kaj *kaj) WeekdayAbbreviated(weekday time.Weekday) string {
	return kaj.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (kaj *kaj) WeekdaysAbbreviated() []string {
	return kaj.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (kaj *kaj) WeekdayNarrow(weekday time.Weekday) string {
	return kaj.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (kaj *kaj) WeekdaysNarrow() []string {
	return kaj.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (kaj *kaj) WeekdayShort(weekday time.Weekday) string {
	return kaj.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (kaj *kaj) WeekdaysShort() []string {
	return kaj.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (kaj *kaj) WeekdayWide(weekday time.Weekday) string {
	return kaj.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (kaj *kaj) WeekdaysWide() []string {
	return kaj.daysWide
}

// Decimal returns the decimal point of number
func (kaj *kaj) Decimal() string {
	return kaj.decimal
}

// Group returns the group of number
func (kaj *kaj) Group() string {
	return kaj.group
}

// Group returns the minus sign of number
func (kaj *kaj) Minus() string {
	return kaj.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'kaj' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (kaj *kaj) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
