...
// New returns a new instance of translator for the 'sms' locale
...
func (sms *sms) Locale() string {
	return sms.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'sms'
func (sms *sms) PluralsCardinal() []locales.PluralRule {
	return sms.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'sms'
func (sms *sms) PluralsOrdinal() []locales.PluralRule {
	return sms.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'sms'
func (sms *sms) PluralsRange() []locales.PluralRule {
	return sms.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'sms'
func (sms *sms) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'sms'
func (sms *sms) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'sms'
func (sms *sms) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (sms *sms) MonthsAbbreviated() []string {
	return nil
}
...
func (sms *sms) MonthsNarrow() []string {
	return nil
}
...
func (sms *sms) MonthsWide() []string {
	return nil
}
...
func (sms *sms) WeekdaysAbbreviated() []string {
	return sms.daysAbbreviated
}
...
func (sms *sms) WeekdaysNarrow() []string {
	return sms.daysNarrow
}
...
func (sms *sms) WeekdaysShort() []string {
	return sms.daysShort
}
...
func (sms *sms) WeekdaysWide() []string {
	return sms.daysWide
}

// Decimal returns the decimal point of number
func (sms *sms) Decimal() string {
	return sms.decimal
}

// Group returns the group of number
func (sms *sms) Group() string {
	return sms.group
}

// Group returns the minus sign of number
func (sms *sms) Minus() string {
	return sms.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'sms' and handles both Whole and Real numbers based on 'v'
func (sms *sms) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'sms' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (sms *sms) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
	...
	b = append(b, sms.percent...)

	return string(b)
}

// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'sms'
func (sms *sms) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'sms'
// in accounting notation.
func (sms *sms) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'sms'
func (sms *sms) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'sms'
func (sms *sms) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'sms'
func (sms *sms) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'sms'
func (sms *sms) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'sms'
func (sms *sms) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'sms'
func (sms *sms) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'sms'
func (sms *sms) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'sms'
func (sms *sms) FmtTimeFull(t time.Time) string {
