...
// New returns a new instance of translator for the 'ku_Latn_SY' locale
...
func (ku *ku_Latn_SY) Locale() string {
	return ku.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'ku_Latn_SY'
func (ku *ku_Latn_SY) PluralsCardinal() []locales.PluralRule {
	return ku.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'ku_Latn_SY'
func (ku *ku_Latn_SY) PluralsOrdinal() []locales.PluralRule {
	return ku.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'ku_Latn_SY'
func (ku *ku_Latn_SY) PluralsRange() []locales.PluralRule {
	return ku.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'ku_Latn_SY'
func (ku *ku_Latn_SY) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'ku_Latn_SY'
func (ku *ku_Latn_SY) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'ku_Latn_SY'
func (ku *ku_Latn_SY) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (ku *ku_Latn_SY) MonthAbbreviated(month time.Month) string {
...
func (ku *ku_Latn_SY) MonthsAbbreviated() []string {
	return ku.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (ku *ku_Latn_SY) MonthNarrow(month time.Month) string {
...
func (ku *ku_Latn_SY) MonthsNarrow() []string {
	return ku.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (ku *ku_Latn_SY) MonthWide(month time.Month) string {
...
func (ku *ku_Latn_SY) MonthsWide() []string {
	return ku.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (ku *ku_Latn_SY) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (ku *ku_Latn_SY) WeekdaysAbbreviated() []string {
	return ku.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (ku *ku_Latn_SY) WeekdayNarrow(weekday time.Weekday) string {
...
func (ku *ku_Latn_SY) WeekdaysNarrow() []string {
	return ku.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (ku *ku_Latn_SY) WeekdayShort(weekday time.Weekday) string {
...
func (ku *ku_Latn_SY) WeekdaysShort() []string {
	return ku.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (ku *ku_Latn_SY) WeekdayWide(weekday time.Weekday) string {
...
func (ku *ku_Latn_SY) WeekdaysWide() []string {
	return ku.daysWide
}

// Decimal returns the decimal point of number
func (ku *ku_Latn_SY) Decimal() string {
	return ku.decimal
}

// Group returns the group of number
func (ku *ku_Latn_SY) Group() string {
	return ku.group
}

// Group returns the minus sign of number
func (ku *ku_Latn_SY) Minus() string {
	return ku.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'ku_Latn_SY' and handles both Whole and Real numbers based on 'v'
func (ku *ku_Latn_SY) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'ku_Latn_SY' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (ku *ku_Latn_SY) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'ku_Latn_SY'
func (ku *ku_Latn_SY) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'ku_Latn_SY'
// in accounting notation.
func (ku *ku_Latn_SY) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'ku_Latn_SY'
func (ku *ku_Latn_SY) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'ku_Latn_SY'
func (ku *ku_Latn_SY) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'ku_Latn_SY'
func (ku *ku_Latn_SY) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'ku_Latn_SY'
func (ku *ku_Latn_SY) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'ku_Latn_SY'
func (ku *ku_Latn_SY) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'ku_Latn_SY'
func (ku *ku_Latn_SY) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'ku_Latn_SY'
func (ku *ku_Latn_SY) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'ku_Latn_SY'
func (ku *ku_Latn_SY) FmtTimeFull(t time.Time) string {
