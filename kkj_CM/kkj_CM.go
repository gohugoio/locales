...
func New() locales.Translator {
	return &kkj_CM{
		...
		daysShort:       []string{"so", "lu", "ma", "mɛ", "ye", "va", "ms"},
...
func (kkj *kkj_CM) MonthAbbreviated(month time.Month) string {
	if len(kkj.monthsAbbreviated) == 0 {
		return ""
	}
