...
// New returns a new instance of translator for the 'tig' locale
...
func (tig *tig) Locale() string {
	return tig.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'tig'
func (tig *tig) PluralsCardinal() []locales.PluralRule {
	return tig.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'tig'
func (tig *tig) PluralsOrdinal() []locales.PluralRule {
	return tig.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'tig'
func (tig *tig) PluralsRange() []locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'tig'
func (tig *tig) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'tig'
func (tig *tig) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (tig *tig) MonthsAbbreviated() []string {
...
func (tig *tig) MonthsNarrow() []string {
...
func (tig *tig) MonthsWide() []string {
...
func (tig *tig) WeekdaysAbbreviated() []string {
...
func (tig *tig) WeekdaysNarrow() []string {
...
func (tig *tig) WeekdaysShort() []string {
...
func (tig *tig) WeekdaysWide() []string {
	return tig.daysWide
}

// Decimal returns the decimal point of number
func (tig *tig) Decimal() string {
	return tig.decimal
}

// Group returns the group of number
func (tig *tig) Group() string {
	return tig.group
}

// Group returns the minus sign of number
func (tig *tig) Minus() string {
	return tig.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'tig' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (tig *tig) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
