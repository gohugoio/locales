...
func (uz *uz_Cyrl_UZ) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	...
	if num < 0 {
		...
		b = append(b, uz.currencyNegativePrefix[0])
