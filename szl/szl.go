...
func (szl *szl) MonthAbbreviated(month time.Month) string {
	if len(szl.monthsAbbreviated) == 0 {
		return ""
	}
...
func (szl *szl) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	...
	b = append(b, szl.currencyPositiveSuffix...)
...
func (szl *szl) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	...
	if num < 0 {
		b = append(b, szl.currencyNegativeSuffix...)
		b = append(b, symbol...)
	} else {
