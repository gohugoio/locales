...
// New returns a new instance of translator for the 'pi_Latn_GB' locale
...
func (pi *pi_Latn_GB) Locale() string {
	return pi.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'pi_Latn_GB'
func (pi *pi_Latn_GB) PluralsCardinal() []locales.PluralRule {
	return pi.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'pi_Latn_GB'
func (pi *pi_Latn_GB) PluralsOrdinal() []locales.PluralRule {
	return pi.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'pi_Latn_GB'
func (pi *pi_Latn_GB) PluralsRange() []locales.PluralRule {
	return pi.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'pi_Latn_GB'
func (pi *pi_Latn_GB) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'pi_Latn_GB'
func (pi *pi_Latn_GB) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'pi_Latn_GB'
func (pi *pi_Latn_GB) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (pi *pi_Latn_GB) MonthsAbbreviated() []string {
	return nil
}
...
func (pi *pi_Latn_GB) MonthsNarrow() []string {
	return nil
}
...
func (pi *pi_Latn_GB) MonthsWide() []string {
	return nil
}
...
func (pi *pi_Latn_GB) WeekdaysAbbreviated() []string {
...
func (pi *pi_Latn_GB) WeekdaysNarrow() []string {
...
func (pi *pi_Latn_GB) WeekdaysShort() []string {
	return pi.daysShort
}
...
func (pi *pi_Latn_GB) WeekdaysWide() []string {
	return pi.daysWide
}

// Decimal returns the decimal point of number
func (pi *pi_Latn_GB) Decimal() string {
	return pi.decimal
}

// Group returns the group of number
func (pi *pi_Latn_GB) Group() string {
	return pi.group
}

// Group returns the minus sign of number
func (pi *pi_Latn_GB) Minus() string {
	return pi.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'pi_Latn_GB' and handles both Whole and Real numbers based on 'v'
func (pi *pi_Latn_GB) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'pi_Latn_GB' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (pi *pi_Latn_GB) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'pi_Latn_GB'
func (pi *pi_Latn_GB) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := pi.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'pi_Latn_GB'
// in accounting notation.
func (pi *pi_Latn_GB) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := pi.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtDateShort returns the short date representation of 't' for 'pi_Latn_GB'
func (pi *pi_Latn_GB) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateMedium returns the medium date representation of 't' for 'pi_Latn_GB'
func (pi *pi_Latn_GB) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateLong returns the long date representation of 't' for 'pi_Latn_GB'
func (pi *pi_Latn_GB) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateFull returns the full date representation of 't' for 'pi_Latn_GB'
func (pi *pi_Latn_GB) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeShort returns the short time representation of 't' for 'pi_Latn_GB'
func (pi *pi_Latn_GB) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeMedium returns the medium time representation of 't' for 'pi_Latn_GB'
func (pi *pi_Latn_GB) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeLong returns the long time representation of 't' for 'pi_Latn_GB'
func (pi *pi_Latn_GB) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeFull returns the full time representation of 't' for 'pi_Latn_GB'
func (pi *pi_Latn_GB) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
