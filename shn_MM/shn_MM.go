...
// New returns a new instance of translator for the 'shn_MM' locale
...
func (shn *shn_MM) Locale() string {
	return shn.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'shn_MM'
func (shn *shn_MM) PluralsCardinal() []locales.PluralRule {
	return shn.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'shn_MM'
func (shn *shn_MM) PluralsOrdinal() []locales.PluralRule {
	return shn.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'shn_MM'
func (shn *shn_MM) PluralsRange() []locales.PluralRule {
	return shn.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'shn_MM'
func (shn *shn_MM) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'shn_MM'
func (shn *shn_MM) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'shn_MM'
func (shn *shn_MM) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (shn *shn_MM) MonthAbbreviated(month time.Month) string {
...
func (shn *shn_MM) MonthsAbbreviated() []string {
	return shn.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (shn *shn_MM) MonthNarrow(month time.Month) string {
...
func (shn *shn_MM) MonthsNarrow() []string {
	return shn.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (shn *shn_MM) MonthWide(month time.Month) string {
...
func (shn *shn_MM) MonthsWide() []string {
	return shn.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (shn *shn_MM) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (shn *shn_MM) WeekdaysAbbreviated() []string {
	return shn.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (shn *shn_MM) WeekdayNarrow(weekday time.Weekday) string {
...
func (shn *shn_MM) WeekdaysNarrow() []string {
	return shn.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (shn *shn_MM) WeekdayShort(weekday time.Weekday) string {
...
func (shn *shn_MM) WeekdaysShort() []string {
	return shn.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (shn *shn_MM) WeekdayWide(weekday time.Weekday) string {
...
func (shn *shn_MM) WeekdaysWide() []string {
	return shn.daysWide
}

// Decimal returns the decimal point of number
func (shn *shn_MM) Decimal() string {
	return shn.decimal
}

// Group returns the group of number
func (shn *shn_MM) Group() string {
	return shn.group
}

// Group returns the minus sign of number
func (shn *shn_MM) Minus() string {
	return shn.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'shn_MM' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (shn *shn_MM) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
