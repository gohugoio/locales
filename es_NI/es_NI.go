...
func New() locales.Translator {
	return &es_NI{
		...
		percent:            "%",
		timeSeparator:      ":",
		currencies:         []string{"ADP", "AED", "AFA", "AFN", "ALK", "ALL", "AMD", "ANG", "AOA", "AOK", "AON", "AOR", "ARA", "ARL", "ARM", "ARP", "ARS", "ATS", "AUD", "AWG", "AZM", "AZN", "BAD", "BAM", "BAN", "BBD", "BDT", "BEC", "BEF", "BEL", "BGL", "BGM", "BGN", "BGO", "BHD", "BIF", "BMD", "BND", "BOB", "BOL", "BOP", "BOV", "BRB", "BRC", "BRE", "BRL", "BRN", "BRR", "BRZ", "BSD", "BTN", "BUK", "BWP", "BYB", "р.", "BYR", "BZD", "CAD", "CDF", "CHE", "CHF", "CHW", "CLE", "CLF", "CLP", "CNH", "CNX", "CNY", "COP", "COU", "CRC", "CSD", "CSK", "CUC", "CUP", "CVE", "CYP", "CZK", "DDM", "DEM", "DJF", "DKK", "DOP", "DZD", "ECS", "ECV", "EEK", "E£", "ERN", "ESA", "ESB", "₧", "ETB", "EUR", "FIM", "FJD", "FK£", "FRF", "GBP", "GEK", "GEL", "GHC", "GHS", "GIP", "GMD", "GNF", "GNS", "GQE", "GRD", "GTQ", "GWE", "GWP", "GYD", "HKD", "HNL", "HRD", "HRK", "HTG", "HUF", "IDR", "IEP", "ILP", "ILR", "ILS", "INR", "IQD", "IRR", "ISJ", "ISK", "ITL", "JMD", "JOD", "JPY", "KES", "KGS", "KHR", "KMF", "KPW", "KRH", "KRO", "KRW", "KWD", "KYD", "KZT", "LAK", "LBP", "LKR", "LRD", "LSL", "LTL", "LTT", "LUC", "LUF", "LUL", "LVL", "LVR", "LYD", "MAD", "MAF", "MCF", "MDC", "MDL", "MGA", "MGF", "MKD", "MKN", "MLF", "MMK", "MNT", "MOP", "MRO", "MRU", "MTL", "MTP", "MUR", "MVP", "MVR", "MWK", "MXN", "MXP", "MXV", "MYR", "MZE", "MZM", "MZN", "NAD", "NGN", "NIC", "C$", "NLG", "NOK", "NPR", "NZD", "OMR", "PAB", "PEI", "PEN", "PES", "PGK", "PHP", "PKR", "PLN", "PLZ", "PTE", "PYG", "QAR", "RHD", "ROL", "L", "RSD", "RUB", "RUR", "RWF", "SAR", "SBD", "SCR", "SDD", "SDG", "SDP", "SEK", "SGD", "SHP", "SIT", "SKK", "SLE", "SLL", "SOS", "SRD", "SRG", "SD£", "STD", "STN", "SUR", "SVC", "S£", "SZL", "฿", "TJR", "TJS", "TMM", "TMT", "TND", "TOP", "TPE", "TRL", "TRY", "TTD", "TWD", "TZS", "UAH", "UAK", "UGS", "UGX", "USD", "USN", "USS", "UYI", "UYP", "UYU", "UYW", "UZS", "VEB", "VED", "BsF", "VES", "VND", "VNN", "VUV", "WST", "XAF", "XAG", "XAU", "XBA", "XBB", "XBC", "XBD", "XCD", "XCG", "XDR", "XEU", "XFO", "XFU", "XOF", "XPD", "XPF", "XPT", "XRE", "XSU", "XTS", "XUA", "XXX", "YDD", "YER", "YUD", "YUM", "YUN", "YUR", "ZAL", "ZAR", "ZMK", "ZMW", "ZRN", "ZRZ", "ZWD", "ZWG", "ZWL", "ZWR"},
		...
		timezones:          map[string]string{"ACDT": "hora de verano de Australia central", "ACST": "hora estándar de Australia central", "ACT": "Hora estándar de Acre", "ACWDT": "hora de verano de Australia centroccidental", "ACWST": "hora estándar de Australia centroccidental", "ADT": "hora de verano del Atlántico", "ADT Arabia": "hora de verano de Arabia", "AEDT": "hora de verano de Australia oriental", "AEST": "hora estándar de Australia oriental", "AFT": "hora de Afganistán", "AKDT": "hora de verano de Alaska", "AKST": "hora estándar de Alaska", "AMST": "hora de verano del Amazonas", "AMST Armenia": "hora de verano de Armenia", "AMT": "hora estándar del Amazonas", "AMT Armenia": "hora estándar de Armenia", "ANAST": "hora de verano de Anadyr", "ANAT": "hora estándar de Anadyr", "ARST": "hora de verano de Argentina", "ART": "hora estándar de Argentina", "AST": "hora estándar del Atlántico", "AST Arabia": "hora estándar de Arabia", "AWDT": "hora de verano de Australia occidental", "AWST": "hora estándar de Australia occidental", "AZST": "hora de verano de Azerbaiyán", "AZT": "hora estándar de Azerbaiyán", "BDT Bangladesh": "hora de verano de Bangladés", "BNT": "hora de Brunéi", "BOT": "hora de Bolivia", "BRST": "hora de verano de Brasilia", "BRT": "hora estándar de Brasilia", "BST Bangladesh": "hora estándar de Bangladés", "BT": "hora de Bután", "CAST": "CAST", "CAT": "hora de África central", "CCT": "hora de Islas Cocos", "CDT": "hora de verano central", "CHADT": "hora de verano de Chatham", "CHAST": "hora estándar de Chatham", "CHUT": "hora de Chuuk", "CKT": "hora estándar de las islas Cook", "CKT DST": "hora de verano media de las islas Cook", "CLST": "hora de verano de Chile", "CLT": "hora estándar de Chile", "COST": "hora de verano de Colombia", "COT": "hora estándar de Colombia", "CST": "hora estándar central", "CST China": "hora estándar de China", "CST China DST": "hora de verano de China", "CVST": "hora de verano de Cabo Verde", "CVT": "hora estándar de Cabo Verde", "CXT": "hora de la Isla de Navidad", "ChST": "hora estándar de Chamorro", "ChST NMI": "Hora de las Islas Marianas del Norte", "CuDT": "hora de verano de Cuba", "CuST": "hora estándar de Cuba", "DAVT": "hora de Davis", "DDUT": "hora de Dumont-d’Urville", "EASST": "hora de verano de la Isla de Pascua", "EAST": "hora estándar de Isla de Pascua", "EAT": "hora de África oriental", "ECT": "hora de Ecuador", "EDT": "hora de verano oriental", "EGDT": "hora de verano de Groenlandia oriental", "EGST": "hora estándar de Groenlandia oriental", "EST": "hora estándar oriental", "FEET": "horario del lejano este de Europa", "FJT": "hora estándar de Fiyi", "FJT Summer": "hora de verano de Fiyi", "FKST": "hora de verano de las Islas Malvinas", "FKT": "hora estándar de las Islas Malvinas", "FNST": "hora de verano de Fernando de Noronha", "FNT": "hora estándar de Fernando de Noronha", "GALT": "hora de Galápagos", "GAMT": "hora de Gambier", "GEST": "hora de verano de Georgia", "GET": "hora estándar de Georgia", "GFT": "hora de la Guayana Francesa", "GIT": "hora de Islas Gilbert", "GMT": "hora del meridiano de Greenwich", "GNSST": "GNSST", "GNST": "GNST", "GST": "hora estándar del Golfo", "GST Guam": "Hora estándar de Guam", "GYT": "hora de Guyana", "HADT": "hora de verano de Hawái-Aleutianas", "HAST": "hora estándar de Hawái-Aleutianas", "HKST": "hora de verano de Hong Kong", "HKT": "hora estándar de Hong Kong", "HOVST": "hora de verano de Hovd", "HOVT": "hora estándar de Hovd", "ICT": "hora de Indochina", "IDT": "hora de verano de Israel", "IOT": "hora del océano Índico", "IRKST": "hora de verano de Irkutsk", "IRKT": "hora estándar de Irkutsk", "IRST": "hora estándar de Irán", "IRST DST": "hora de verano de Irán", "IST": "hora de India", "IST Israel": "hora estándar de Israel", "JDT": "hora de verano de Japón", "JST": "hora estándar de Japón", "KOST": "hora de Kosrae", "KRAST": "hora de verano de Krasnoyarsk", "KRAT": "hora estándar de Krasnoyarsk", "KST": "hora estándar de Corea", "KST DST": "hora de verano de Corea", "LHDT": "hora de verano de Lord Howe", "LHST": "hora estándar de Lord Howe", "LINT": "hora de las Espóradas Ecuatoriales", "MAGST": "hora de verano de Magadán", "MAGT": "hora estándar de Magadán", "MART": "hora de Marquesas", "MAWT": "hora de Mawson", "MDT": "Hora de verano de Macao", "MESZ": "hora de verano de Europa central", "MEZ": "hora estándar de Europa central", "MHT": "hora de Islas Marshall", "MMT": "hora de Myanmar (Birmania)", "MSD": "hora de verano de Moscú", "MST": "Hora estándar de Macao", "MUST": "hora de verano de Mauricio", "MUT": "hora estándar de Mauricio", "MVT": "hora de Maldivas", "MYT": "hora de Malasia", "NCT": "hora estándar de Nueva Caledonia", "NDT": "hora de verano de Terranova", "NDT New Caledonia": "hora de verano de Nueva Caledonia", "NFDT": "hora de verano de la Isla Norfolk", "NFT": "hora estándar de la Isla Norfolk", "NOVST": "hora de verano de Novosibirsk", "NOVT": "hora estándar de Novosibirsk", "NPT": "hora de Nepal", "NRT": "hora de Nauru", "NST": "hora estándar de Terranova", "NUT": "hora de Niue", "NZDT": "hora de verano de Nueva Zelanda", "NZST": "hora estándar de Nueva Zelanda", "OESZ": "hora de verano de Europa del Este", "OEZ": "hora estándar de Europa del Este", "OMSST": "hora de verano de Omsk", "OMST": "hora estándar de Omsk", "PDT": "hora de verano del Pacífico", "PDTM": "hora de verano del Pacífico de México", "PETDT": "hora de verano de Kamchatka", "PETST": "hora estándar de Kamchatka", "PGT": "hora de Papúa Nueva Guinea", "PHOT": "hora de las Islas Fénix", "PKT": "hora estándar de Pakistán", "PKT DST": "hora de verano de Pakistán", "PMDT": "hora de verano de San Pedro y Miquelón", "PMST": "hora estándar de San Pedro y Miquelón", "PONT": "hora de Pohnpei", "PST": "hora estándar del Pacífico", "PST Philippine": "hora estándar de Filipinas", "PST Philippine DST": "hora de verano de Filipinas", "PST Pitcairn": "hora de Pitcairn", "PSTM": "hora estándar del Pacífico de México", "PWT": "hora de Palaos", "PYST": "hora de verano de Paraguay", "PYT": "hora estándar de Paraguay", "PYT Korea": "hora de Pionyang", "RET": "hora de Reunión", "ROTT": "hora de Rothera", "SAKST": "hora de verano de Sajalín", "SAKT": "hora estándar de Sajalín", "SAMST": "hora de verano de Samara", "SAMT": "hora estándar de Samara", "SAST": "hora de Sudáfrica", "SBT": "hora de Islas Salomón", "SCT": "hora de Seychelles", "SGT": "hora de Singapur", "SLST": "Hora de Sri Lanka", "SRT": "hora de Surinam", "SST Samoa": "hora estándar de Samoa", "SST Samoa Apia": "hora estándar de Apia", "SST Samoa Apia DST": "horario de verano de Apia", "SST Samoa DST": "hora de verano de Samoa", "SYOT": "hora de Syowa", "TAAF": "hora de las Tierras Australes y Antárticas Francesas", "TAHT": "hora de Tahití", "TJT": "hora de Tayikistán", "TKT": "hora de Tokelau", "TLT": "hora de Timor Oriental", "TMST": "hora de verano de Turkmenistán", "TMT": "hora estándar de Turkmenistán", "TOST": "hora de verano de Tonga", "TOT": "hora estándar de Tonga", "TVT": "hora de Tuvalu", "TWT": "hora estándar de Taipéi", "TWT DST": "hora de verano de Taipéi", "ULAST": "hora de verano de Ulán Bator", "ULAT": "hora estándar de Ulán Bator", "UYST": "hora de verano de Uruguay", "UYT": "hora estándar de Uruguay", "UZT": "hora estándar de Uzbekistán", "UZT DST": "hora de verano de Uzbekistán", "VET": "hora de Venezuela", "VLAST": "hora de verano de Vladivostok", "VLAT": "hora estándar de Vladivostok", "VOLST": "hora de verano de Volgogrado", "VOLT": "hora estándar de Volgogrado", "VOST": "hora de Vostok", "VUT": "hora estándar de Vanuatu", "VUT DST": "hora de verano de Vanuatu", "WAKT": "hora de Isla Wake", "WARST": "hora de verano de Argentina occidental", "WART": "hora estándar de Argentina occidental", "WAST": "hora de África occidental", "WAT": "hora de África occidental", "WESZ": "hora de verano de Europa del Oeste", "WEZ": "hora estándar de Europa del Oeste", "WFT": "hora de Wallis y Futuna", "WGST": "hora de verano de Groenlandia occidental", "WGT": "hora estándar de Groenlandia occidental", "WIB": "hora de Indonesia occidental", "WIT": "hora de Indonesia oriental", "WITA": "hora de Indonesia central", "YAKST": "hora de verano de Yakutsk", "YAKT": "hora estándar de Yakutsk", "YEKST": "hora de verano de Ekaterimburgo", "YEKT": "hora estándar de Ekaterimburgo", "YST": "hora de Yukón", "МСК": "hora estándar de Moscú", "اقتاۋ": "Hora estándar de Aktau", "اقتاۋ قالاسى": "Hora de verano de Aktau", "اقتوبە": "Hora estándar de Aktobe", "اقتوبە قالاسى": "Hora de verano de Aktobe", "الماتى": "الماتى", "الماتى قالاسى": "الماتى قالاسى", "باتىس قازاق ەلى": "hora de Kazajistán occidental", "شىعىش قازاق ەلى": "hora de Kazajistán oriental", "قازاق ەلى": "hora de Kazajistán", "قىرعىزستان": "hora de Kirguistán", "قىزىلوردا": "Hora estándar de Qyzylorda", "قىزىلوردا قالاسى": "Hora de verano de Qyzylorda", "∅∅∅": "hora de verano de las Azores"},
	}
}
