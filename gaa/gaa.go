...
// New returns a new instance of translator for the 'gaa' locale
...
func (gaa *gaa) MonthsAbbreviated() []string {
...
func (gaa *gaa) MonthsNarrow() []string {
...
func (gaa *gaa) MonthsWide() []string {
...
func (gaa *gaa) WeekdaysAbbreviated() []string {
...
func (gaa *gaa) WeekdaysNarrow() []string {
...
func (gaa *gaa) WeekdaysShort() []string {
...
func (gaa *gaa) WeekdaysWide() []string {
	return gaa.daysWide
}

// Decimal returns the decimal point of number
func (gaa *gaa) Decimal() string {
	return gaa.decimal
}

// Group returns the group of number
func (gaa *gaa) Group() string {
	return gaa.group
}

// Group returns the minus sign of number
func (gaa *gaa) Minus() string {
	return gaa.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'gaa' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (gaa *gaa) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
