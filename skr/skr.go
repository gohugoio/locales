...
// New returns a new instance of translator for the 'skr' locale
...
func (skr *skr) MonthsAbbreviated() []string {
	return nil
}
...
func (skr *skr) MonthsNarrow() []string {
	return nil
}
...
func (skr *skr) MonthsWide() []string {
	return skr.monthsWide[1:]
}
...
func (skr *skr) WeekdaysAbbreviated() []string {
	return skr.daysAbbreviated
}
...
func (skr *skr) WeekdaysNarrow() []string {
	return skr.daysNarrow
}
...
func (skr *skr) WeekdaysShort() []string {
	return skr.daysShort
}
...
func (skr *skr) WeekdaysWide() []string {
	return skr.daysWide
}

// Decimal returns the decimal point of number
func (skr *skr) Decimal() string {
	return skr.decimal
}

// Group returns the group of number
func (skr *skr) Group() string {
	return skr.group
}

// Group returns the minus sign of number
func (skr *skr) Minus() string {
	return skr.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'skr' and handles both Whole and Real numbers based on 'v'
func (skr *skr) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'skr' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (skr *skr) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
	...
	b = append(b, skr.percent...)

	return string(b)
}

// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'skr'
func (skr *skr) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := skr.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'skr'
// in accounting notation.
func (skr *skr) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := skr.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtDateShort returns the short date representation of 't' for 'skr'
func (skr *skr) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateMedium returns the medium date representation of 't' for 'skr'
func (skr *skr) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateLong returns the long date representation of 't' for 'skr'
func (skr *skr) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtDateFull returns the full date representation of 't' for 'skr'
func (skr *skr) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeShort returns the short time representation of 't' for 'skr'
func (skr *skr) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeMedium returns the medium time representation of 't' for 'skr'
func (skr *skr) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeLong returns the long time representation of 't' for 'skr'
func (skr *skr) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)

	return string(b)
}

// FmtTimeFull returns the full time representation of 't' for 'skr'
func (skr *skr) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
