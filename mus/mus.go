...
// New returns a new instance of translator for the 'mus' locale
...
func (mus *mus) Locale() string {
	return mus.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'mus'
func (mus *mus) PluralsCardinal() []locales.PluralRule {
	return mus.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'mus'
func (mus *mus) PluralsOrdinal() []locales.PluralRule {
	return mus.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'mus'
func (mus *mus) PluralsRange() []locales.PluralRule {
	return mus.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'mus'
func (mus *mus) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'mus'
func (mus *mus) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'mus'
func (mus *mus) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (mus *mus) MonthsAbbreviated() []string {
	return nil
}
...
func (mus *mus) MonthsNarrow() []string {
	return nil
}
...
func (mus *mus) MonthsWide() []string {
...
func (mus *mus) WeekdaysAbbreviated() []string {
...
func (mus *mus) WeekdaysNarrow() []string {
...
func (mus *mus) WeekdaysShort() []string {
...
func (mus *mus) WeekdaysWide() []string {
	return mus.daysWide
}

// Decimal returns the decimal point of number
func (mus *mus) Decimal() string {
	return mus.decimal
}

// Group returns the group of number
func (mus *mus) Group() string {
	return mus.group
}

// Group returns the minus sign of number
func (mus *mus) Minus() string {
	return mus.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'mus' and handles both Whole and Real numbers based on 'v'
func (mus *mus) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'mus' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (mus *mus) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'mus'
func (mus *mus) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := mus.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'mus'
// in accounting notation.
func (mus *mus) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := mus.currencies[currency]
	return string(append(append([]byte{}, symbol...), s...))
}

// FmtDateShort returns the short date representation of 't' for 'mus'
func (mus *mus) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateMedium returns the medium date representation of 't' for 'mus'
func (mus *mus) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateLong returns the long date representation of 't' for 'mus'
func (mus *mus) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateFull returns the full date representation of 't' for 'mus'
func (mus *mus) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeShort returns the short time representation of 't' for 'mus'
func (mus *mus) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeMedium returns the medium time representation of 't' for 'mus'
func (mus *mus) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeLong returns the long time representation of 't' for 'mus'
func (mus *mus) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeFull returns the full time representation of 't' for 'mus'
func (mus *mus) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
