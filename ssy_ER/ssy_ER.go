...
// New returns a new instance of translator for the 'ssy_ER' locale
...
func (ssy *ssy_ER) Locale() string {
	return ssy.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'ssy_ER'
func (ssy *ssy_ER) PluralsCardinal() []locales.PluralRule {
	return ssy.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'ssy_ER'
func (ssy *ssy_ER) PluralsOrdinal() []locales.PluralRule {
	return ssy.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'ssy_ER'
func (ssy *ssy_ER) PluralsRange() []locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'ssy_ER'
func (ssy *ssy_ER) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'ssy_ER'
func (ssy *ssy_ER) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}
...
func (ssy *ssy_ER) MonthsAbbreviated() []string {
...
func (ssy *ssy_ER) MonthsNarrow() []string {
...
func (ssy *ssy_ER) MonthsWide() []string {
...
func (ssy *ssy_ER) WeekdaysAbbreviated() []string {
...
func (ssy *ssy_ER) WeekdaysNarrow() []string {
...
func (ssy *ssy_ER) WeekdaysShort() []string {
...
func (ssy *ssy_ER) WeekdaysWide() []string {
	return ssy.daysWide
}

// Decimal returns the decimal point of number
func (ssy *ssy_ER) Decimal() string {
	return ssy.decimal
}

// Group returns the group of number
func (ssy *ssy_ER) Group() string {
	return ssy.group
}

// Group returns the minus sign of number
func (ssy *ssy_ER) Minus() string {
	return ssy.minus
}
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'ssy_ER' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (ssy *ssy_ER) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
