...
// New returns a new instance of translator for the 'zh_Latn_CN' locale
...
func (zh *zh_Latn_CN) Locale() string {
	return zh.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'zh_Latn_CN'
func (zh *zh_Latn_CN) PluralsCardinal() []locales.PluralRule {
	return zh.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'zh_Latn_CN'
func (zh *zh_Latn_CN) PluralsOrdinal() []locales.PluralRule {
	return zh.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'zh_Latn_CN'
func (zh *zh_Latn_CN) PluralsRange() []locales.PluralRule {
	return zh.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'zh_Latn_CN'
func (zh *zh_Latn_CN) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'zh_Latn_CN'
func (zh *zh_Latn_CN) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'zh_Latn_CN'
func (zh *zh_Latn_CN) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleOther
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (zh *zh_Latn_CN) MonthAbbreviated(month time.Month) string {
...
func (zh *zh_Latn_CN) MonthsAbbreviated() []string {
	return zh.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (zh *zh_Latn_CN) MonthNarrow(month time.Month) string {
...
func (zh *zh_Latn_CN) MonthsNarrow() []string {
	return nil
}

// MonthWide returns the locales wide month given the 'month' provided
func (zh *zh_Latn_CN) MonthWide(month time.Month) string {
...
func (zh *zh_Latn_CN) MonthsWide() []string {
	return zh.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (zh *zh_Latn_CN) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (zh *zh_Latn_CN) WeekdaysAbbreviated() []string {
	return zh.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (zh *zh_Latn_CN) WeekdayNarrow(weekday time.Weekday) string {
...
func (zh *zh_Latn_CN) WeekdaysNarrow() []string {
	return zh.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (zh *zh_Latn_CN) WeekdayShort(weekday time.Weekday) string {
...
func (zh *zh_Latn_CN) WeekdaysShort() []string {
	return zh.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (zh *zh_Latn_CN) WeekdayWide(weekday time.Weekday) string {
...
func (zh *zh_Latn_CN) WeekdaysWide() []string {
	return zh.daysWide
}

// Decimal returns the decimal point of number
func (zh *zh_Latn_CN) Decimal() string {
	return zh.decimal
}

// Group returns the group of number
func (zh *zh_Latn_CN) Group() string {
	return zh.group
}

// Group returns the minus sign of number
func (zh *zh_Latn_CN) Minus() string {
	return zh.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'zh_Latn_CN' and handles both Whole and Real numbers based on 'v'
func (zh *zh_Latn_CN) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'zh_Latn_CN' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (zh *zh_Latn_CN) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 3
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'zh_Latn_CN'
func (zh *zh_Latn_CN) FmtCurrency(num float64, v uint64, currency currency.Type) string {
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'zh_Latn_CN'
// in accounting notation.
func (zh *zh_Latn_CN) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'zh_Latn_CN'
func (zh *zh_Latn_CN) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'zh_Latn_CN'
func (zh *zh_Latn_CN) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'zh_Latn_CN'
func (zh *zh_Latn_CN) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'zh_Latn_CN'
func (zh *zh_Latn_CN) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'zh_Latn_CN'
func (zh *zh_Latn_CN) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'zh_Latn_CN'
func (zh *zh_Latn_CN) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'zh_Latn_CN'
func (zh *zh_Latn_CN) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'zh_Latn_CN'
func (zh *zh_Latn_CN) FmtTimeFull(t time.Time) string {
