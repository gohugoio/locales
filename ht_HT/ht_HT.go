...
// New returns a new instance of translator for the 'ht_HT' locale
...
func (ht *ht_HT) Locale() string {
	return ht.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'ht_HT'
func (ht *ht_HT) PluralsCardinal() []locales.PluralRule {
	return ht.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'ht_HT'
func (ht *ht_HT) PluralsOrdinal() []locales.PluralRule {
	return ht.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'ht_HT'
func (ht *ht_HT) PluralsRange() []locales.PluralRule {
	return ht.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'ht_HT'
func (ht *ht_HT) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'ht_HT'
func (ht *ht_HT) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'ht_HT'
func (ht *ht_HT) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (ht *ht_HT) MonthAbbreviated(month time.Month) string {
...
func (ht *ht_HT) MonthsAbbreviated() []string {
	return ht.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (ht *ht_HT) MonthNarrow(month time.Month) string {
...
func (ht *ht_HT) MonthsNarrow() []string {
	return ht.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (ht *ht_HT) MonthWide(month time.Month) string {
...
func (ht *ht_HT) MonthsWide() []string {
	return ht.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (ht *ht_HT) WeekdayAbbreviated(weekday time.Weekday) string {
...
func (ht *ht_HT) WeekdaysAbbreviated() []string {
	return ht.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (ht *ht_HT) WeekdayNarrow(weekday time.Weekday) string {
...
func (ht *ht_HT) WeekdaysNarrow() []string {
	return ht.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (ht *ht_HT) WeekdayShort(weekday time.Weekday) string {
...
func (ht *ht_HT) WeekdaysShort() []string {
	return ht.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (ht *ht_HT) WeekdayWide(weekday time.Weekday) string {
...
func (ht *ht_HT) WeekdaysWide() []string {
	return ht.daysWide
}

// Decimal returns the decimal point of number
func (ht *ht_HT) Decimal() string {
	return ht.decimal
}

// Group returns the group of number
func (ht *ht_HT) Group() string {
	return ht.group
}

// Group returns the minus sign of number
func (ht *ht_HT) Minus() string {
	return ht.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'ht_HT' and handles both Whole and Real numbers based on 'v'
func (ht *ht_HT) FmtNumber(num float64, v uint64) string {
...
// FmtPercent returns 'num' with digits/precision of 'v' for 'ht_HT' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (ht *ht_HT) FmtPercent(num float64, v uint64) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	l := len(s) + 5
	b := make([]byte, 0, l)
...
// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'ht_HT'
func (ht *ht_HT) FmtCurrency(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'ht_HT'
// in accounting notation.
func (ht *ht_HT) FmtAccounting(num float64, v uint64, currency currency.Type) string {
	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := ht.currencies[currency]
...
// FmtDateShort returns the short date representation of 't' for 'ht_HT'
func (ht *ht_HT) FmtDateShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateMedium returns the medium date representation of 't' for 'ht_HT'
func (ht *ht_HT) FmtDateMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateLong returns the long date representation of 't' for 'ht_HT'
func (ht *ht_HT) FmtDateLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtDateFull returns the full date representation of 't' for 'ht_HT'
func (ht *ht_HT) FmtDateFull(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeShort returns the short time representation of 't' for 'ht_HT'
func (ht *ht_HT) FmtTimeShort(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeMedium returns the medium time representation of 't' for 'ht_HT'
func (ht *ht_HT) FmtTimeMedium(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeLong returns the long time representation of 't' for 'ht_HT'
func (ht *ht_HT) FmtTimeLong(t time.Time) string {
	b := make([]byte, 0, 32)
...
// FmtTimeFull returns the full time representation of 't' for 'ht_HT'
func (ht *ht_HT) FmtTimeFull(t time.Time) string {
	b := make([]byte, 0, 32)
