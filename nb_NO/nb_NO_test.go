...
// TestDaysWide_Bokmal verifies nb_NO has Bokmål day names, not Nynorsk.
func TestDaysWide_Bokmal(t *testing.T) {
	trans := New()

	expected := []string{"søndag", "mandag", "tirsdag", "onsdag", "torsdag", "fredag", "lørdag"}
...
// TestDaysAbbreviated_Bokmal verifies nb_NO has Bokmål abbreviated days.
func TestDaysAbbreviated_Bokmal(t *testing.T) {
	trans := New()

	expected := []string{"søn.", "man.", "tir.", "ons.", "tor.", "fre.", "lør."}
