...
// New returns a new instance of translator for the 'sat_Deva_IN' locale
func New() locales.Translator {
	return &sat_Deva_IN{
		...
		erasAbbreviated:        []string{"", ""},
		erasNarrow:             []string{"ᱡᱤ", "ᱥᱮ"},
		erasWide:               []string{"ᱡᱤᱥᱩ ᱢᱟᱲᱟᱝ", "ᱥᱮᱨᱢᱟ ᱥᱚᱱ"},
...
func (sat *sat_Deva_IN) Locale() string {
	return sat.locale
}

// PluralsCardinal returns the list of cardinal plural rules associated with 'sat_Deva_IN'
func (sat *sat_Deva_IN) PluralsCardinal() []locales.PluralRule {
	return sat.pluralsCardinal
}

// PluralsOrdinal returns the list of ordinal plural rules associated with 'sat_Deva_IN'
func (sat *sat_Deva_IN) PluralsOrdinal() []locales.PluralRule {
	return sat.pluralsOrdinal
}

// PluralsRange returns the list of range plural rules associated with 'sat_Deva_IN'
func (sat *sat_Deva_IN) PluralsRange() []locales.PluralRule {
	return sat.pluralsRange
}

// CardinalPluralRule returns the cardinal PluralRule given 'num' and digits/precision of 'v' for 'sat_Deva_IN'
func (sat *sat_Deva_IN) CardinalPluralRule(num float64, v uint64) locales.PluralRule {
...
// OrdinalPluralRule returns the ordinal PluralRule given 'num' and digits/precision of 'v' for 'sat_Deva_IN'
func (sat *sat_Deva_IN) OrdinalPluralRule(num float64, v uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// RangePluralRule returns the ordinal PluralRule given 'num1', 'num2' and digits/precision of 'v1' and 'v2' for 'sat_Deva_IN'
func (sat *sat_Deva_IN) RangePluralRule(num1 float64, v1 uint64, num2 float64, v2 uint64) locales.PluralRule {
	return locales.PluralRuleUnknown
}

// MonthAbbreviated returns the locales abbreviated month given the 'month' provided
func (sat *sat_Deva_IN) MonthAbbreviated(month time.Month) string {
	return sat.monthsAbbreviated[month]
}

// MonthsAbbreviated returns the locales abbreviated months
func (sat *sat_Deva_IN) MonthsAbbreviated() []string {
	return sat.monthsAbbreviated[1:]
}

// MonthNarrow returns the locales narrow month given the 'month' provided
func (sat *sat_Deva_IN) MonthNarrow(month time.Month) string {
	return sat.monthsNarrow[month]
}

// MonthsNarrow returns the locales narrow months
func (sat *sat_Deva_IN) MonthsNarrow() []string {
	return sat.monthsNarrow[1:]
}

// MonthWide returns the locales wide month given the 'month' provided
func (sat *sat_Deva_IN) MonthWide(month time.Month) string {
	return sat.monthsWide[month]
}

// MonthsWide returns the locales wide months
func (sat *sat_Deva_IN) MonthsWide() []string {
	return sat.monthsWide[1:]
}

// WeekdayAbbreviated returns the locales abbreviated weekday given the 'weekday' provided
func (sat *sat_Deva_IN) WeekdayAbbreviated(weekday time.Weekday) string {
	return sat.daysAbbreviated[weekday]
}

// WeekdaysAbbreviated returns the locales abbreviated weekdays
func (sat *sat_Deva_IN) WeekdaysAbbreviated() []string {
	return sat.daysAbbreviated
}

// WeekdayNarrow returns the locales narrow weekday given the 'weekday' provided
func (sat *sat_Deva_IN) WeekdayNarrow(weekday time.Weekday) string {
	return sat.daysNarrow[weekday]
}

// WeekdaysNarrow returns the locales narrow weekdays
func (sat *sat_Deva_IN) WeekdaysNarrow() []string {
	return sat.daysNarrow
}

// WeekdayShort returns the locales short weekday given the 'weekday' provided
func (sat *sat_Deva_IN) WeekdayShort(weekday time.Weekday) string {
	return sat.daysShort[weekday]
}

// WeekdaysShort returns the locales short weekdays
func (sat *sat_Deva_IN) WeekdaysShort() []string {
	return sat.daysShort
}

// WeekdayWide returns the locales wide weekday given the 'weekday' provided
func (sat *sat_Deva_IN) WeekdayWide(weekday time.Weekday) string {
	return sat.daysWide[weekday]
}

// WeekdaysWide returns the locales wide weekdays
func (sat *sat_Deva_IN) WeekdaysWide() []string {
	return sat.daysWide
}

// Decimal returns the decimal point of number
func (sat *sat_Deva_IN) Decimal() string {
	return sat.decimal
}

// Group returns the group of number
func (sat *sat_Deva_IN) Group() string {
	return sat.group
}

// Group returns the minus sign of number
func (sat *sat_Deva_IN) Minus() string {
	return sat.minus
}

// FmtNumber returns 'num' with digits/precision of 'v' for 'sat_Deva_IN' and handles both Whole and Real numbers based on 'v'
func (sat *sat_Deva_IN) FmtNumber(num float64, v uint64) string {

	return strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
}

// FmtPercent returns 'num' with digits/precision of 'v' for 'sat_Deva_IN' and handles both Whole and Real numbers based on 'v'
// NOTE: 'num' passed into FmtPercent is assumed to be in percent already
func (sat *sat_Deva_IN) FmtPercent(num float64, v uint64) string {
	return strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
}

// FmtCurrency returns the currency representation of 'num' with digits/precision of 'v' for 'sat_Deva_IN'
func (sat *sat_Deva_IN) FmtCurrency(num float64, v uint64, currency currency.Type) string {

	s := strconv.FormatFloat(math.Abs(num), 'f', int(v), 64)
	symbol := sat.currencies[currency]
	l := len(s) + len(symbol) + 20
...
// FmtAccounting returns the currency representation of 'num' with digits/precision of 'v' for 'sat_Deva_IN'
// in accounting notation.
func (sat *sat_Deva_IN) FmtAccounting(num float64, v uint64, currency currency.Type) string {
...
// FmtDateShort returns the short date representation of 't' for 'sat_Deva_IN'
func (sat *sat_Deva_IN) FmtDateShort(t time.Time) string {
...
// FmtDateMedium returns the medium date representation of 't' for 'sat_Deva_IN'
func (sat *sat_Deva_IN) FmtDateMedium(t time.Time) string {
...
// FmtDateLong returns the long date representation of 't' for 'sat_Deva_IN'
func (sat *sat_Deva_IN) FmtDateLong(t time.Time) string {
...
// FmtDateFull returns the full date representation of 't' for 'sat_Deva_IN'
func (sat *sat_Deva_IN) FmtDateFull(t time.Time) string {
...
// FmtTimeShort returns the short time representation of 't' for 'sat_Deva_IN'
func (sat *sat_Deva_IN) FmtTimeShort(t time.Time) string {
...
// FmtTimeMedium returns the medium time representation of 't' for 'sat_Deva_IN'
func (sat *sat_Deva_IN) FmtTimeMedium(t time.Time) string {
...
// FmtTimeLong returns the long time representation of 't' for 'sat_Deva_IN'
func (sat *sat_Deva_IN) FmtTimeLong(t time.Time) string {
...
// FmtTimeFull returns the full time representation of 't' for 'sat_Deva_IN'
func (sat *sat_Deva_IN) FmtTimeFull(t time.Time) string {
